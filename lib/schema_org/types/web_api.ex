defmodule SchemaOrg.WebAPI do
  @moduledoc "An application programming interface accessible over Web/Internet technologies."
  ...
  @doc false
  def __schema_org__, do: %{type: "WebAPI", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WebAPI` struct."
  ...
  @doc "Sets the Schema.org `documentation` property.\n\nFurther documentation describing the Web API in more detail."
  def documentation(%__MODULE__{} = thing, value) do
    %{thing | documentation: value}
  end
