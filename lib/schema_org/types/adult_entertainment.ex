defmodule SchemaOrg.AdultEntertainment do
  @moduledoc "An adult entertainment establishment."
  ...
  @doc false
  def __schema_org__, do: %{type: "AdultEntertainment", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AdultEntertainment` struct."
