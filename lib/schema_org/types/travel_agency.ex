defmodule SchemaOrg.TravelAgency do
  @moduledoc "A travel agency."
  ...
  @doc false
  def __schema_org__, do: %{type: "TravelAgency", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TravelAgency` struct."
