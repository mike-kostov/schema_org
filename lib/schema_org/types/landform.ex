defmodule SchemaOrg.Landform do
  @moduledoc "A landform or physical feature.  Landform elements include mountains, plains, lakes, rivers, seascape and oceanic waterbody interface features such as bays, peninsulas, seas and so forth, including sub-aqueous terrain features such as submersed mountain ranges, volcanoes, and the great ocean basins."
  ...
  @doc false
  def __schema_org__, do: %{type: "Landform", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Landform` struct."
