defmodule SchemaOrg.UnitPriceSpecification do
  ...
  @doc "Sets the Schema.org `billingDuration` property.\n\nSpecifies for how long this price (or price component) will be billed. Can be used, for example, to model the contractual duration of a subscription or payment plan. Type can be either a Duration or a Number (in which case the unit of measurement, for example month, is specified by the unitCode property)."
  def billing_duration(%__MODULE__{} = thing, value) do
    %{thing | billing_duration: value}
  end

  @doc "Sets the Schema.org `billingIncrement` property.\n\nThis property specifies the minimal quantity and rounding increment that will be the basis for the billing. The unit of measurement is specified by the unitCode property."
  def billing_increment(%__MODULE__{} = thing, value) do
    %{thing | billing_increment: value}
  end

  @doc "Sets the Schema.org `billingStart` property.\n\nSpecifies after how much time this price (or price component) becomes valid and billing starts. Can be used, for example, to model a price increase after the first year of a subscription. The unit of measurement is specified by the unitCode property."
  def billing_start(%__MODULE__{} = thing, value) do
    %{thing | billing_start: value}
  end
  ...
  @doc "Sets the Schema.org `priceComponentType` property.\n\nIdentifies a price component (for example, a line item on an invoice), part of the total price for an offer."
  def price_component_type(%__MODULE__{} = thing, value) do
    %{thing | price_component_type: value}
  end
