defmodule SchemaOrg.RadiationTherapy do
  @moduledoc "A process of care using radiation aimed at improving a health condition."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadiationTherapy", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadiationTherapy` struct."
