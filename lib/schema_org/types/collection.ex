defmodule SchemaOrg.Collection do
  @moduledoc "A collection of items, e.g. creative works or products."
  ...
  @doc false
  def __schema_org__, do: %{type: "Collection", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Collection` struct."
