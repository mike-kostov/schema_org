defmodule SchemaOrg.AskAction do
  ...
  @doc false
  def __schema_org__, do: %{type: "AskAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AskAction` struct."
  ...
  @doc "Sets the Schema.org `question` property.\n\nA sub property of object. A question."
  def question(%__MODULE__{} = thing, value) do
    %{thing | question: value}
  end
