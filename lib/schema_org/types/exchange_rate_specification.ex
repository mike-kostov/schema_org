defmodule SchemaOrg.ExchangeRateSpecification do
  ...
  @doc "Sets the Schema.org `currentExchangeRate` property.\n\nThe current price of a currency."
  def current_exchange_rate(%__MODULE__{} = thing, value) do
    %{thing | current_exchange_rate: value}
  end
  ...
  @doc "Sets the Schema.org `exchangeRateSpread` property.\n\nThe difference between the price at which a broker or other intermediary buys and sells foreign currency."
  def exchange_rate_spread(%__MODULE__{} = thing, value) do
    %{thing | exchange_rate_spread: value}
  end
