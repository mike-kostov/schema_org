defmodule SchemaOrg.IndividualProduct do
  @moduledoc "A single, identifiable product instance (e.g. a laptop with a particular serial number)."
  ...
  @doc false
  def __schema_org__, do: %{type: "IndividualProduct", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.IndividualProduct` struct."
