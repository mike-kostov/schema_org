defmodule SchemaOrg.HowToDirection do
  @moduledoc "A direction indicating a single action to do in the instructions for how to achieve a result."
  ...
  @doc false
  def __schema_org__, do: %{type: "HowToDirection", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HowToDirection` struct."
  ...
  @doc "Sets the Schema.org `afterMedia` property.\n\nA media object representing the circumstances after performing this direction."
  def after_media(%__MODULE__{} = thing, value) do
    %{thing | after_media: value}
  end
  ...
  @doc "Sets the Schema.org `beforeMedia` property.\n\nA media object representing the circumstances before performing this direction."
  def before_media(%__MODULE__{} = thing, value) do
    %{thing | before_media: value}
  end
  ...
  @doc "Sets the Schema.org `duringMedia` property.\n\nA media object representing the circumstances while performing this direction."
  def during_media(%__MODULE__{} = thing, value) do
    %{thing | during_media: value}
  end
  ...
  @doc "Sets the Schema.org `item` property.\n\nAn entity represented by an entry in a list or data feed (e.g. an 'artist' in a list of 'artists')."
  def item(%__MODULE__{} = thing, value) do
    %{thing | item: value}
  end
  ...
  @doc "Sets the Schema.org `nextItem` property.\n\nA link to the ListItem that follows the current one."
  def next_item(%__MODULE__{} = thing, value) do
    %{thing | next_item: value}
  end
  ...
  @doc "Sets the Schema.org `previousItem` property.\n\nA link to the ListItem that precedes the current one."
  def previous_item(%__MODULE__{} = thing, value) do
    %{thing | previous_item: value}
  end
