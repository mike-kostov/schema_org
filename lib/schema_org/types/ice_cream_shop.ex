defmodule SchemaOrg.IceCreamShop do
  @moduledoc "An ice cream shop."
  ...
  @doc false
  def __schema_org__, do: %{type: "IceCreamShop", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.IceCreamShop` struct."
