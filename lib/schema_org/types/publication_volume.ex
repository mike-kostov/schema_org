defmodule SchemaOrg.PublicationVolume do
  @moduledoc "A part of a successively published publication such as a periodical or multi-volume work, often numbered. It may represent a time span, such as a year.\\n\\nSee also [blog post](https://blog-schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/)."
  ...
  @doc false
  def __schema_org__, do: %{type: "PublicationVolume", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PublicationVolume` struct."
  ...
  @doc "Sets the Schema.org `volumeNumber` property.\n\nIdentifies the volume of publication or multi-part work; for example, \"iii\" or \"2\"."
  def volume_number(%__MODULE__{} = thing, value) do
    %{thing | volume_number: value}
  end
