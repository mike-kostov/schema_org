defmodule SchemaOrg.MobileApplication do
  @moduledoc "A software application designed specifically to work well on a mobile device such as a telephone."
  ...
  @doc false
  def __schema_org__, do: %{type: "MobileApplication", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MobileApplication` struct."
  ...
  @doc "Sets the Schema.org `carrierRequirements` property.\n\nSpecifies specific carrier(s) requirements for the application (e.g. an application may only work on a specific carrier network)."
  def carrier_requirements(%__MODULE__{} = thing, value) do
    %{thing | carrier_requirements: value}
  end
