defmodule SchemaOrg.FurnitureStore do
  @moduledoc "A furniture store."
  ...
  @doc false
  def __schema_org__, do: %{type: "FurnitureStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FurnitureStore` struct."
