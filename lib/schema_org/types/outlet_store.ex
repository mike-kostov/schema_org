defmodule SchemaOrg.OutletStore do
  @moduledoc "An outlet store."
  ...
  @doc false
  def __schema_org__, do: %{type: "OutletStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OutletStore` struct."
