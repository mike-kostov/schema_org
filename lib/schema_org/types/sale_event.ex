defmodule SchemaOrg.SaleEvent do
  @moduledoc "Event type: Sales event."
  ...
  @doc false
  def __schema_org__, do: %{type: "SaleEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SaleEvent` struct."
