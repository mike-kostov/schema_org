defmodule SchemaOrg.ImageGallery do
  @moduledoc "Web page type: Image gallery page."
  ...
  @doc false
  def __schema_org__, do: %{type: "ImageGallery", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ImageGallery` struct."
