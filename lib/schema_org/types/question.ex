defmodule SchemaOrg.Question do
  ...
  @doc "Sets the Schema.org `acceptedAnswer` property.\n\nThe answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author."
  def accepted_answer(%__MODULE__{} = thing, value) do
    %{thing | accepted_answer: value}
  end
  ...
  @doc "Sets the Schema.org `answerCount` property.\n\nThe number of answers this question has received."
  def answer_count(%__MODULE__{} = thing, value) do
    %{thing | answer_count: value}
  end
  ...
  @doc "Sets the Schema.org `downvoteCount` property.\n\nThe number of downvotes this question, answer or comment has received from the community."
  def downvote_count(%__MODULE__{} = thing, value) do
    %{thing | downvote_count: value}
  end
  ...
  @doc "Sets the Schema.org `eduQuestionType` property.\n\nFor questions that are part of learning resources (e.g. Quiz), eduQuestionType indicates the format of question being given. Example: \"Multiple choice\", \"Open ended\", \"Flashcard\"."
  def edu_question_type(%__MODULE__{} = thing, value) do
    %{thing | edu_question_type: value}
  end
  ...
  @doc "Sets the Schema.org `parentItem` property.\n\nThe parent of a question, answer or item in general. Typically used for Q/A discussion threads e.g. a chain of comments with the first comment being an [[Article]] or other [[CreativeWork]]. See also [[comment]] which points from something to a comment about it."
  def parent_item(%__MODULE__{} = thing, value) do
    %{thing | parent_item: value}
  end
  ...
  @doc "Sets the Schema.org `suggestedAnswer` property.\n\nAn answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site."
  def suggested_answer(%__MODULE__{} = thing, value) do
    %{thing | suggested_answer: value}
  end
  ...
  @doc "Sets the Schema.org `upvoteCount` property.\n\nThe number of upvotes this question, answer or comment has received from the community."
  def upvote_count(%__MODULE__{} = thing, value) do
    %{thing | upvote_count: value}
  end
