defmodule SchemaOrg.WPSideBar do
  @moduledoc "A sidebar section of the page."
  ...
  @doc false
  def __schema_org__, do: %{type: "WPSideBar", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WPSideBar` struct."
