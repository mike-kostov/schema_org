defmodule SchemaOrg.BusinessEvent do
  @moduledoc "Event type: Business event."
  ...
  @doc false
  def __schema_org__, do: %{type: "BusinessEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BusinessEvent` struct."
