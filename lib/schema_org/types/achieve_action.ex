defmodule SchemaOrg.AchieveAction do
  @moduledoc "The act of accomplishing something via previous efforts. It is an instantaneous action rather than an ongoing process."
  ...
  @doc false
  def __schema_org__, do: %{type: "AchieveAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AchieveAction` struct."
