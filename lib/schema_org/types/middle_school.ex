defmodule SchemaOrg.MiddleSchool do
  @moduledoc "A middle school (typically for children aged around 11-14, although this varies somewhat)."
  ...
  @doc false
  def __schema_org__, do: %{type: "MiddleSchool", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MiddleSchool` struct."
