defmodule SchemaOrg.ClaimReview do
  @moduledoc "A fact-checking review of claims made (or reported) in some creative work (referenced via itemReviewed)."
  ...
  @doc false
  def __schema_org__, do: %{type: "ClaimReview", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ClaimReview` struct."
  ...
  @doc "Sets the Schema.org `claimReviewed` property.\n\nA short summary of the specific claims reviewed in a ClaimReview."
  def claim_reviewed(%__MODULE__{} = thing, value) do
    %{thing | claim_reviewed: value}
  end
