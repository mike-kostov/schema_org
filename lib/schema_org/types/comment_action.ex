defmodule SchemaOrg.CommentAction do
  @moduledoc "The act of generating a comment about a subject."
  ...
  @doc false
  def __schema_org__, do: %{type: "CommentAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CommentAction` struct."
  ...
  @doc "Sets the Schema.org `language` property.\n\nA sub property of instrument. The language used on this action."
  def language(%__MODULE__{} = thing, value) do
    %{thing | language: value}
  end
  ...
  @doc "Sets the Schema.org `resultComment` property.\n\nA sub property of result. The Comment created or sent as a result of this action."
  def result_comment(%__MODULE__{} = thing, value) do
    %{thing | result_comment: value}
  end
