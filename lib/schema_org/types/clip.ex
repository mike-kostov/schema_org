defmodule SchemaOrg.Clip do
  @moduledoc "A short TV or radio program or a segment/part of a program."
  ...
  @doc false
  def __schema_org__, do: %{type: "Clip", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Clip` struct."
