defmodule SchemaOrg.SkiResort do
  @moduledoc "A ski resort."
  ...
  @doc false
  def __schema_org__, do: %{type: "SkiResort", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SkiResort` struct."
