defmodule SchemaOrg.CreativeWorkSeries do
  ...
  @doc false
  def __schema_org__, do: %{type: "CreativeWorkSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CreativeWorkSeries` struct."
