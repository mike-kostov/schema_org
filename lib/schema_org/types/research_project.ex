defmodule SchemaOrg.ResearchProject do
  @moduledoc "A Research project."
  ...
  @doc false
  def __schema_org__, do: %{type: "ResearchProject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ResearchProject` struct."
