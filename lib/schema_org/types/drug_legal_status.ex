defmodule SchemaOrg.DrugLegalStatus do
  @moduledoc "The legal availability status of a medical drug."
  ...
  @doc false
  def __schema_org__, do: %{type: "DrugLegalStatus", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DrugLegalStatus` struct."
