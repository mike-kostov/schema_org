defmodule SchemaOrg.Mountain do
  @moduledoc "A mountain, like Mount Whitney or Mount Everest."
  ...
  @doc false
  def __schema_org__, do: %{type: "Mountain", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Mountain` struct."
