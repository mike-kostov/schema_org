defmodule SchemaOrg.MoneyTransfer do
  @moduledoc "The act of transferring money from one place to another place. This may occur electronically or physically."
  ...
  @doc false
  def __schema_org__, do: %{type: "MoneyTransfer", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MoneyTransfer` struct."
  ...
  @doc "Sets the Schema.org `beneficiaryBank` property.\n\nA bank or bank’s branch, financial institution or international financial institution operating the beneficiary’s bank account or releasing funds for the beneficiary."
  def beneficiary_bank(%__MODULE__{} = thing, value) do
    %{thing | beneficiary_bank: value}
  end
