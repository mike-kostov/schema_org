defmodule SchemaOrg.ReviewNewsArticle do
  ...
  @json_keys %{
    ...
    assesses: "assesses",
    associated_claim_review: "associatedClaimReview",
    associated_media: "associatedMedia",
    associated_media_review: "associatedMediaReview",
    associated_review: "associatedReview",
    audience: "audience",
    audio: "audio",
    author: "author",
    award: "award",
  ...
  @doc false
  def __schema_org__, do: %{type: "ReviewNewsArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ReviewNewsArticle` struct."
  ...
  @doc "Sets the Schema.org `articleBody` property.\n\nThe actual body of the article."
  def article_body(%__MODULE__{} = thing, value) do
    %{thing | article_body: value}
  end

  @doc "Sets the Schema.org `articleSection` property.\n\nArticles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc."
  def article_section(%__MODULE__{} = thing, value) do
    %{thing | article_section: value}
  end
  ...
  @doc "Sets the Schema.org `associatedMediaReview` property.\n\nAn associated [[MediaReview]], related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case [[relatedMediaReview]] would commonly be used on a [[ClaimReview]], while [[associatedClaimReview]] would be used on [[MediaReview]]."
  def associated_media_review(%__MODULE__{} = thing, value) do
    %{thing | associated_media_review: value}
  end

  @doc "Sets the Schema.org `associatedReview` property.\n\nAn associated [[Review]]."
  def associated_review(%__MODULE__{} = thing, value) do
    %{thing | associated_review: value}
  end
  ...
  @doc "Sets the Schema.org `backstory` property.\n\nFor an [[Article]], typically a [[NewsArticle]], the backstory property provides a textual summary giving a brief explanation of why and how an article was created. In a journalistic setting this could include information about reporting process, methods, interviews, data sources, etc."
  def backstory(%__MODULE__{} = thing, value) do
    %{thing | backstory: value}
  end
  ...
  @doc "Sets the Schema.org `itemReviewed` property.\n\nThe item that is being reviewed/rated."
  def item_reviewed(%__MODULE__{} = thing, value) do
    %{thing | item_reviewed: value}
  end
  ...
  @doc "Sets the Schema.org `pageEnd` property.\n\nThe page on which the work ends; for example \"138\" or \"xvi\"."
  def page_end(%__MODULE__{} = thing, value) do
    %{thing | page_end: value}
  end

  @doc "Sets the Schema.org `pageStart` property.\n\nThe page on which the work starts; for example \"135\" or \"xiii\"."
  def page_start(%__MODULE__{} = thing, value) do
    %{thing | page_start: value}
  end

  @doc "Sets the Schema.org `pagination` property.\n\nAny description of pages that is not separated into pageStart and pageEnd; for example, \"1-6, 9, 55\" or \"10-12, 46-49\"."
  def pagination(%__MODULE__{} = thing, value) do
    %{thing | pagination: value}
  end
  ...
  @doc "Sets the Schema.org `printColumn` property.\n\nThe number of the column in which the NewsArticle appears in the print edition."
  def print_column(%__MODULE__{} = thing, value) do
    %{thing | print_column: value}
  end

  @doc "Sets the Schema.org `printEdition` property.\n\nThe edition of the print product in which the NewsArticle appears."
  def print_edition(%__MODULE__{} = thing, value) do
    %{thing | print_edition: value}
  end

  @doc "Sets the Schema.org `printPage` property.\n\nIf this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18)."
  def print_page(%__MODULE__{} = thing, value) do
    %{thing | print_page: value}
  end

  @doc "Sets the Schema.org `printSection` property.\n\nIf this NewsArticle appears in print, this field indicates the print section in which the article appeared."
  def print_section(%__MODULE__{} = thing, value) do
    %{thing | print_section: value}
  end
  ...
  @doc "Sets the Schema.org `reviewBody` property.\n\nThe actual body of the review."
  def review_body(%__MODULE__{} = thing, value) do
    %{thing | review_body: value}
  end

  @doc "Sets the Schema.org `reviewRating` property.\n\nThe rating given in this review. Note that reviews can themselves be rated. The ```reviewRating``` applies to rating given by the review. The [[aggregateRating]] property applies to the review itself, as a creative work."
  def review_rating(%__MODULE__{} = thing, value) do
    %{thing | review_rating: value}
  end
