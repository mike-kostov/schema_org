defmodule SchemaOrg.MobilePhoneStore do
  @moduledoc "A store that sells mobile phones and related accessories."
  ...
  @doc false
  def __schema_org__, do: %{type: "MobilePhoneStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MobilePhoneStore` struct."
