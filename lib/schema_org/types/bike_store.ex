defmodule SchemaOrg.BikeStore do
  @moduledoc "A bike store."
  ...
  @doc false
  def __schema_org__, do: %{type: "BikeStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BikeStore` struct."
