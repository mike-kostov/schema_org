defmodule SchemaOrg.WatchAction do
  @moduledoc "The act of consuming dynamic/moving visual content."
  ...
  @doc false
  def __schema_org__, do: %{type: "WatchAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WatchAction` struct."
