defmodule SchemaOrg.EmergencyService do
  @moduledoc "An emergency service, such as a fire station or ER."
  ...
  @doc false
  def __schema_org__, do: %{type: "EmergencyService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EmergencyService` struct."
