defmodule SchemaOrg.QAPage do
  @moduledoc "A QAPage is a WebPage focussed on a specific Question and its Answer(s), e.g. in a question answering site or documenting Frequently Asked Questions (FAQs)."
  ...
  @doc false
  def __schema_org__, do: %{type: "QAPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.QAPage` struct."
