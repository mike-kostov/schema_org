defmodule SchemaOrg.SocialEvent do
  @moduledoc "Event type: Social event."
  ...
  @doc false
  def __schema_org__, do: %{type: "SocialEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SocialEvent` struct."
