defmodule SchemaOrg.ScreeningEvent do
  @moduledoc "A screening of a movie or other video."
  ...
  @doc false
  def __schema_org__, do: %{type: "ScreeningEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ScreeningEvent` struct."
  ...
  @doc "Sets the Schema.org `workPresented` property.\n\nThe movie presented during this event."
  def work_presented(%__MODULE__{} = thing, value) do
    %{thing | work_presented: value}
  end
end
