defmodule SchemaOrg.SportsClub do
  @moduledoc "A sports club."
  ...
  @doc false
  def __schema_org__, do: %{type: "SportsClub", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SportsClub` struct."
