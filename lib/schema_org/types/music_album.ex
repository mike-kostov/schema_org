defmodule SchemaOrg.MusicAlbum do
  @moduledoc "A collection of music tracks."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicAlbum", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicAlbum` struct."
  ...
  @doc "Sets the Schema.org `albumProductionType` property.\n\nClassification of the album by its type of content: soundtrack, live album, studio album, etc."
  def album_production_type(%__MODULE__{} = thing, value) do
    %{thing | album_production_type: value}
  end

  @doc "Sets the Schema.org `albumRelease` property.\n\nA release of this album."
  def album_release(%__MODULE__{} = thing, value) do
    %{thing | album_release: value}
  end

  @doc "Sets the Schema.org `albumReleaseType` property.\n\nThe kind of release which this album is: single, EP or album."
  def album_release_type(%__MODULE__{} = thing, value) do
    %{thing | album_release_type: value}
  end
  ...
  @doc "Sets the Schema.org `byArtist` property.\n\nThe artist that performed this album or recording."
  def by_artist(%__MODULE__{} = thing, value) do
    %{thing | by_artist: value}
  end
