defmodule SchemaOrg.InteractAction do
  @moduledoc "The act of interacting with another person or organization."
  ...
  @doc false
  def __schema_org__, do: %{type: "InteractAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InteractAction` struct."
