defmodule SchemaOrg.PayAction do
  @moduledoc "An agent pays a price to a participant."
  ...
  @doc false
  def __schema_org__, do: %{type: "PayAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PayAction` struct."
