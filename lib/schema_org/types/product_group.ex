defmodule SchemaOrg.ProductGroup do
  ...
  @doc "Sets the Schema.org `hasVariant` property.\n\nIndicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]])."
  def has_variant(%__MODULE__{} = thing, value) do
    %{thing | has_variant: value}
  end
  ...
  @doc "Sets the Schema.org `productGroupID` property.\n\nIndicates a textual identifier for a ProductGroup."
  def product_group_id(%__MODULE__{} = thing, value) do
    %{thing | product_group_id: value}
  end
  ...
  @doc "Sets the Schema.org `variesBy` property.\n\nIndicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. \"color\"; terms defined elsewhere can be referenced with their URIs."
  def varies_by(%__MODULE__{} = thing, value) do
    %{thing | varies_by: value}
  end
