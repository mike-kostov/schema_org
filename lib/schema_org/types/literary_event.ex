defmodule SchemaOrg.LiteraryEvent do
  @moduledoc "Event type: Literary event."
  ...
  @doc false
  def __schema_org__, do: %{type: "LiteraryEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LiteraryEvent` struct."
