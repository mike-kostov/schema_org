defmodule SchemaOrg.ShortStory do
  @moduledoc "Short story or tale. A brief work of literature, usually written in narrative prose."
  ...
  @doc false
  def __schema_org__, do: %{type: "ShortStory", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ShortStory` struct."
