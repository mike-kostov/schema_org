defmodule SchemaOrg.ExercisePlan do
  ...
  @doc "Sets the Schema.org `activityDuration` property.\n\nLength of time to engage in the activity."
  def activity_duration(%__MODULE__{} = thing, value) do
    %{thing | activity_duration: value}
  end

  @doc "Sets the Schema.org `activityFrequency` property.\n\nHow often one should engage in the activity."
  def activity_frequency(%__MODULE__{} = thing, value) do
    %{thing | activity_frequency: value}
  end
  ...
  @doc "Sets the Schema.org `additionalVariable` property.\n\nAny additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc."
  def additional_variable(%__MODULE__{} = thing, value) do
    %{thing | additional_variable: value}
  end
  ...
  @doc "Sets the Schema.org `intensity` property.\n\nQuantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement."
  def intensity(%__MODULE__{} = thing, value) do
    %{thing | intensity: value}
  end
  ...
  @doc "Sets the Schema.org `repetitions` property.\n\nNumber of times one should repeat the activity."
  def repetitions(%__MODULE__{} = thing, value) do
    %{thing | repetitions: value}
  end

  @doc "Sets the Schema.org `restPeriods` property.\n\nHow often one should break from the activity."
  def rest_periods(%__MODULE__{} = thing, value) do
    %{thing | rest_periods: value}
  end
  ...
  @doc "Sets the Schema.org `workload` property.\n\nQuantitative measure of the physiologic output of the exercise; also referred to as energy expenditure."
  def workload(%__MODULE__{} = thing, value) do
    %{thing | workload: value}
  end
end
