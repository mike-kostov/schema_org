defmodule SchemaOrg.MedicalWebPage do
  @moduledoc "A web page that provides medical information."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalWebPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalWebPage` struct."
  ...
  @doc "Sets the Schema.org `aspect` property.\n\nAn aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment', 'causes', 'prognosis', 'etiology', 'epidemiology', etc."
  def aspect(%__MODULE__{} = thing, value) do
    %{thing | aspect: value}
  end
  ...
  @doc "Sets the Schema.org `medicalAudience` property.\n\nMedical audience for page."
  def medical_audience(%__MODULE__{} = thing, value) do
    %{thing | medical_audience: value}
  end
