defmodule SchemaOrg.ProfilePage do
  @moduledoc "Web page type: Profile page."
  ...
  @doc false
  def __schema_org__, do: %{type: "ProfilePage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ProfilePage` struct."
