defmodule SchemaOrg.Painting do
  @moduledoc "A painting."
  ...
  @doc false
  def __schema_org__, do: %{type: "Painting", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Painting` struct."
