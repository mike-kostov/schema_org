defmodule SchemaOrg.DrinkAction do
  @moduledoc "The act of swallowing liquids."
  ...
  @doc false
  def __schema_org__, do: %{type: "DrinkAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DrinkAction` struct."
