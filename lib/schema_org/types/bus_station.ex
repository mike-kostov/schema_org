defmodule SchemaOrg.BusStation do
  @moduledoc "A bus station."
  ...
  @doc false
  def __schema_org__, do: %{type: "BusStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BusStation` struct."
