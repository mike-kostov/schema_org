defmodule SchemaOrg.FinancialService do
  @moduledoc "Financial services business."
  ...
  @doc false
  def __schema_org__, do: %{type: "FinancialService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FinancialService` struct."
