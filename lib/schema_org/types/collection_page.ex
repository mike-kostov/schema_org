defmodule SchemaOrg.CollectionPage do
  @moduledoc "Web page type: Collection page."
  ...
  @doc false
  def __schema_org__, do: %{type: "CollectionPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CollectionPage` struct."
