defmodule SchemaOrg.SurgicalProcedure do
  @moduledoc "A medical procedure involving an incision with instruments; performed for diagnose, or therapeutic purposes."
  ...
  @doc false
  def __schema_org__, do: %{type: "SurgicalProcedure", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SurgicalProcedure` struct."
