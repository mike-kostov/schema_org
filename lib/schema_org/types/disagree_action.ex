defmodule SchemaOrg.DisagreeAction do
  @moduledoc "The act of expressing a difference of opinion with the object. An agent disagrees to/about an object (a proposition, topic or theme) with participants."
  ...
  @doc false
  def __schema_org__, do: %{type: "DisagreeAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DisagreeAction` struct."
