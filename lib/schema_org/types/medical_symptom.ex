defmodule SchemaOrg.MedicalSymptom do
  @moduledoc "Any complaint sensed and expressed by the patient (therefore defined as subjective)  like stomachache, lower-back pain, or fatigue."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalSymptom", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalSymptom` struct."
