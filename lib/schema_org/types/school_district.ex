defmodule SchemaOrg.SchoolDistrict do
  @moduledoc "A School District is an administrative area for the administration of schools."
  ...
  @doc false
  def __schema_org__, do: %{type: "SchoolDistrict", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SchoolDistrict` struct."
