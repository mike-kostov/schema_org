defmodule SchemaOrg.GovernmentOffice do
  @moduledoc "A government office&#x2014;for example, an IRS or DMV office."
  ...
  @doc false
  def __schema_org__, do: %{type: "GovernmentOffice", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GovernmentOffice` struct."
