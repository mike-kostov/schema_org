defmodule SchemaOrg.MedicalOrganization do
  @moduledoc "A medical organization (physical or not), such as hospital, institution or clinic."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalOrganization` struct."
