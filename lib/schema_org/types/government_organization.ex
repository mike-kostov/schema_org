defmodule SchemaOrg.GovernmentOrganization do
  @moduledoc "A governmental organization or agency."
  ...
  @doc false
  def __schema_org__, do: %{type: "GovernmentOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GovernmentOrganization` struct."
