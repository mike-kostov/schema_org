defmodule SchemaOrg.IgnoreAction do
  @moduledoc "The act of intentionally disregarding the object. An agent ignores an object."
  ...
  @doc false
  def __schema_org__, do: %{type: "IgnoreAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.IgnoreAction` struct."
