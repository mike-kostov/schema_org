defmodule SchemaOrg.WPHeader do
  @moduledoc "The header section of the page."
  ...
  @doc false
  def __schema_org__, do: %{type: "WPHeader", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WPHeader` struct."
