defmodule SchemaOrg.FundingAgency do
  @moduledoc "A FundingAgency is an organization that implements one or more [[FundingScheme]]s and manages\n    the granting process (via [[Grant]]s, typically [[MonetaryGrant]]s).\n    A funding agency is not always required for grant funding, e.g. philanthropic giving, corporate sponsorship etc.\n    \nExamples of funding agencies include ERC, REA, NIH, Bill and Melinda Gates Foundation, ...\n    "
  ...
  @doc false
  def __schema_org__, do: %{type: "FundingAgency", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FundingAgency` struct."
