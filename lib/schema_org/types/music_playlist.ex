defmodule SchemaOrg.MusicPlaylist do
  @moduledoc "A collection of music tracks in playlist form."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicPlaylist", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicPlaylist` struct."
