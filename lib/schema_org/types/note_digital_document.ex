defmodule SchemaOrg.NoteDigitalDocument do
  @moduledoc "A file containing a note, primarily for the author."
  ...
  @doc false
  def __schema_org__, do: %{type: "NoteDigitalDocument", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.NoteDigitalDocument` struct."
