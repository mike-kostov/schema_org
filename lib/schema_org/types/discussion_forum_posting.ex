defmodule SchemaOrg.DiscussionForumPosting do
  @moduledoc "A posting to a discussion forum."
  ...
  @doc false
  def __schema_org__, do: %{type: "DiscussionForumPosting", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DiscussionForumPosting` struct."
