defmodule SchemaOrg.HealthClub do
  @moduledoc "A health club."
  ...
  @doc false
  def __schema_org__, do: %{type: "HealthClub", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HealthClub` struct."
