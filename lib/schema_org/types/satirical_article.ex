defmodule SchemaOrg.SatiricalArticle do
  @moduledoc "An [[Article]] whose content is primarily [[satirical]](https://en.wikipedia.org/wiki/Satire) in nature, i.e. unlikely to be literally true. A satirical article is sometimes but not necessarily also a [[NewsArticle]]. [[ScholarlyArticle]]s are also sometimes satirized."
  ...
  @doc false
  def __schema_org__, do: %{type: "SatiricalArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SatiricalArticle` struct."
