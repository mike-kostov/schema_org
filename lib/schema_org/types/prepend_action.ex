defmodule SchemaOrg.PrependAction do
  @moduledoc "The act of inserting at the beginning if an ordered collection."
  ...
  @doc false
  def __schema_org__, do: %{type: "PrependAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PrependAction` struct."
