defmodule SchemaOrg.Cemetery do
  @moduledoc "A graveyard."
  ...
  @doc false
  def __schema_org__, do: %{type: "Cemetery", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Cemetery` struct."
