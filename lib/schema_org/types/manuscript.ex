defmodule SchemaOrg.Manuscript do
  @moduledoc "A book, document, or piece of music written by hand rather than typed or printed."
  ...
  @doc false
  def __schema_org__, do: %{type: "Manuscript", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Manuscript` struct."
