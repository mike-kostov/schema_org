defmodule SchemaOrg.ChildCare do
  @moduledoc "A Childcare center."
  ...
  @doc false
  def __schema_org__, do: %{type: "ChildCare", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ChildCare` struct."
