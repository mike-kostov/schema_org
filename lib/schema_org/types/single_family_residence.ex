defmodule SchemaOrg.SingleFamilyResidence do
  @moduledoc "Residence type: Single-family home."
  ...
  @doc false
  def __schema_org__, do: %{type: "SingleFamilyResidence", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SingleFamilyResidence` struct."
