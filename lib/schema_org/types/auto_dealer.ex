defmodule SchemaOrg.AutoDealer do
  @moduledoc "An car dealership."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutoDealer", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutoDealer` struct."
