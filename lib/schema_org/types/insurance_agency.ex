defmodule SchemaOrg.InsuranceAgency do
  @moduledoc "An Insurance agency."
  ...
  @doc false
  def __schema_org__, do: %{type: "InsuranceAgency", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InsuranceAgency` struct."
