defmodule SchemaOrg.WearAction do
  @moduledoc "The act of dressing oneself in clothing."
  ...
  @doc false
  def __schema_org__, do: %{type: "WearAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WearAction` struct."
