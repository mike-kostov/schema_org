defmodule SchemaOrg.BodyOfWater do
  @moduledoc "A body of water, such as a sea, ocean, or lake."
  ...
  @doc false
  def __schema_org__, do: %{type: "BodyOfWater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BodyOfWater` struct."
