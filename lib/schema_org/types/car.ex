defmodule SchemaOrg.Car do
  @moduledoc "A car is a wheeled, self-powered motor vehicle used for transportation."
  ...
  @doc false
  def __schema_org__, do: %{type: "Car", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Car` struct."
