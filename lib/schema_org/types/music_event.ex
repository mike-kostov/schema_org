defmodule SchemaOrg.MusicEvent do
  @moduledoc "Event type: Music event."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicEvent` struct."
