defmodule SchemaOrg.HousePainter do
  @moduledoc "A house painting service."
  ...
  @doc false
  def __schema_org__, do: %{type: "HousePainter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HousePainter` struct."
