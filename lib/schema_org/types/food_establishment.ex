defmodule SchemaOrg.FoodEstablishment do
  @moduledoc "A food-related business."
  ...
  @doc false
  def __schema_org__, do: %{type: "FoodEstablishment", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FoodEstablishment` struct."
