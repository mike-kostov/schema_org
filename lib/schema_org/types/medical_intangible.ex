defmodule SchemaOrg.MedicalIntangible do
  @moduledoc "A utility class that serves as the umbrella for a number of 'intangible' things in the medical space."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalIntangible", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalIntangible` struct."
