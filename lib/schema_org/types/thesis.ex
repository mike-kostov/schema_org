defmodule SchemaOrg.Thesis do
  @moduledoc "A thesis or dissertation document submitted in support of candidature for an academic degree or professional qualification."
  ...
  @doc false
  def __schema_org__, do: %{type: "Thesis", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Thesis` struct."
  ...
  @doc "Sets the Schema.org `inSupportOf` property.\n\nQualification, candidature, degree, application that Thesis supports."
  def in_support_of(%__MODULE__{} = thing, value) do
    %{thing | in_support_of: value}
  end
