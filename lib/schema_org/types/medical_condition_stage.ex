defmodule SchemaOrg.MedicalConditionStage do
  ...
  @doc "Sets the Schema.org `stageAsNumber` property.\n\nThe stage represented as a number, e.g. 3."
  def stage_as_number(%__MODULE__{} = thing, value) do
    %{thing | stage_as_number: value}
  end
  ...
  @doc "Sets the Schema.org `subStageSuffix` property.\n\nThe substage, e.g. 'a' for Stage IIIa."
  def sub_stage_suffix(%__MODULE__{} = thing, value) do
    %{thing | sub_stage_suffix: value}
  end
