defmodule SchemaOrg.UserComments do
  @moduledoc "UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use [[Action]]-based vocabulary, alongside types such as [[Comment]]."
  ...
  @doc false
  def __schema_org__, do: %{type: "UserComments", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.UserComments` struct."
  ...
  @doc "Sets the Schema.org `commentText` property.\n\nThe text of the UserComment."
  def comment_text(%__MODULE__{} = thing, value) do
    %{thing | comment_text: value}
  end

  @doc "Sets the Schema.org `commentTime` property.\n\nThe time at which the UserComment was made."
  def comment_time(%__MODULE__{} = thing, value) do
    %{thing | comment_time: value}
  end
  ...
  @doc "Sets the Schema.org `discusses` property.\n\nSpecifies the CreativeWork associated with the UserComment."
  def discusses(%__MODULE__{} = thing, value) do
    %{thing | discusses: value}
  end
  ...
  @doc "Sets the Schema.org `replyToUrl` property.\n\nThe URL at which a reply may be posted to the specified UserComment."
  def reply_to_url(%__MODULE__{} = thing, value) do
    %{thing | reply_to_url: value}
  end
