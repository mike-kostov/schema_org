defmodule SchemaOrg.MovieClip do
  @moduledoc "A short segment/part of a movie."
  ...
  @doc false
  def __schema_org__, do: %{type: "MovieClip", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MovieClip` struct."
