defmodule SchemaOrg.Optician do
  @moduledoc "A store that sells reading glasses and similar devices for improving vision."
  ...
  @doc false
  def __schema_org__, do: %{type: "Optician", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Optician` struct."
