defmodule SchemaOrg.TVClip do
  @moduledoc "A short TV program or a segment/part of a TV program."
  ...
  @doc false
  def __schema_org__, do: %{type: "TVClip", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TVClip` struct."
  ...
  @doc "Sets the Schema.org `clipNumber` property.\n\nPosition of the clip within an ordered group of clips."
  def clip_number(%__MODULE__{} = thing, value) do
    %{thing | clip_number: value}
  end
  ...
  @doc "Sets the Schema.org `endOffset` property.\n\nThe end time of the clip expressed as the number of seconds from the beginning of the work."
  def end_offset(%__MODULE__{} = thing, value) do
    %{thing | end_offset: value}
  end
  ...
  @doc "Sets the Schema.org `partOfEpisode` property.\n\nThe episode to which this clip belongs."
  def part_of_episode(%__MODULE__{} = thing, value) do
    %{thing | part_of_episode: value}
  end
  ...
  @doc "Sets the Schema.org `startOffset` property.\n\nThe start time of the clip expressed as the number of seconds from the beginning of the work."
  def start_offset(%__MODULE__{} = thing, value) do
    %{thing | start_offset: value}
  end
