defmodule SchemaOrg.WinAction do
  @moduledoc "The act of achieving victory in a competitive activity."
  ...
  @doc false
  def __schema_org__, do: %{type: "WinAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WinAction` struct."
  ...
  @doc "Sets the Schema.org `loser` property.\n\nA sub property of participant. The loser of the action."
  def loser(%__MODULE__{} = thing, value) do
    %{thing | loser: value}
  end
