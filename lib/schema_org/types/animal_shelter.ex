defmodule SchemaOrg.AnimalShelter do
  @moduledoc "Animal shelter."
  ...
  @doc false
  def __schema_org__, do: %{type: "AnimalShelter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AnimalShelter` struct."
