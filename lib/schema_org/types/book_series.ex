defmodule SchemaOrg.BookSeries do
  @moduledoc "A series of books. Included books can be indicated with the hasPart property."
  ...
  @doc false
  def __schema_org__, do: %{type: "BookSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BookSeries` struct."
