defmodule SchemaOrg.DietarySupplement do
  ...
  @doc "Sets the Schema.org `recommendedIntake` property.\n\nRecommended intake of this supplement for a given population as defined by a specific recommending authority."
  def recommended_intake(%__MODULE__{} = thing, value) do
    %{thing | recommended_intake: value}
  end
  ...
  @doc "Sets the Schema.org `safetyConsideration` property.\n\nAny potential safety concern associated with the supplement. May include interactions with other drugs and foods, pregnancy, breastfeeding, known adverse reactions, and documented efficacy of the supplement."
  def safety_consideration(%__MODULE__{} = thing, value) do
    %{thing | safety_consideration: value}
  end
  ...
  @doc "Sets the Schema.org `targetPopulation` property.\n\nCharacteristics of the population for which this is intended, or which typically uses it, e.g. 'adults'."
  def target_population(%__MODULE__{} = thing, value) do
    %{thing | target_population: value}
  end
