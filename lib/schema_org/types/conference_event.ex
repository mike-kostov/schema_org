defmodule SchemaOrg.ConferenceEvent do
  @moduledoc "Event type: Conference event."
  ...
  @doc false
  def __schema_org__, do: %{type: "ConferenceEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ConferenceEvent` struct."
