defmodule SchemaOrg.ListenAction do
  @moduledoc "The act of consuming audio content."
  ...
  @doc false
  def __schema_org__, do: %{type: "ListenAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ListenAction` struct."
