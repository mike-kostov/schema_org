defmodule SchemaOrg.Sculpture do
  @moduledoc "A piece of sculpture."
  ...
  @doc false
  def __schema_org__, do: %{type: "Sculpture", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Sculpture` struct."
