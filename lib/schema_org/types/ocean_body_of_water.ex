defmodule SchemaOrg.OceanBodyOfWater do
  @moduledoc "An ocean (for example, the Pacific)."
  ...
  @doc false
  def __schema_org__, do: %{type: "OceanBodyOfWater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OceanBodyOfWater` struct."
