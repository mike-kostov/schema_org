defmodule SchemaOrg.BookStore do
  @moduledoc "A bookstore."
  ...
  @doc false
  def __schema_org__, do: %{type: "BookStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BookStore` struct."
