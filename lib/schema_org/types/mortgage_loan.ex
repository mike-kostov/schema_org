defmodule SchemaOrg.MortgageLoan do
  ...
  @doc "Sets the Schema.org `domiciledMortgage` property.\n\nWhether borrower is a resident of the jurisdiction where the property is located."
  def domiciled_mortgage(%__MODULE__{} = thing, value) do
    %{thing | domiciled_mortgage: value}
  end
  ...
  @doc "Sets the Schema.org `loanMortgageMandateAmount` property.\n\nAmount of mortgage mandate that can be converted into a proper mortgage at a later stage."
  def loan_mortgage_mandate_amount(%__MODULE__{} = thing, value) do
    %{thing | loan_mortgage_mandate_amount: value}
  end
