defmodule SchemaOrg.ReportageNewsArticle do
  ...
  @doc false
  def __schema_org__, do: %{type: "ReportageNewsArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ReportageNewsArticle` struct."
