defmodule SchemaOrg.DeleteAction do
  @moduledoc "The act of editing a recipient by removing one of its objects."
  ...
  @doc false
  def __schema_org__, do: %{type: "DeleteAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DeleteAction` struct."
