defmodule SchemaOrg.ApartmentComplex do
  @moduledoc "Residence type: Apartment complex."
  ...
  @doc false
  def __schema_org__, do: %{type: "ApartmentComplex", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ApartmentComplex` struct."
