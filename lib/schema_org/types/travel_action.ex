defmodule SchemaOrg.TravelAction do
  @moduledoc "The act of traveling from a fromLocation to a destination by a specified mode of transport, optionally with participants."
  ...
  @doc false
  def __schema_org__, do: %{type: "TravelAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TravelAction` struct."
