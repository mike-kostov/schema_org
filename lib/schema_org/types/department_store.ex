defmodule SchemaOrg.DepartmentStore do
  @moduledoc "A department store."
  ...
  @doc false
  def __schema_org__, do: %{type: "DepartmentStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DepartmentStore` struct."
