defmodule SchemaOrg.VideoGameClip do
  @moduledoc "A short segment/part of a video game."
  ...
  @doc false
  def __schema_org__, do: %{type: "VideoGameClip", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VideoGameClip` struct."
