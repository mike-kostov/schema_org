defmodule SchemaOrg.MenuSection do
  @moduledoc "A sub-grouping of food or drink items in a menu. E.g. courses (such as 'Dinner', 'Breakfast', etc.), specific type of dishes (such as 'Meat', 'Vegan', 'Drinks', etc.), or some other classification made by the menu provider."
  ...
  @doc false
  def __schema_org__, do: %{type: "MenuSection", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MenuSection` struct."
  ...
  @doc "Sets the Schema.org `hasMenuItem` property.\n\nA food or drink item contained in a menu or menu section."
  def has_menu_item(%__MODULE__{} = thing, value) do
    %{thing | has_menu_item: value}
  end

  @doc "Sets the Schema.org `hasMenuSection` property.\n\nA subgrouping of the menu (by dishes, course, serving time period, etc.)."
  def has_menu_section(%__MODULE__{} = thing, value) do
    %{thing | has_menu_section: value}
  end
