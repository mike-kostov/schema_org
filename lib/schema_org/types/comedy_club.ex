defmodule SchemaOrg.ComedyClub do
  @moduledoc "A comedy club."
  ...
  @doc false
  def __schema_org__, do: %{type: "ComedyClub", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ComedyClub` struct."
