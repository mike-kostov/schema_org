defmodule SchemaOrg.DeactivateAction do
  @moduledoc "The act of stopping or deactivating a device or application (e.g. stopping a timer or turning off a flashlight)."
  ...
  @doc false
  def __schema_org__, do: %{type: "DeactivateAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DeactivateAction` struct."
