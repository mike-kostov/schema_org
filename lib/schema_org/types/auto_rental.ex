defmodule SchemaOrg.AutoRental do
  @moduledoc "A car rental business."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutoRental", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutoRental` struct."
