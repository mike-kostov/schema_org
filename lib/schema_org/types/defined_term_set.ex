defmodule SchemaOrg.DefinedTermSet do
  @moduledoc "A set of defined terms, for example a set of categories or a classification scheme, a glossary, dictionary or enumeration. Use the about property to specify what the term set is about."
  ...
  @doc false
  def __schema_org__, do: %{type: "DefinedTermSet", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DefinedTermSet` struct."
