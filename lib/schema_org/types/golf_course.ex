defmodule SchemaOrg.GolfCourse do
  @moduledoc "A golf course."
  ...
  @doc false
  def __schema_org__, do: %{type: "GolfCourse", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GolfCourse` struct."
