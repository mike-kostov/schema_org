defmodule SchemaOrg.PerformingArtsTheater do
  @moduledoc "A theater or other performing art center."
  ...
  @doc false
  def __schema_org__, do: %{type: "PerformingArtsTheater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PerformingArtsTheater` struct."
