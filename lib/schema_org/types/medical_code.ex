defmodule SchemaOrg.MedicalCode do
  ...
  @doc "Sets the Schema.org `codeValue` property.\n\nA short textual code that uniquely identifies the value."
  def code_value(%__MODULE__{} = thing, value) do
    %{thing | code_value: value}
  end

  @doc "Sets the Schema.org `codingSystem` property.\n\nThe coding system, e.g. 'ICD-10'."
  def coding_system(%__MODULE__{} = thing, value) do
    %{thing | coding_system: value}
  end
  ...
  @doc "Sets the Schema.org `inCodeSet` property.\n\nA [[CategoryCodeSet]] that contains this category code."
  def in_code_set(%__MODULE__{} = thing, value) do
    %{thing | in_code_set: value}
  end

  @doc "Sets the Schema.org `inDefinedTermSet` property.\n\nA [[DefinedTermSet]] that contains this term."
  def in_defined_term_set(%__MODULE__{} = thing, value) do
    %{thing | in_defined_term_set: value}
  end
  ...
  @doc "Sets the Schema.org `termCode` property.\n\nA code that identifies this [[DefinedTerm]] within a [[DefinedTermSet]]."
  def term_code(%__MODULE__{} = thing, value) do
    %{thing | term_code: value}
  end
