defmodule SchemaOrg.SpreadsheetDigitalDocument do
  @moduledoc "A spreadsheet file."
  ...
  @doc false
  def __schema_org__, do: %{type: "SpreadsheetDigitalDocument", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SpreadsheetDigitalDocument` struct."
