defmodule SchemaOrg.Property do
  ...
  @doc "Sets the Schema.org `domainIncludes` property.\n\nRelates a property to a class that is (one of) the type(s) the property is expected to be used on."
  def domain_includes(%__MODULE__{} = thing, value) do
    %{thing | domain_includes: value}
  end
  ...
  @doc "Sets the Schema.org `inverseOf` property.\n\nRelates a property to a property that is its inverse. Inverse properties relate the same pairs of items to each other, but in reversed direction. For example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit inverses; in these situations RDFa and JSON-LD syntax for reverse properties can be used."
  def inverse_of(%__MODULE__{} = thing, value) do
    %{thing | inverse_of: value}
  end
  ...
  @doc "Sets the Schema.org `rangeIncludes` property.\n\nRelates a property to a class that constitutes (one of) the expected type(s) for values of the property."
  def range_includes(%__MODULE__{} = thing, value) do
    %{thing | range_includes: value}
  end
