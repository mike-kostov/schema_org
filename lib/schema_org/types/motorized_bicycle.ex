defmodule SchemaOrg.MotorizedBicycle do
  @moduledoc "A motorized bicycle is a bicycle with an attached motor used to power the vehicle, or to assist with pedaling."
  ...
  @doc false
  def __schema_org__, do: %{type: "MotorizedBicycle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MotorizedBicycle` struct."
