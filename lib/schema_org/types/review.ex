defmodule SchemaOrg.Review do
  @moduledoc "A review of an item - for example, of a restaurant, movie, or store."
  ...
  @doc false
  def __schema_org__, do: %{type: "Review", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Review` struct."
