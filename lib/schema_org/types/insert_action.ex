defmodule SchemaOrg.InsertAction do
  @moduledoc "The act of adding at a specific location in an ordered collection."
  ...
  @doc false
  def __schema_org__, do: %{type: "InsertAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InsertAction` struct."
  ...
  @doc "Sets the Schema.org `collection` property.\n\nA sub property of object. The collection target of the action."
  def collection(%__MODULE__{} = thing, value) do
    %{thing | collection: value}
  end
  ...
  @doc "Sets the Schema.org `targetCollection` property.\n\nA sub property of object. The collection target of the action."
  def target_collection(%__MODULE__{} = thing, value) do
    %{thing | target_collection: value}
  end
