defmodule SchemaOrg.ChooseAction do
  @moduledoc "The act of expressing a preference from a set of options or a large or unbounded set of choices/options."
  ...
  @doc false
  def __schema_org__, do: %{type: "ChooseAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ChooseAction` struct."
