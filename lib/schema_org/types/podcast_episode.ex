defmodule SchemaOrg.PodcastEpisode do
  @moduledoc "A single episode of a podcast series."
  ...
  @doc false
  def __schema_org__, do: %{type: "PodcastEpisode", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PodcastEpisode` struct."
