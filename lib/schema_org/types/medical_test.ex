defmodule SchemaOrg.MedicalTest do
  @moduledoc "Any medical test, typically performed for diagnostic purposes."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalTest", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalTest` struct."
