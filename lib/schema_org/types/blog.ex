defmodule SchemaOrg.Blog do
  ...
  @doc false
  def __schema_org__, do: %{type: "Blog", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Blog` struct."
  ...
  @doc "Sets the Schema.org `blogPost` property.\n\nA posting that is part of this blog."
  def blog_post(%__MODULE__{} = thing, value) do
    %{thing | blog_post: value}
  end

  @doc "Sets the Schema.org `blogPosts` property.\n\nIndicates a post that is part of a [[Blog]]. Note that historically, what we term a \"Blog\" was once known as a \"weblog\", and that what we term a \"BlogPosting\" is now often colloquially referred to as a \"blog\"."
  def blog_posts(%__MODULE__{} = thing, value) do
    %{thing | blog_posts: value}
  end
