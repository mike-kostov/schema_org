defmodule SchemaOrg.AutoRepair do
  @moduledoc "Car repair business."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutoRepair", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutoRepair` struct."
