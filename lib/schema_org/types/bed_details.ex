defmodule SchemaOrg.BedDetails do
  ...
  @doc "Sets the Schema.org `numberOfBeds` property.\n\nThe quantity of the given bed type available in the HotelRoom, Suite, House, or Apartment."
  def number_of_beds(%__MODULE__{} = thing, value) do
    %{thing | number_of_beds: value}
  end
  ...
  @doc "Sets the Schema.org `typeOfBed` property.\n\nThe type of bed to which the BedDetail refers, i.e. the type of bed available in the quantity indicated by quantity."
  def type_of_bed(%__MODULE__{} = thing, value) do
    %{thing | type_of_bed: value}
  end
