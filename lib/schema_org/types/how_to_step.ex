defmodule SchemaOrg.HowToStep do
  @moduledoc "A step in the instructions for how to achieve a result. It is an ordered list with HowToDirection and/or HowToTip items."
  ...
  @doc false
  def __schema_org__, do: %{type: "HowToStep", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HowToStep` struct."
