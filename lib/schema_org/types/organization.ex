defmodule SchemaOrg.Organization do
  @moduledoc "An organization such as a school, NGO, corporation, club, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "Organization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Organization` struct."
