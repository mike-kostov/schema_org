defmodule SchemaOrg.MedicalObservationalStudy do
  ...
  @doc "Sets the Schema.org `studyDesign` property.\n\nSpecifics about the observational study design (enumerated)."
  def study_design(%__MODULE__{} = thing, value) do
    %{thing | study_design: value}
  end

  @doc "Sets the Schema.org `studyLocation` property.\n\nThe location in which the study is taking/took place."
  def study_location(%__MODULE__{} = thing, value) do
    %{thing | study_location: value}
  end

  @doc "Sets the Schema.org `studySubject` property.\n\nA subject of the study, i.e. one of the medical conditions, therapies, devices, drugs, etc. investigated by the study."
  def study_subject(%__MODULE__{} = thing, value) do
    %{thing | study_subject: value}
  end
