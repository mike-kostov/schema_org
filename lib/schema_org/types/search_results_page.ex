defmodule SchemaOrg.SearchResultsPage do
  @moduledoc "Web page type: Search results page."
  ...
  @doc false
  def __schema_org__, do: %{type: "SearchResultsPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SearchResultsPage` struct."
