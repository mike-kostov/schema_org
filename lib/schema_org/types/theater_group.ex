defmodule SchemaOrg.TheaterGroup do
  @moduledoc "A theater group or company, for example, the Royal Shakespeare Company or Druid Theatre."
  ...
  @doc false
  def __schema_org__, do: %{type: "TheaterGroup", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TheaterGroup` struct."
