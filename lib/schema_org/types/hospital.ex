defmodule SchemaOrg.Hospital do
  @moduledoc "A hospital."
  ...
  @json_keys %{
    ...
    healthcare_reporting_data: "healthcareReportingData",
  ...
  @doc false
  def __schema_org__, do: %{type: "Hospital", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Hospital` struct."
  ...
  @doc "Sets the Schema.org `healthcareReportingData` property.\n\nIndicates data describing a hospital, e.g. a CDC [[CDCPMDRecord]] or as some kind of [[Dataset]]."
  def healthcare_reporting_data(%__MODULE__{} = thing, value) do
    %{thing | healthcare_reporting_data: value}
  end
