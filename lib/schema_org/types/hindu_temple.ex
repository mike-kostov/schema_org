defmodule SchemaOrg.HinduTemple do
  @moduledoc "A Hindu temple."
  ...
  @doc false
  def __schema_org__, do: %{type: "HinduTemple", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HinduTemple` struct."
