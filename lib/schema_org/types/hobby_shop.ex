defmodule SchemaOrg.HobbyShop do
  @moduledoc "A store that sells materials useful or necessary for various hobbies."
  ...
  @doc false
  def __schema_org__, do: %{type: "HobbyShop", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HobbyShop` struct."
