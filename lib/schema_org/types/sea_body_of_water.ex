defmodule SchemaOrg.SeaBodyOfWater do
  @moduledoc "A sea (for example, the Caspian sea)."
  ...
  @doc false
  def __schema_org__, do: %{type: "SeaBodyOfWater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SeaBodyOfWater` struct."
