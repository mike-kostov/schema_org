defmodule SchemaOrg.RadioEpisode do
  @moduledoc "A radio episode which can be part of a series or season."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadioEpisode", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadioEpisode` struct."
