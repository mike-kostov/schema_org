defmodule SchemaOrg.RoofingContractor do
  @moduledoc "A roofing contractor."
  ...
  @doc false
  def __schema_org__, do: %{type: "RoofingContractor", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RoofingContractor` struct."
