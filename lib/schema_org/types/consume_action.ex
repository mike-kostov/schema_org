defmodule SchemaOrg.ConsumeAction do
  @moduledoc "The act of ingesting information/resources/food."
  ...
  @doc false
  def __schema_org__, do: %{type: "ConsumeAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ConsumeAction` struct."
  def new, do: %__MODULE__{}

  @doc "Sets the Schema.org `actionAccessibilityRequirement` property.\n\nA set of requirements that must be fulfilled in order to perform an Action. If more than one value is specified, fulfilling one set of requirements will allow the Action to be performed."
  def action_accessibility_requirement(%__MODULE__{} = thing, value) do
    %{thing | action_accessibility_requirement: value}
  end
