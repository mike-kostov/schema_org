defmodule SchemaOrg.TaxiService do
  @moduledoc "A service for a vehicle for hire with a driver for local travel. Fares are usually calculated based on distance traveled."
  ...
  @doc false
  def __schema_org__, do: %{type: "TaxiService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TaxiService` struct."
