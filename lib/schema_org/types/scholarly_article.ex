defmodule SchemaOrg.ScholarlyArticle do
  @moduledoc "A scholarly article."
  ...
  @doc false
  def __schema_org__, do: %{type: "ScholarlyArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ScholarlyArticle` struct."
