defmodule SchemaOrg.ArchiveOrganization do
  @moduledoc "An organization with archival holdings. An organization which keeps and preserves archival material and typically makes it accessible to the public."
  ...
  @doc false
  def __schema_org__, do: %{type: "ArchiveOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ArchiveOrganization` struct."
  ...
  @doc "Sets the Schema.org `archiveHeld` property.\n\nCollection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an [[ArchiveOrganization]]."
  def archive_held(%__MODULE__{} = thing, value) do
    %{thing | archive_held: value}
  end
