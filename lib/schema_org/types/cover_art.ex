defmodule SchemaOrg.CoverArt do
  @moduledoc "The artwork on the outer surface of a CreativeWork."
  ...
  @doc false
  def __schema_org__, do: %{type: "CoverArt", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CoverArt` struct."
