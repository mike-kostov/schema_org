defmodule SchemaOrg.Quotation do
  @moduledoc "A quotation. Often but not necessarily from some written work, attributable to a real world author and - if associated with a fictional character - to any fictional Person. Use [[isBasedOn]] to link to source/origin. The [[recordedIn]] property can be used to reference a Quotation from an [[Event]]."
  ...
  @json_keys %{
    ...
    spoken_by_character: "spokenByCharacter",
    sponsor: "sponsor",
  ...
  @doc false
  def __schema_org__, do: %{type: "Quotation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Quotation` struct."
  ...
  @doc "Sets the Schema.org `spokenByCharacter` property.\n\nThe (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork."
  def spoken_by_character(%__MODULE__{} = thing, value) do
    %{thing | spoken_by_character: value}
  end
