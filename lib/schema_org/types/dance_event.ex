defmodule SchemaOrg.DanceEvent do
  @moduledoc "Event type: A social dance."
  ...
  @doc false
  def __schema_org__, do: %{type: "DanceEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DanceEvent` struct."
