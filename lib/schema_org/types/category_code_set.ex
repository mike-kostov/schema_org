defmodule SchemaOrg.CategoryCodeSet do
  @moduledoc "A set of Category Code values."
  ...
  @doc false
  def __schema_org__, do: %{type: "CategoryCodeSet", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CategoryCodeSet` struct."
  ...
  @doc "Sets the Schema.org `hasCategoryCode` property.\n\nA Category code contained in this code set."
  def has_category_code(%__MODULE__{} = thing, value) do
    %{thing | has_category_code: value}
  end
