defmodule SchemaOrg.RentAction do
  ...
  @doc "Sets the Schema.org `landlord` property.\n\nA sub property of participant. The owner of the real estate property."
  def landlord(%__MODULE__{} = thing, value) do
    %{thing | landlord: value}
  end
  ...
  @doc "Sets the Schema.org `realEstateAgent` property.\n\nA sub property of participant. The real estate agent involved in the action."
  def real_estate_agent(%__MODULE__{} = thing, value) do
    %{thing | real_estate_agent: value}
  end
