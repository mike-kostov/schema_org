defmodule SchemaOrg.BedType do
  @moduledoc "A type of bed. This is used for indicating the bed or beds available in an accommodation."
  ...
  @doc false
  def __schema_org__, do: %{type: "BedType", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BedType` struct."
