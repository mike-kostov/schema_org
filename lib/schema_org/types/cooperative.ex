defmodule SchemaOrg.Cooperative do
  @moduledoc "An organization that is a joint project of multiple organizations or persons."
  ...
  @doc false
  def __schema_org__, do: %{type: "Cooperative", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Cooperative` struct."
