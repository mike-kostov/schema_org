defmodule SchemaOrg.TieAction do
  @moduledoc "The act of reaching a draw in a competitive activity."
  ...
  @doc false
  def __schema_org__, do: %{type: "TieAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TieAction` struct."
