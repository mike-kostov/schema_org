defmodule SchemaOrg.NightClub do
  @moduledoc "A nightclub or discotheque."
  ...
  @doc false
  def __schema_org__, do: %{type: "NightClub", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.NightClub` struct."
