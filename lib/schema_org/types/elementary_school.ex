defmodule SchemaOrg.ElementarySchool do
  @moduledoc "An elementary school."
  ...
  @doc false
  def __schema_org__, do: %{type: "ElementarySchool", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ElementarySchool` struct."
