defmodule SchemaOrg.TireShop do
  @moduledoc "A tire shop."
  ...
  @doc false
  def __schema_org__, do: %{type: "TireShop", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TireShop` struct."
