defmodule SchemaOrg.TouristDestination do
  ...
  @json_keys %{
    ...
    image: "image",
    includes_attraction: "includesAttraction",
  ...
  @doc false
  def __schema_org__, do: %{type: "TouristDestination", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TouristDestination` struct."
  ...
  @doc "Sets the Schema.org `includesAttraction` property.\n\nAttraction located at destination."
  def includes_attraction(%__MODULE__{} = thing, value) do
    %{thing | includes_attraction: value}
  end
