defmodule SchemaOrg.PhysicalTherapy do
  @moduledoc "A process of progressive physical care and rehabilitation aimed at improving a health condition."
  ...
  @doc false
  def __schema_org__, do: %{type: "PhysicalTherapy", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PhysicalTherapy` struct."
