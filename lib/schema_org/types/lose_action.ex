defmodule SchemaOrg.LoseAction do
  @moduledoc "The act of being defeated in a competitive activity."
  ...
  @doc false
  def __schema_org__, do: %{type: "LoseAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LoseAction` struct."
  ...
  @doc "Sets the Schema.org `winner` property.\n\nA sub property of participant. The winner of the action."
  def winner(%__MODULE__{} = thing, value) do
    %{thing | winner: value}
  end
end
