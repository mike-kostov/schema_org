defmodule SchemaOrg.MediaGallery do
  @moduledoc "Web page type: Media gallery page. A mixed-media page that can contain media such as images, videos, and other multimedia."
  ...
  @doc false
  def __schema_org__, do: %{type: "MediaGallery", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MediaGallery` struct."
