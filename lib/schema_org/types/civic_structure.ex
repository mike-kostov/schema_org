defmodule SchemaOrg.CivicStructure do
  @moduledoc "A public structure, such as a town hall or concert hall."
  ...
  @doc false
  def __schema_org__, do: %{type: "CivicStructure", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CivicStructure` struct."
