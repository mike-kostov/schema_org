defmodule SchemaOrg.RiverBodyOfWater do
  @moduledoc "A river (for example, the broad majestic Shannon)."
  ...
  @doc false
  def __schema_org__, do: %{type: "RiverBodyOfWater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RiverBodyOfWater` struct."
