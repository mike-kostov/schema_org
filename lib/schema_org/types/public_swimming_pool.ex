defmodule SchemaOrg.PublicSwimmingPool do
  @moduledoc "A public swimming pool."
  ...
  @doc false
  def __schema_org__, do: %{type: "PublicSwimmingPool", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PublicSwimmingPool` struct."
