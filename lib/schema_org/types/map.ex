defmodule SchemaOrg.Map do
  ...
  @doc false
  def __schema_org__, do: %{type: "Map", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Map` struct."
  ...
  @doc "Sets the Schema.org `mapType` property.\n\nIndicates the kind of Map, from the MapCategoryType Enumeration."
  def map_type(%__MODULE__{} = thing, value) do
    %{thing | map_type: value}
  end
