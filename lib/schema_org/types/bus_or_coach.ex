defmodule SchemaOrg.BusOrCoach do
  ...
  @doc "Sets the Schema.org `accelerationTime` property.\n\nThe time needed to accelerate the vehicle from a given start velocity to a given target velocity.\\n\\nTypical unit code(s): SEC for seconds\\n\\n* Note: There are unfortunately no standard unit codes for seconds/0..100 km/h or seconds/0..60 mph. Simply use \"SEC\" for seconds and indicate the velocities in the [[name]] of the [[QuantitativeValue]], or use [[valueReference]] with a [[QuantitativeValue]] of 0..60 mph or 0..100 km/h to specify the reference speeds."
  def acceleration_time(%__MODULE__{} = thing, value) do
    %{thing | acceleration_time: value}
  end

  @doc "Sets the Schema.org `acrissCode` property.\n\nThe ACRISS Car Classification Code is a code used by many car rental companies, for classifying vehicles. ACRISS stands for Association of Car Rental Industry Systems and Standards."
  def acriss_code(%__MODULE__{} = thing, value) do
    %{thing | acriss_code: value}
  end
  ...
  @doc "Sets the Schema.org `bodyType` property.\n\nIndicates the design and body style of the vehicle (e.g. station wagon, hatchback, etc.)."
  def body_type(%__MODULE__{} = thing, value) do
    %{thing | body_type: value}
  end
  ...
  @doc "Sets the Schema.org `cargoVolume` property.\n\nThe available volume for cargo or luggage. For automobiles, this is usually the trunk volume.\\n\\nTypical unit code(s): LTR for liters, FTQ for cubic foot/feet\\n\\nNote: You can use [[minValue]] and [[maxValue]] to indicate ranges."
  def cargo_volume(%__MODULE__{} = thing, value) do
    %{thing | cargo_volume: value}
  end
  ...
  @doc "Sets the Schema.org `dateVehicleFirstRegistered` property.\n\nThe date of the first registration of the vehicle with the respective public authorities."
  def date_vehicle_first_registered(%__MODULE__{} = thing, value) do
    %{thing | date_vehicle_first_registered: value}
  end
  ...
  @doc "Sets the Schema.org `driveWheelConfiguration` property.\n\nThe drive wheel configuration, i.e. which roadwheels will receive torque from the vehicle's engine via the drivetrain."
  def drive_wheel_configuration(%__MODULE__{} = thing, value) do
    %{thing | drive_wheel_configuration: value}
  end

  @doc "Sets the Schema.org `emissionsCO2` property.\n\nThe CO2 emissions in g/km. When used in combination with a QuantitativeValue, put \"g/km\" into the unitText property of that value, since there is no UN/CEFACT Common Code for \"g/km\"."
  def emissions_co2(%__MODULE__{} = thing, value) do
    %{thing | emissions_co2: value}
  end

  @doc "Sets the Schema.org `fuelCapacity` property.\n\nThe capacity of the fuel tank or in the case of electric cars, the battery. If there are multiple components for storage, this should indicate the total of all storage of the same type.\\n\\nTypical unit code(s): LTR for liters, GLL of US gallons, GLI for UK / imperial gallons, AMH for ampere-hours (for electrical vehicles)."
  def fuel_capacity(%__MODULE__{} = thing, value) do
    %{thing | fuel_capacity: value}
  end

  @doc "Sets the Schema.org `fuelConsumption` property.\n\nThe amount of fuel consumed for traveling a particular distance or temporal duration with the given vehicle (e.g. liters per 100 km).\\n\\n* Note 1: There are unfortunately no standard unit codes for liters per 100 km.  Use [[unitText]] to indicate the unit of measurement, e.g. L/100 km.\\n* Note 2: There are two ways of indicating the fuel consumption, [[fuelConsumption]] (e.g. 8 liters per 100 km) and [[fuelEfficiency]] (e.g. 30 miles per gallon). They are reciprocal.\\n* Note 3: Often, the absolute value is useful only when related to driving speed (\"at 80 km/h\") or usage pattern (\"city traffic\"). You can use [[valueReference]] to link the value for the fuel consumption to another value."
  def fuel_consumption(%__MODULE__{} = thing, value) do
    %{thing | fuel_consumption: value}
  end

  @doc "Sets the Schema.org `fuelEfficiency` property.\n\nThe distance traveled per unit of fuel used; most commonly miles per gallon (mpg) or kilometers per liter (km/L).\\n\\n* Note 1: There are unfortunately no standard unit codes for miles per gallon or kilometers per liter. Use [[unitText]] to indicate the unit of measurement, e.g. mpg or km/L.\\n* Note 2: There are two ways of indicating the fuel consumption, [[fuelConsumption]] (e.g. 8 liters per 100 km) and [[fuelEfficiency]] (e.g. 30 miles per gallon). They are reciprocal.\\n* Note 3: Often, the absolute value is useful only when related to driving speed (\"at 80 km/h\") or usage pattern (\"city traffic\"). You can use [[valueReference]] to link the value for the fuel economy to another value."
  def fuel_efficiency(%__MODULE__{} = thing, value) do
    %{thing | fuel_efficiency: value}
  end
  ...
  @doc "Sets the Schema.org `knownVehicleDamages` property.\n\nA textual description of known damages, both repaired and unrepaired."
  def known_vehicle_damages(%__MODULE__{} = thing, value) do
    %{thing | known_vehicle_damages: value}
  end
  ...
  @doc "Sets the Schema.org `meetsEmissionStandard` property.\n\nIndicates that the vehicle meets the respective emission standard."
  def meets_emission_standard(%__MODULE__{} = thing, value) do
    %{thing | meets_emission_standard: value}
  end

  @doc "Sets the Schema.org `mileageFromOdometer` property.\n\nThe total distance travelled by the particular vehicle since its initial production, as read from its odometer.\\n\\nTypical unit code(s): KMT for kilometers, SMI for statute miles."
  def mileage_from_odometer(%__MODULE__{} = thing, value) do
    %{thing | mileage_from_odometer: value}
  end
  ...
  @doc "Sets the Schema.org `modelDate` property.\n\nThe release date of a vehicle model (often used to differentiate versions of the same make and model)."
  def model_date(%__MODULE__{} = thing, value) do
    %{thing | model_date: value}
  end
  ...
  @doc "Sets the Schema.org `numberOfAirbags` property.\n\nThe number or type of airbags in the vehicle."
  def number_of_airbags(%__MODULE__{} = thing, value) do
    %{thing | number_of_airbags: value}
  end

  @doc "Sets the Schema.org `numberOfAxles` property.\n\nThe number of axles.\\n\\nTypical unit code(s): C62."
  def number_of_axles(%__MODULE__{} = thing, value) do
    %{thing | number_of_axles: value}
  end

  @doc "Sets the Schema.org `numberOfDoors` property.\n\nThe number of doors.\\n\\nTypical unit code(s): C62."
  def number_of_doors(%__MODULE__{} = thing, value) do
    %{thing | number_of_doors: value}
  end

  @doc "Sets the Schema.org `numberOfForwardGears` property.\n\nThe total number of forward gears available for the transmission system of the vehicle.\\n\\nTypical unit code(s): C62."
  def number_of_forward_gears(%__MODULE__{} = thing, value) do
    %{thing | number_of_forward_gears: value}
  end

  @doc "Sets the Schema.org `numberOfPreviousOwners` property.\n\nThe number of owners of the vehicle, including the current one.\\n\\nTypical unit code(s): C62."
  def number_of_previous_owners(%__MODULE__{} = thing, value) do
    %{thing | number_of_previous_owners: value}
  end
  ...
  @doc "Sets the Schema.org `roofLoad` property.\n\nThe permitted total weight of cargo and installations (e.g. a roof rack) on top of the vehicle.\\n\\nTypical unit code(s): KGM for kilogram, LBR for pound\\n\\n* Note 1: You can indicate additional information in the [[name]] of the [[QuantitativeValue]] node.\\n* Note 2: You may also link to a [[QualitativeValue]] node that provides additional information using [[valueReference]]\\n* Note 3: Note that you can use [[minValue]] and [[maxValue]] to indicate ranges."
  def roof_load(%__MODULE__{} = thing, value) do
    %{thing | roof_load: value}
  end
  ...
  @doc "Sets the Schema.org `seatingCapacity` property.\n\nThe number of persons that can be seated (e.g. in a vehicle), both in terms of the physical space available, and in terms of limitations set by law.\\n\\nTypical unit code(s): C62 for persons."
  def seating_capacity(%__MODULE__{} = thing, value) do
    %{thing | seating_capacity: value}
  end
  ...
  @doc "Sets the Schema.org `speed` property.\n\nThe speed range of the vehicle. If the vehicle is powered by an engine, the upper limit of the speed range (indicated by [[maxValue]]) should be the maximum speed achievable under regular conditions.\\n\\nTypical unit code(s): KMH for km/h, HM for mile per hour (0.447 04 m/s), KNT for knot\\n\\n*Note 1: Use [[minValue]] and [[maxValue]] to indicate the range. Typically, the minimal value is zero.\\n* Note 2: There are many different ways of measuring the speed range. You can link to information about how the given value has been determined using the [[valueReference]] property."
  def speed(%__MODULE__{} = thing, value) do
    %{thing | speed: value}
  end

  @doc "Sets the Schema.org `steeringPosition` property.\n\nThe position of the steering wheel or similar device (mostly for cars)."
  def steering_position(%__MODULE__{} = thing, value) do
    %{thing | steering_position: value}
  end
  ...
  @doc "Sets the Schema.org `tongueWeight` property.\n\nThe permitted vertical load (TWR) of a trailer attached to the vehicle. Also referred to as Tongue Load Rating (TLR) or Vertical Load Rating (VLR).\\n\\nTypical unit code(s): KGM for kilogram, LBR for pound\\n\\n* Note 1: You can indicate additional information in the [[name]] of the [[QuantitativeValue]] node.\\n* Note 2: You may also link to a [[QualitativeValue]] node that provides additional information using [[valueReference]].\\n* Note 3: Note that you can use [[minValue]] and [[maxValue]] to indicate ranges."
  def tongue_weight(%__MODULE__{} = thing, value) do
    %{thing | tongue_weight: value}
  end

  @doc "Sets the Schema.org `trailerWeight` property.\n\nThe permitted weight of a trailer attached to the vehicle.\\n\\nTypical unit code(s): KGM for kilogram, LBR for pound\\n* Note 1: You can indicate additional information in the [[name]] of the [[QuantitativeValue]] node.\\n* Note 2: You may also link to a [[QualitativeValue]] node that provides additional information using [[valueReference]].\\n* Note 3: Note that you can use [[minValue]] and [[maxValue]] to indicate ranges."
  def trailer_weight(%__MODULE__{} = thing, value) do
    %{thing | trailer_weight: value}
  end
  ...
  @doc "Sets the Schema.org `vehicleConfiguration` property.\n\nA short text indicating the configuration of the vehicle, e.g. '5dr hatchback ST 2.5 MT 225 hp' or 'limited edition'."
  def vehicle_configuration(%__MODULE__{} = thing, value) do
    %{thing | vehicle_configuration: value}
  end

  @doc "Sets the Schema.org `vehicleEngine` property.\n\nInformation about the engine or engines of the vehicle."
  def vehicle_engine(%__MODULE__{} = thing, value) do
    %{thing | vehicle_engine: value}
  end

  @doc "Sets the Schema.org `vehicleIdentificationNumber` property.\n\nThe Vehicle Identification Number (VIN) is a unique serial number used by the automotive industry to identify individual motor vehicles."
  def vehicle_identification_number(%__MODULE__{} = thing, value) do
    %{thing | vehicle_identification_number: value}
  end

  @doc "Sets the Schema.org `vehicleInteriorColor` property.\n\nThe color or color combination of the interior of the vehicle."
  def vehicle_interior_color(%__MODULE__{} = thing, value) do
    %{thing | vehicle_interior_color: value}
  end

  @doc "Sets the Schema.org `vehicleInteriorType` property.\n\nThe type or material of the interior of the vehicle (e.g. synthetic fabric, leather, wood, etc.). While most interior types are characterized by the material used, an interior type can also be based on vehicle usage or target audience."
  def vehicle_interior_type(%__MODULE__{} = thing, value) do
    %{thing | vehicle_interior_type: value}
  end

  @doc "Sets the Schema.org `vehicleModelDate` property.\n\nThe release date of a vehicle model (often used to differentiate versions of the same make and model)."
  def vehicle_model_date(%__MODULE__{} = thing, value) do
    %{thing | vehicle_model_date: value}
  end

  @doc "Sets the Schema.org `vehicleSeatingCapacity` property.\n\nThe number of passengers that can be seated in the vehicle, both in terms of the physical space available, and in terms of limitations set by law.\\n\\nTypical unit code(s): C62 for persons."
  def vehicle_seating_capacity(%__MODULE__{} = thing, value) do
    %{thing | vehicle_seating_capacity: value}
  end

  @doc "Sets the Schema.org `vehicleSpecialUsage` property.\n\nIndicates whether the vehicle has been used for special purposes, like commercial rental, driving school, or as a taxi. The legislation in many countries requires this information to be revealed when offering a car for sale."
  def vehicle_special_usage(%__MODULE__{} = thing, value) do
    %{thing | vehicle_special_usage: value}
  end

  @doc "Sets the Schema.org `vehicleTransmission` property.\n\nThe type of component used for transmitting the power from a rotating power source to the wheels or other relevant component(s) (\"gearbox\" for cars)."
  def vehicle_transmission(%__MODULE__{} = thing, value) do
    %{thing | vehicle_transmission: value}
  end
  ...
  @doc "Sets the Schema.org `weightTotal` property.\n\nThe permitted total weight of the loaded vehicle, including passengers and cargo and the weight of the empty vehicle.\\n\\nTypical unit code(s): KGM for kilogram, LBR for pound\\n\\n* Note 1: You can indicate additional information in the [[name]] of the [[QuantitativeValue]] node.\\n* Note 2: You may also link to a [[QualitativeValue]] node that provides additional information using [[valueReference]].\\n* Note 3: Note that you can use [[minValue]] and [[maxValue]] to indicate ranges."
  def weight_total(%__MODULE__{} = thing, value) do
    %{thing | weight_total: value}
  end

  @doc "Sets the Schema.org `wheelbase` property.\n\nThe distance between the centers of the front and rear wheels.\\n\\nTypical unit code(s): CMT for centimeters, MTR for meters, INH for inches, FOT for foot/feet."
  def wheelbase(%__MODULE__{} = thing, value) do
    %{thing | wheelbase: value}
  end
