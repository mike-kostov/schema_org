defmodule SchemaOrg.ComicIssue do
  @moduledoc "Individual comic issues are serially published as\n    \tpart of a larger series. For the sake of consistency, even one-shot issues\n    \tbelong to a series comprised of a single issue. All comic issues can be\n    \tuniquely identified by: the combination of the name and volume number of the\n    \tseries to which the issue belongs; the issue number; and the variant\n    \tdescription of the issue (if any)."
  ...
  @doc false
  def __schema_org__, do: %{type: "ComicIssue", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ComicIssue` struct."
  ...
  @doc "Sets the Schema.org `issueNumber` property.\n\nIdentifies the issue of publication; for example, \"iii\" or \"2\"."
  def issue_number(%__MODULE__{} = thing, value) do
    %{thing | issue_number: value}
  end
  ...
  @doc "Sets the Schema.org `variantCover` property.\n\nA description of the variant cover\n    \tfor the issue, if the issue is a variant printing. For example, \"Bryan Hitch\n    \tVariant Cover\" or \"2nd Printing Variant\"."
  def variant_cover(%__MODULE__{} = thing, value) do
    %{thing | variant_cover: value}
  end
