defmodule SchemaOrg.Airport do
  @moduledoc "An airport."
  ...
  @doc false
  def __schema_org__, do: %{type: "Airport", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Airport` struct."
  ...
  @doc "Sets the Schema.org `iataCode` property.\n\nIATA identifier for an airline or airport."
  def iata_code(%__MODULE__{} = thing, value) do
    %{thing | iata_code: value}
  end

  @doc "Sets the Schema.org `icaoCode` property.\n\nICAO identifier for an airport."
  def icao_code(%__MODULE__{} = thing, value) do
    %{thing | icao_code: value}
  end
