defmodule SchemaOrg.OnlineBusiness do
  @moduledoc "A particular online business, either standalone or the online part of a broader organization. Examples include an eCommerce site, an online travel booking site, an online learning site, an online logistics and shipping provider, an online (virtual) doctor, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "OnlineBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OnlineBusiness` struct."
