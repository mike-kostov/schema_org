defmodule SchemaOrg.Message do
  @moduledoc "A single message from a sender to one or more organizations or people."
  ...
  @doc false
  def __schema_org__, do: %{type: "Message", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Message` struct."
  ...
  @doc "Sets the Schema.org `bccRecipient` property.\n\nA sub property of recipient. The recipient blind copied on a message."
  def bcc_recipient(%__MODULE__{} = thing, value) do
    %{thing | bcc_recipient: value}
  end

  @doc "Sets the Schema.org `ccRecipient` property.\n\nA sub property of recipient. The recipient copied on a message."
  def cc_recipient(%__MODULE__{} = thing, value) do
    %{thing | cc_recipient: value}
  end
  ...
  @doc "Sets the Schema.org `dateRead` property.\n\nThe date/time at which the message has been read by the recipient if a single recipient exists."
  def date_read(%__MODULE__{} = thing, value) do
    %{thing | date_read: value}
  end

  @doc "Sets the Schema.org `dateReceived` property.\n\nThe date/time the message was received if a single recipient exists."
  def date_received(%__MODULE__{} = thing, value) do
    %{thing | date_received: value}
  end

  @doc "Sets the Schema.org `dateSent` property.\n\nThe date/time at which the message was sent."
  def date_sent(%__MODULE__{} = thing, value) do
    %{thing | date_sent: value}
  end
  ...
  @doc "Sets the Schema.org `messageAttachment` property.\n\nA CreativeWork attached to the message."
  def message_attachment(%__MODULE__{} = thing, value) do
    %{thing | message_attachment: value}
  end
  ...
  @doc "Sets the Schema.org `recipient` property.\n\nA sub property of participant. The participant who is at the receiving end of the action."
  def recipient(%__MODULE__{} = thing, value) do
    %{thing | recipient: value}
  end
  ...
  @doc "Sets the Schema.org `sender` property.\n\nA sub property of participant. The participant who is at the sending end of the action."
  def sender(%__MODULE__{} = thing, value) do
    %{thing | sender: value}
  end
  ...
  @doc "Sets the Schema.org `toRecipient` property.\n\nA sub property of recipient. The recipient who was directly sent the message."
  def to_recipient(%__MODULE__{} = thing, value) do
    %{thing | to_recipient: value}
  end
