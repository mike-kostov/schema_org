defmodule SchemaOrg.UserInteraction do
  ...
  @doc false
  def __schema_org__, do: %{type: "UserInteraction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.UserInteraction` struct."
