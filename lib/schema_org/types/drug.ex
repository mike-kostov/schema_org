defmodule SchemaOrg.Drug do
  ...
  @doc "Sets the Schema.org `activeIngredient` property.\n\nAn active ingredient, typically chemical compounds and/or biologic substances."
  def active_ingredient(%__MODULE__{} = thing, value) do
    %{thing | active_ingredient: value}
  end
  ...
  @doc "Sets the Schema.org `administrationRoute` property.\n\nA route by which this drug may be administered, e.g. 'oral'."
  def administration_route(%__MODULE__{} = thing, value) do
    %{thing | administration_route: value}
  end
  ...
  @doc "Sets the Schema.org `alcoholWarning` property.\n\nAny precaution, guidance, contraindication, etc. related to consumption of alcohol while taking this drug."
  def alcohol_warning(%__MODULE__{} = thing, value) do
    %{thing | alcohol_warning: value}
  end
  ...
  @doc "Sets the Schema.org `availableStrength` property.\n\nAn available dosage strength for the drug."
  def available_strength(%__MODULE__{} = thing, value) do
    %{thing | available_strength: value}
  end
  ...
  @doc "Sets the Schema.org `breastfeedingWarning` property.\n\nAny precaution, guidance, contraindication, etc. related to this drug's use by breastfeeding mothers."
  def breastfeeding_warning(%__MODULE__{} = thing, value) do
    %{thing | breastfeeding_warning: value}
  end
  ...
  @doc "Sets the Schema.org `clincalPharmacology` property.\n\nDescription of the absorption and elimination of drugs, including their concentration (pharmacokinetics, pK) and biological effects (pharmacodynamics, pD)."
  def clincal_pharmacology(%__MODULE__{} = thing, value) do
    %{thing | clincal_pharmacology: value}
  end

  @doc "Sets the Schema.org `clinicalPharmacology` property.\n\nDescription of the absorption and elimination of drugs, including their concentration (pharmacokinetics, pK) and biological effects (pharmacodynamics, pD)."
  def clinical_pharmacology(%__MODULE__{} = thing, value) do
    %{thing | clinical_pharmacology: value}
  end
  ...
  @doc "Sets the Schema.org `dosageForm` property.\n\nA dosage form in which this drug/supplement is available, e.g. 'tablet', 'suspension', 'injection'."
  def dosage_form(%__MODULE__{} = thing, value) do
    %{thing | dosage_form: value}
  end

  @doc "Sets the Schema.org `doseSchedule` property.\n\nA dosing schedule for the drug for a given population, either observed, recommended, or maximum dose based on the type used."
  def dose_schedule(%__MODULE__{} = thing, value) do
    %{thing | dose_schedule: value}
  end

  @doc "Sets the Schema.org `drugClass` property.\n\nThe class of drug this belongs to (e.g., statins)."
  def drug_class(%__MODULE__{} = thing, value) do
    %{thing | drug_class: value}
  end

  @doc "Sets the Schema.org `drugUnit` property.\n\nThe unit in which the drug is measured, e.g. '5 mg tablet'."
  def drug_unit(%__MODULE__{} = thing, value) do
    %{thing | drug_unit: value}
  end

  @doc "Sets the Schema.org `foodWarning` property.\n\nAny precaution, guidance, contraindication, etc. related to consumption of specific foods while taking this drug."
  def food_warning(%__MODULE__{} = thing, value) do
    %{thing | food_warning: value}
  end
  ...
  @doc "Sets the Schema.org `includedInHealthInsurancePlan` property.\n\nThe insurance plans that cover this drug."
  def included_in_health_insurance_plan(%__MODULE__{} = thing, value) do
    %{thing | included_in_health_insurance_plan: value}
  end

  @doc "Sets the Schema.org `interactingDrug` property.\n\nAnother drug that is known to interact with this drug in a way that impacts the effect of this drug or causes a risk to the patient. Note: disease interactions are typically captured as contraindications."
  def interacting_drug(%__MODULE__{} = thing, value) do
    %{thing | interacting_drug: value}
  end
  ...
  @doc "Sets the Schema.org `isAvailableGenerically` property.\n\nTrue if the drug is available in a generic form (regardless of name)."
  def is_available_generically(%__MODULE__{} = thing, value) do
    %{thing | is_available_generically: value}
  end
  ...
  @doc "Sets the Schema.org `isProprietary` property.\n\nTrue if this item's name is a proprietary/brand name (vs. generic name)."
  def is_proprietary(%__MODULE__{} = thing, value) do
    %{thing | is_proprietary: value}
  end
  ...
  @doc "Sets the Schema.org `labelDetails` property.\n\nLink to the drug's label details."
  def label_details(%__MODULE__{} = thing, value) do
    %{thing | label_details: value}
  end
  ...
  @doc "Sets the Schema.org `maximumIntake` property.\n\nRecommended intake of this supplement for a given population as defined by a specific recommending authority."
  def maximum_intake(%__MODULE__{} = thing, value) do
    %{thing | maximum_intake: value}
  end

  @doc "Sets the Schema.org `mechanismOfAction` property.\n\nThe specific biochemical interaction through which this drug or supplement produces its pharmacological effect."
  def mechanism_of_action(%__MODULE__{} = thing, value) do
    %{thing | mechanism_of_action: value}
  end
  ...
  @doc "Sets the Schema.org `nonProprietaryName` property.\n\nThe generic name of this drug or supplement."
  def non_proprietary_name(%__MODULE__{} = thing, value) do
    %{thing | non_proprietary_name: value}
  end
  ...
  @doc "Sets the Schema.org `overdosage` property.\n\nAny information related to overdose on a drug, including signs or symptoms, treatments, contact information for emergency response."
  def overdosage(%__MODULE__{} = thing, value) do
    %{thing | overdosage: value}
  end
  ...
  @doc "Sets the Schema.org `pregnancyCategory` property.\n\nPregnancy category of this drug."
  def pregnancy_category(%__MODULE__{} = thing, value) do
    %{thing | pregnancy_category: value}
  end

  @doc "Sets the Schema.org `pregnancyWarning` property.\n\nAny precaution, guidance, contraindication, etc. related to this drug's use during pregnancy."
  def pregnancy_warning(%__MODULE__{} = thing, value) do
    %{thing | pregnancy_warning: value}
  end

  @doc "Sets the Schema.org `prescribingInfo` property.\n\nLink to prescribing information for the drug."
  def prescribing_info(%__MODULE__{} = thing, value) do
    %{thing | prescribing_info: value}
  end

  @doc "Sets the Schema.org `prescriptionStatus` property.\n\nIndicates the status of drug prescription, e.g. local catalogs classifications or whether the drug is available by prescription or over-the-counter, etc."
  def prescription_status(%__MODULE__{} = thing, value) do
    %{thing | prescription_status: value}
  end
  ...
  @doc "Sets the Schema.org `proprietaryName` property.\n\nProprietary name given to the diet plan, typically by its originator or creator."
  def proprietary_name(%__MODULE__{} = thing, value) do
    %{thing | proprietary_name: value}
  end
  ...
  @doc "Sets the Schema.org `relatedDrug` property.\n\nAny other drug related to this one, for example commonly-prescribed alternatives."
  def related_drug(%__MODULE__{} = thing, value) do
    %{thing | related_drug: value}
  end
  ...
  @doc "Sets the Schema.org `rxcui` property.\n\nThe RxCUI drug identifier from RXNORM."
  def rxcui(%__MODULE__{} = thing, value) do
    %{thing | rxcui: value}
  end
  ...
  @doc "Sets the Schema.org `warning` property.\n\nAny FDA or other warnings about the drug (text or URL)."
  def warning(%__MODULE__{} = thing, value) do
    %{thing | warning: value}
  end
