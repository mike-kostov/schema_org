defmodule SchemaOrg.WPFooter do
  @moduledoc "The footer section of the page."
  ...
  @doc false
  def __schema_org__, do: %{type: "WPFooter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WPFooter` struct."
