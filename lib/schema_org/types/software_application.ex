defmodule SchemaOrg.SoftwareApplication do
  @moduledoc "A software application."
  ...
  @doc false
  def __schema_org__, do: %{type: "SoftwareApplication", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SoftwareApplication` struct."
