defmodule SchemaOrg.ImageObjectSnapshot do
  ...
  @doc false
  def __schema_org__, do: %{type: "ImageObjectSnapshot", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ImageObjectSnapshot` struct."
