defmodule SchemaOrg.NewsMediaOrganization do
  @moduledoc "A News/Media organization such as a newspaper or TV station."
  ...
  @doc false
  def __schema_org__, do: %{type: "NewsMediaOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.NewsMediaOrganization` struct."
  ...
  @doc "Sets the Schema.org `masthead` property.\n\nFor a [[NewsMediaOrganization]], a link to the masthead page or a page listing top editorial management."
  def masthead(%__MODULE__{} = thing, value) do
    %{thing | masthead: value}
  end
  ...
  @doc "Sets the Schema.org `missionCoveragePrioritiesPolicy` property.\n\nFor a [[NewsMediaOrganization]], a statement on coverage priorities, including any public agenda or stance on issues."
  def mission_coverage_priorities_policy(%__MODULE__{} = thing, value) do
    %{thing | mission_coverage_priorities_policy: value}
  end
  ...
  @doc "Sets the Schema.org `noBylinesPolicy` property.\n\nFor a [[NewsMediaOrganization]] or other news-related [[Organization]], a statement explaining when authors of articles are not named in bylines."
  def no_bylines_policy(%__MODULE__{} = thing, value) do
    %{thing | no_bylines_policy: value}
  end
  ...
  @doc "Sets the Schema.org `verificationFactCheckingPolicy` property.\n\nDisclosure about verification and fact-checking processes for a [[NewsMediaOrganization]] or other fact-checking [[Organization]]."
  def verification_fact_checking_policy(%__MODULE__{} = thing, value) do
    %{thing | verification_fact_checking_policy: value}
  end
end
