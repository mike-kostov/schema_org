defmodule SchemaOrg.Atlas do
  @moduledoc "A collection or bound volume of maps, charts, plates or tables, physical or in media form illustrating any subject."
  ...
  @doc false
  def __schema_org__, do: %{type: "Atlas", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Atlas` struct."
