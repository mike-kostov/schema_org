defmodule SchemaOrg.Comment do
  @moduledoc "A comment on an item - for example, a comment on a blog post. The comment's content is expressed via the [[text]] property, and its topic via [[about]], properties shared with all CreativeWorks."
  ...
  @doc false
  def __schema_org__, do: %{type: "Comment", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Comment` struct."
