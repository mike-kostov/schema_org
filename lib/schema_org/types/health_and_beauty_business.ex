defmodule SchemaOrg.HealthAndBeautyBusiness do
  @moduledoc "Health and beauty."
  ...
  @doc false
  def __schema_org__, do: %{type: "HealthAndBeautyBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HealthAndBeautyBusiness` struct."
