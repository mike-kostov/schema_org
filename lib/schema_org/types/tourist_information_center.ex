defmodule SchemaOrg.TouristInformationCenter do
  @moduledoc "A tourist information center."
  ...
  @doc false
  def __schema_org__, do: %{type: "TouristInformationCenter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TouristInformationCenter` struct."
