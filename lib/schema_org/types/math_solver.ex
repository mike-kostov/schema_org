defmodule SchemaOrg.MathSolver do
  @moduledoc "A math solver which is capable of solving a subset of mathematical problems."
  ...
  @doc false
  def __schema_org__, do: %{type: "MathSolver", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MathSolver` struct."
  ...
  @doc "Sets the Schema.org `mathExpression` property.\n\nA mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard."
  def math_expression(%__MODULE__{} = thing, value) do
    %{thing | math_expression: value}
  end
