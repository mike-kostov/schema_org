defmodule SchemaOrg.PeopleAudience do
  @moduledoc "A set of characteristics belonging to people, e.g. who compose an item's target audience."
  ...
  @doc false
  def __schema_org__, do: %{type: "PeopleAudience", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PeopleAudience` struct."
