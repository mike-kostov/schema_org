defmodule SchemaOrg.State do
  @moduledoc "A state or province of a country."
  ...
  @doc false
  def __schema_org__, do: %{type: "State", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.State` struct."
