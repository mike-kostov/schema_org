defmodule SchemaOrg.Store do
  @moduledoc "A retail good store."
  ...
  @doc false
  def __schema_org__, do: %{type: "Store", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Store` struct."
