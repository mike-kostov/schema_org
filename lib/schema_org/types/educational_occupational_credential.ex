defmodule SchemaOrg.EducationalOccupationalCredential do
  @moduledoc "An educational or occupational credential. A diploma, academic degree, certification, qualification, badge, etc., that may be awarded to a person or other entity that meets the requirements defined by the credentialer."
  ...
  @doc false
  def __schema_org__, do: %{type: "EducationalOccupationalCredential", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EducationalOccupationalCredential` struct."
  ...
  @doc "Sets the Schema.org `credentialCategory` property.\n\nThe category or type of credential being described, for example \"degree”, “certificate”, “badge”, or more specific term."
  def credential_category(%__MODULE__{} = thing, value) do
    %{thing | credential_category: value}
  end
  ...
  @doc "Sets the Schema.org `recognizedBy` property.\n\nAn organization that acknowledges the validity, value or utility of a credential. Note: recognition may include a process of quality assurance or accreditation."
  def recognized_by(%__MODULE__{} = thing, value) do
    %{thing | recognized_by: value}
  end
