defmodule SchemaOrg.SportsTeam do
  @moduledoc "Organization: Sports team."
  ...
  @doc false
  def __schema_org__, do: %{type: "SportsTeam", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SportsTeam` struct."
  ...
  @doc "Sets the Schema.org `athlete` property.\n\nA person that acts as performing member of a sports team; a player as opposed to a coach."
  def athlete(%__MODULE__{} = thing, value) do
    %{thing | athlete: value}
  end
  ...
  @doc "Sets the Schema.org `coach` property.\n\nA person that acts in a coaching role for a sports team."
  def coach(%__MODULE__{} = thing, value) do
    %{thing | coach: value}
  end
