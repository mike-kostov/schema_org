defmodule SchemaOrg.TextObject do
  @moduledoc "A text file. The text can be unformatted or contain markup, html, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "TextObject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TextObject` struct."
