defmodule SchemaOrg.Artery do
  ...
  @doc "Sets the Schema.org `arterialBranch` property.\n\nThe branches that comprise the arterial structure."
  def arterial_branch(%__MODULE__{} = thing, value) do
    %{thing | arterial_branch: value}
  end
  ...
  @doc "Sets the Schema.org `supplyTo` property.\n\nThe area to which the artery supplies blood."
  def supply_to(%__MODULE__{} = thing, value) do
    %{thing | supply_to: value}
  end
