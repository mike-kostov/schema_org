defmodule SchemaOrg.TrainStation do
  @moduledoc "A train station."
  ...
  @doc false
  def __schema_org__, do: %{type: "TrainStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TrainStation` struct."
