defmodule SchemaOrg.Table do
  @moduledoc "A table on a Web page."
  ...
  @doc false
  def __schema_org__, do: %{type: "Table", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Table` struct."
