defmodule SchemaOrg.PalliativeProcedure do
  @moduledoc "A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition."
  ...
  @doc false
  def __schema_org__, do: %{type: "PalliativeProcedure", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PalliativeProcedure` struct."
  ...
  @doc "Sets the Schema.org `duplicateTherapy` property.\n\nA therapy that duplicates or overlaps this one."
  def duplicate_therapy(%__MODULE__{} = thing, value) do
    %{thing | duplicate_therapy: value}
  end

  @doc "Sets the Schema.org `followup` property.\n\nTypical or recommended followup care after the procedure is performed."
  def followup(%__MODULE__{} = thing, value) do
    %{thing | followup: value}
  end
  ...
  @doc "Sets the Schema.org `howPerformed` property.\n\nHow the procedure is performed."
  def how_performed(%__MODULE__{} = thing, value) do
    %{thing | how_performed: value}
  end
  ...
  @doc "Sets the Schema.org `preparation` property.\n\nTypical preparation that a patient must undergo before having the procedure performed."
  def preparation(%__MODULE__{} = thing, value) do
    %{thing | preparation: value}
  end

  @doc "Sets the Schema.org `procedureType` property.\n\nThe type of procedure, for example Surgical, Noninvasive, or Percutaneous."
  def procedure_type(%__MODULE__{} = thing, value) do
    %{thing | procedure_type: value}
  end
