defmodule SchemaOrg.VideoGallery do
  @moduledoc "Web page type: Video gallery page."
  ...
  @doc false
  def __schema_org__, do: %{type: "VideoGallery", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VideoGallery` struct."
