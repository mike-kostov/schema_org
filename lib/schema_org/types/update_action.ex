defmodule SchemaOrg.UpdateAction do
  @moduledoc "The act of managing by changing/editing the state of the object."
  ...
  @doc false
  def __schema_org__, do: %{type: "UpdateAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.UpdateAction` struct."
