defmodule SchemaOrg.WholesaleStore do
  @moduledoc "A wholesale store."
  ...
  @doc false
  def __schema_org__, do: %{type: "WholesaleStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WholesaleStore` struct."
