defmodule SchemaOrg.GovernmentBuilding do
  @moduledoc "A government building."
  ...
  @doc false
  def __schema_org__, do: %{type: "GovernmentBuilding", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GovernmentBuilding` struct."
