defmodule SchemaOrg.TVEpisode do
  @moduledoc "A TV episode which can be part of a series or season."
  ...
  @json_keys %{
    ...
    part_of_tv_series: "partOfTVSeries",
    pattern: "pattern",
    position: "position",
  ...
  @doc false
  def __schema_org__, do: %{type: "TVEpisode", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TVEpisode` struct."
  ...
  @doc "Sets the Schema.org `episodeNumber` property.\n\nPosition of the episode within an ordered group of episodes."
  def episode_number(%__MODULE__{} = thing, value) do
    %{thing | episode_number: value}
  end
  ...
  @doc "Sets the Schema.org `partOfSeason` property.\n\nThe season to which this episode belongs."
  def part_of_season(%__MODULE__{} = thing, value) do
    %{thing | part_of_season: value}
  end

  @doc "Sets the Schema.org `partOfSeries` property.\n\nThe series to which this episode or season belongs."
  def part_of_series(%__MODULE__{} = thing, value) do
    %{thing | part_of_series: value}
  end

  @doc "Sets the Schema.org `partOfTVSeries` property.\n\nThe TV series to which this episode or season belongs."
  def part_of_tv_series(%__MODULE__{} = thing, value) do
    %{thing | part_of_tv_series: value}
  end
  ...
  @doc "Sets the Schema.org `subtitleLanguage` property.\n\nLanguages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47)."
  def subtitle_language(%__MODULE__{} = thing, value) do
    %{thing | subtitle_language: value}
  end
