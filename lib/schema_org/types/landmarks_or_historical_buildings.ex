defmodule SchemaOrg.LandmarksOrHistoricalBuildings do
  @moduledoc "An historical landmark or building."
  ...
  @doc false
  def __schema_org__, do: %{type: "LandmarksOrHistoricalBuildings", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LandmarksOrHistoricalBuildings` struct."
