defmodule SchemaOrg.OnDemandEvent do
  @moduledoc "A publication event, e.g. catch-up TV or radio podcast, during which a program is available on-demand."
  ...
  @doc false
  def __schema_org__, do: %{type: "OnDemandEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OnDemandEvent` struct."
