defmodule SchemaOrg.ComicSeries do
  @moduledoc "A sequential publication of comic stories under a\n    \tunifying title, for example \"The Amazing Spider-Man\" or \"Groo the\n    \tWanderer\"."
  ...
  @doc false
  def __schema_org__, do: %{type: "ComicSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ComicSeries` struct."
