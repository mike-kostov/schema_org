defmodule SchemaOrg.ControlAction do
  @moduledoc "An agent controls a device or application."
  ...
  @doc false
  def __schema_org__, do: %{type: "ControlAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ControlAction` struct."
