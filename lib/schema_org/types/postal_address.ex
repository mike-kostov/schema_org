defmodule SchemaOrg.PostalAddress do
  ...
  @doc "Sets the Schema.org `addressLocality` property.\n\nThe locality in which the street address is, and which is in the region. For example, Mountain View."
  def address_locality(%__MODULE__{} = thing, value) do
    %{thing | address_locality: value}
  end
  ...
  @doc "Sets the Schema.org `extendedAddress` property.\n\nAn address extension such as an apartment number, C/O or alternative name."
  def extended_address(%__MODULE__{} = thing, value) do
    %{thing | extended_address: value}
  end
  ...
  @doc "Sets the Schema.org `postOfficeBoxNumber` property.\n\nThe post office box number for PO box addresses."
  def post_office_box_number(%__MODULE__{} = thing, value) do
    %{thing | post_office_box_number: value}
  end
  ...
  @doc "Sets the Schema.org `streetAddress` property.\n\nThe street address. For example, 1600 Amphitheatre Pkwy."
  def street_address(%__MODULE__{} = thing, value) do
    %{thing | street_address: value}
  end
