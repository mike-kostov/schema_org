defmodule SchemaOrg.RVPark do
  @moduledoc "A place offering space for \"Recreational Vehicles\", Caravans, mobile homes and the like."
  ...
  @doc false
  def __schema_org__, do: %{type: "RVPark", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RVPark` struct."
