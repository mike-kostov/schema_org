defmodule SchemaOrg.RadioChannel do
  @moduledoc "A unique instance of a radio BroadcastService on a CableOrSatelliteService lineup."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadioChannel", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadioChannel` struct."
