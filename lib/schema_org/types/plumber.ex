defmodule SchemaOrg.Plumber do
  @moduledoc "A plumbing service."
  ...
  @doc false
  def __schema_org__, do: %{type: "Plumber", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Plumber` struct."
