defmodule SchemaOrg.RadioSeries do
  @moduledoc "CreativeWorkSeries dedicated to radio broadcast and associated online delivery."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadioSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadioSeries` struct."
