defmodule SchemaOrg.ArtGallery do
  @moduledoc "An art gallery."
  ...
  @doc false
  def __schema_org__, do: %{type: "ArtGallery", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ArtGallery` struct."
