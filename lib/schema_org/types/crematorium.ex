defmodule SchemaOrg.Crematorium do
  @moduledoc "A crematorium."
  ...
  @doc false
  def __schema_org__, do: %{type: "Crematorium", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Crematorium` struct."
