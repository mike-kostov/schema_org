defmodule SchemaOrg.AppendAction do
  @moduledoc "The act of inserting at the end if an ordered collection."
  ...
  @doc false
  def __schema_org__, do: %{type: "AppendAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AppendAction` struct."
