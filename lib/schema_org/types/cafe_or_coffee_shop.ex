defmodule SchemaOrg.CafeOrCoffeeShop do
  @moduledoc "A cafe or coffee shop."
  ...
  @doc false
  def __schema_org__, do: %{type: "CafeOrCoffeeShop", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CafeOrCoffeeShop` struct."
