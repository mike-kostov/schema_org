defmodule SchemaOrg.UseAction do
  @moduledoc "The act of applying an object to its intended purpose."
  ...
  @doc false
  def __schema_org__, do: %{type: "UseAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.UseAction` struct."
