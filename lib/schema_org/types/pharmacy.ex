defmodule SchemaOrg.Pharmacy do
  @moduledoc "A pharmacy or drugstore."
  ...
  @doc false
  def __schema_org__, do: %{type: "Pharmacy", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Pharmacy` struct."
