defmodule SchemaOrg.Quiz do
  @moduledoc "Quiz: A test of knowledge, skills and abilities."
  ...
  @doc false
  def __schema_org__, do: %{type: "Quiz", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Quiz` struct."
