defmodule SchemaOrg.SearchAction do
  @moduledoc "The act of searching for an object.\\n\\nRelated actions:\\n\\n* [[FindAction]]: SearchAction generally leads to a FindAction, but not necessarily."
  ...
  @doc false
  def __schema_org__, do: %{type: "SearchAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SearchAction` struct."
  ...
  @doc "Sets the Schema.org `query` property.\n\nA sub property of instrument. The query used on this action."
  def query(%__MODULE__{} = thing, value) do
    %{thing | query: value}
  end
