defmodule SchemaOrg.EducationEvent do
  @moduledoc "Event type: Education event."
  ...
  @doc false
  def __schema_org__, do: %{type: "EducationEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EducationEvent` struct."
