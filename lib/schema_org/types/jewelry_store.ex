defmodule SchemaOrg.JewelryStore do
  @moduledoc "A jewelry store."
  ...
  @doc false
  def __schema_org__, do: %{type: "JewelryStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.JewelryStore` struct."
