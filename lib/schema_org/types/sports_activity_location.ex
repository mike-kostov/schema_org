defmodule SchemaOrg.SportsActivityLocation do
  @moduledoc "A sports location, such as a playing field."
  ...
  @doc false
  def __schema_org__, do: %{type: "SportsActivityLocation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SportsActivityLocation` struct."
