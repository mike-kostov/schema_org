defmodule SchemaOrg.BowlingAlley do
  @moduledoc "A bowling alley."
  ...
  @doc false
  def __schema_org__, do: %{type: "BowlingAlley", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BowlingAlley` struct."
