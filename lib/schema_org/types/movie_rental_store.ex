defmodule SchemaOrg.MovieRentalStore do
  @moduledoc "A movie rental store."
  ...
  @doc false
  def __schema_org__, do: %{type: "MovieRentalStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MovieRentalStore` struct."
