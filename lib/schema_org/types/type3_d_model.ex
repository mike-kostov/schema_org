defmodule SchemaOrg.Type3DModel do
  ...
  @doc false
  def __schema_org__, do: %{type: "3DModel", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Type3DModel` struct."
  ...
  @doc "Sets the Schema.org `isResizable` property.\n\nWhether the 3DModel allows resizing. For example, room layout applications often do not allow 3DModel elements to be resized to reflect reality."
  def is_resizable(%__MODULE__{} = thing, value) do
    %{thing | is_resizable: value}
  end
