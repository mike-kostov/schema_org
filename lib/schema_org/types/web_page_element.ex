defmodule SchemaOrg.WebPageElement do
  @moduledoc "A web page element, like a table or an image."
  ...
  @doc false
  def __schema_org__, do: %{type: "WebPageElement", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WebPageElement` struct."
