defmodule SchemaOrg.InviteAction do
  @moduledoc "The act of asking someone to attend an event. Reciprocal of RsvpAction."
  ...
  @doc false
  def __schema_org__, do: %{type: "InviteAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InviteAction` struct."
