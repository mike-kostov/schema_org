defmodule SchemaOrg.SiteNavigationElement do
  @moduledoc "A navigation element of the page."
  ...
  @doc false
  def __schema_org__, do: %{type: "SiteNavigationElement", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SiteNavigationElement` struct."
  ...
  @doc "Sets the Schema.org `cssSelector` property.\n\nA CSS selector, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter case, multiple matches within a page can constitute a single conceptual \"Web page element\"."
  def css_selector(%__MODULE__{} = thing, value) do
    %{thing | css_selector: value}
  end
  ...
  @doc "Sets the Schema.org `xpath` property.\n\nAn XPath, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter case, multiple matches within a page can constitute a single conceptual \"Web page element\"."
  def xpath(%__MODULE__{} = thing, value) do
    %{thing | xpath: value}
  end
end
