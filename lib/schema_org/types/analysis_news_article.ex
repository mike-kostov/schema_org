defmodule SchemaOrg.AnalysisNewsArticle do
  @moduledoc "An AnalysisNewsArticle is a [[NewsArticle]] that, while based on factual reporting, incorporates the expertise of the author/producer, offering interpretations and conclusions."
  ...
  @doc false
  def __schema_org__, do: %{type: "AnalysisNewsArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AnalysisNewsArticle` struct."
