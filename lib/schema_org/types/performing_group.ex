defmodule SchemaOrg.PerformingGroup do
  @moduledoc "A performance group, such as a band, an orchestra, or a circus."
  ...
  @doc false
  def __schema_org__, do: %{type: "PerformingGroup", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PerformingGroup` struct."
