defmodule SchemaOrg.Airline do
  @moduledoc "An organization that provides flights for passengers."
  ...
  @doc false
  def __schema_org__, do: %{type: "Airline", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Airline` struct."
