defmodule SchemaOrg.CheckAction do
  @moduledoc "An agent inspects, determines, investigates, inquires, or examines an object's accuracy, quality, condition, or state."
  ...
  @doc false
  def __schema_org__, do: %{type: "CheckAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CheckAction` struct."
