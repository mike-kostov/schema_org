defmodule SchemaOrg.DrugStrength do
  ...
  @doc "Sets the Schema.org `availableIn` property.\n\nThe location in which the strength is available."
  def available_in(%__MODULE__{} = thing, value) do
    %{thing | available_in: value}
  end
  ...
  @doc "Sets the Schema.org `strengthUnit` property.\n\nThe units of an active ingredient's strength, e.g. mg."
  def strength_unit(%__MODULE__{} = thing, value) do
    %{thing | strength_unit: value}
  end

  @doc "Sets the Schema.org `strengthValue` property.\n\nThe value of an active ingredient's strength, e.g. 325."
  def strength_value(%__MODULE__{} = thing, value) do
    %{thing | strength_value: value}
  end
