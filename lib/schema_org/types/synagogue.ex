defmodule SchemaOrg.Synagogue do
  @moduledoc "A synagogue."
  ...
  @doc false
  def __schema_org__, do: %{type: "Synagogue", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Synagogue` struct."
