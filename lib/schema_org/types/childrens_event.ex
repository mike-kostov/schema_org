defmodule SchemaOrg.ChildrensEvent do
  @moduledoc "Event type: Children's event."
  ...
  @doc false
  def __schema_org__, do: %{type: "ChildrensEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ChildrensEvent` struct."
