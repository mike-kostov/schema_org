defmodule SchemaOrg.HyperToc do
  ...
  @doc false
  def __schema_org__, do: %{type: "HyperToc", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HyperToc` struct."
  ...
  @doc "Sets the Schema.org `tocEntry` property.\n\nIndicates a [[HyperTocEntry]] in a [[HyperToc]]."
  def toc_entry(%__MODULE__{} = thing, value) do
    %{thing | toc_entry: value}
  end
