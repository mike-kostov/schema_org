defmodule SchemaOrg.EmploymentAgency do
  @moduledoc "An employment agency."
  ...
  @doc false
  def __schema_org__, do: %{type: "EmploymentAgency", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EmploymentAgency` struct."
