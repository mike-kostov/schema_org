defmodule SchemaOrg.BroadcastFrequencySpecification do
  ...
  @doc "Sets the Schema.org `broadcastFrequencyValue` property.\n\nThe frequency in MHz for a particular broadcast."
  def broadcast_frequency_value(%__MODULE__{} = thing, value) do
    %{thing | broadcast_frequency_value: value}
  end

  @doc "Sets the Schema.org `broadcastSignalModulation` property.\n\nThe modulation (e.g. FM, AM, etc) used by a particular broadcast service."
  def broadcast_signal_modulation(%__MODULE__{} = thing, value) do
    %{thing | broadcast_signal_modulation: value}
  end

  @doc "Sets the Schema.org `broadcastSubChannel` property.\n\nThe subchannel used for the broadcast."
  def broadcast_sub_channel(%__MODULE__{} = thing, value) do
    %{thing | broadcast_sub_channel: value}
  end
