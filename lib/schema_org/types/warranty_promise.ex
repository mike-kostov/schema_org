defmodule SchemaOrg.WarrantyPromise do
  ...
  @doc "Sets the Schema.org `durationOfWarranty` property.\n\nThe duration of the warranty promise. Common unitCode values are ANN for year, MON for months, or DAY for days."
  def duration_of_warranty(%__MODULE__{} = thing, value) do
    %{thing | duration_of_warranty: value}
  end
  ...
  @doc "Sets the Schema.org `warrantyScope` property.\n\nThe scope of the warranty promise."
  def warranty_scope(%__MODULE__{} = thing, value) do
    %{thing | warranty_scope: value}
  end
end
