defmodule SchemaOrg.DepositAccount do
  @moduledoc "A type of Bank Account with a main purpose of depositing funds to gain interest or other benefits."
  ...
  @doc false
  def __schema_org__, do: %{type: "DepositAccount", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DepositAccount` struct."
