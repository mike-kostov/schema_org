defmodule SchemaOrg.LegislativeBuilding do
  @moduledoc "A legislative building&#x2014;for example, the state capitol."
  ...
  @doc false
  def __schema_org__, do: %{type: "LegislativeBuilding", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LegislativeBuilding` struct."
