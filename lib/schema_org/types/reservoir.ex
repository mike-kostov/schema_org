defmodule SchemaOrg.Reservoir do
  @moduledoc "A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir."
  ...
  @doc false
  def __schema_org__, do: %{type: "Reservoir", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Reservoir` struct."
