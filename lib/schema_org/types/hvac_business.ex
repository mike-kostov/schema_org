defmodule SchemaOrg.HVACBusiness do
  @moduledoc "A business that provides Heating, Ventilation and Air Conditioning services."
  ...
  @doc false
  def __schema_org__, do: %{type: "HVACBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HVACBusiness` struct."
