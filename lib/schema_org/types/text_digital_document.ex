defmodule SchemaOrg.TextDigitalDocument do
  @moduledoc "A file composed primarily of text."
  ...
  @doc false
  def __schema_org__, do: %{type: "TextDigitalDocument", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TextDigitalDocument` struct."
