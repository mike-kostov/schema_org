defmodule SchemaOrg.HomeAndConstructionBusiness do
  @moduledoc "A construction business.\\n\\nA HomeAndConstructionBusiness is a [[LocalBusiness]] that provides services around homes and buildings.\\n\\nAs a [[LocalBusiness]] it can be described as a [[provider]] of one or more [[Service]]\\(s)."
  ...
  @doc false
  def __schema_org__, do: %{type: "HomeAndConstructionBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HomeAndConstructionBusiness` struct."
