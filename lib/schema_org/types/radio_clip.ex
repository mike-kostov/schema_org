defmodule SchemaOrg.RadioClip do
  @moduledoc "A short radio program or a segment/part of a radio program."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadioClip", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadioClip` struct."
