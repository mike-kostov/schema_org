defmodule SchemaOrg.FoodEvent do
  @moduledoc "Event type: Food event."
  ...
  @doc false
  def __schema_org__, do: %{type: "FoodEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FoodEvent` struct."
