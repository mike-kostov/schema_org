defmodule SchemaOrg.TrainTrip do
  ...
  @doc "Sets the Schema.org `arrivalPlatform` property.\n\nThe platform where the train arrives."
  def arrival_platform(%__MODULE__{} = thing, value) do
    %{thing | arrival_platform: value}
  end

  @doc "Sets the Schema.org `arrivalStation` property.\n\nThe station where the train trip ends."
  def arrival_station(%__MODULE__{} = thing, value) do
    %{thing | arrival_station: value}
  end
  ...
  @doc "Sets the Schema.org `departurePlatform` property.\n\nThe platform from which the train departs."
  def departure_platform(%__MODULE__{} = thing, value) do
    %{thing | departure_platform: value}
  end

  @doc "Sets the Schema.org `departureStation` property.\n\nThe station from which the train departs."
  def departure_station(%__MODULE__{} = thing, value) do
    %{thing | departure_station: value}
  end
  ...
  @doc "Sets the Schema.org `trainName` property.\n\nThe name of the train (e.g. The Orient Express)."
  def train_name(%__MODULE__{} = thing, value) do
    %{thing | train_name: value}
  end

  @doc "Sets the Schema.org `trainNumber` property.\n\nThe unique identifier for the train."
  def train_number(%__MODULE__{} = thing, value) do
    %{thing | train_number: value}
  end
