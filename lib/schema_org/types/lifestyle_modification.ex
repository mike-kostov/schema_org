defmodule SchemaOrg.LifestyleModification do
  @moduledoc "A process of care involving exercise, changes to diet, fitness routines, and other lifestyle changes aimed at improving a health condition."
  ...
  @doc false
  def __schema_org__, do: %{type: "LifestyleModification", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LifestyleModification` struct."
