defmodule SchemaOrg.TVSeason do
  @moduledoc "Season dedicated to TV broadcast and associated online delivery."
  ...
  @doc false
  def __schema_org__, do: %{type: "TVSeason", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TVSeason` struct."
  ...
  @doc "Sets the Schema.org `seasonNumber` property.\n\nPosition of the season within an ordered group of seasons."
  def season_number(%__MODULE__{} = thing, value) do
    %{thing | season_number: value}
  end
