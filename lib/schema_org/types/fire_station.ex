defmodule SchemaOrg.FireStation do
  @moduledoc "A fire station. With firemen."
  ...
  @doc false
  def __schema_org__, do: %{type: "FireStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FireStation` struct."
