defmodule SchemaOrg.RadioSeason do
  @moduledoc "Season dedicated to radio broadcast and associated online delivery."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadioSeason", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadioSeason` struct."
