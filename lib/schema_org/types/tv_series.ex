defmodule SchemaOrg.TVSeries do
  @moduledoc "CreativeWorkSeries dedicated to TV broadcast and associated online delivery."
  ...
  @doc false
  def __schema_org__, do: %{type: "TVSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TVSeries` struct."
