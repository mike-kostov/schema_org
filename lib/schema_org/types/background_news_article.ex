defmodule SchemaOrg.BackgroundNewsArticle do
  ...
  @doc false
  def __schema_org__, do: %{type: "BackgroundNewsArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BackgroundNewsArticle` struct."
