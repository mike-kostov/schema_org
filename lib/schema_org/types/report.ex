defmodule SchemaOrg.Report do
  @moduledoc "A Report generated by governmental or non-governmental organization."
  ...
  @doc false
  def __schema_org__, do: %{type: "Report", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Report` struct."
  ...
  @doc "Sets the Schema.org `reportNumber` property.\n\nThe number or other unique designator assigned to a Report by the publishing organization."
  def report_number(%__MODULE__{} = thing, value) do
    %{thing | report_number: value}
  end
