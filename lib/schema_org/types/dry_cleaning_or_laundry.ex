defmodule SchemaOrg.DryCleaningOrLaundry do
  @moduledoc "A dry-cleaning business."
  ...
  @doc false
  def __schema_org__, do: %{type: "DryCleaningOrLaundry", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DryCleaningOrLaundry` struct."
