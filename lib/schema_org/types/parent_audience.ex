defmodule SchemaOrg.ParentAudience do
  ...
  @doc "Sets the Schema.org `childMaxAge` property.\n\nMaximal age of the child."
  def child_max_age(%__MODULE__{} = thing, value) do
    %{thing | child_max_age: value}
  end

  @doc "Sets the Schema.org `childMinAge` property.\n\nMinimal age of the child."
  def child_min_age(%__MODULE__{} = thing, value) do
    %{thing | child_min_age: value}
  end
