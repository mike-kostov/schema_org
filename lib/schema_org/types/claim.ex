defmodule SchemaOrg.Claim do
  ...
  @json_keys %{
    ...
    character: "character",
    citation: "citation",
    claim_interpreter: "claimInterpreter",
    comment: "comment",
  ...
  @doc false
  def __schema_org__, do: %{type: "Claim", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Claim` struct."
  ...
  @doc "Sets the Schema.org `appearance` property.\n\nIndicates an occurrence of a [[Claim]] in some [[CreativeWork]]."
  def appearance(%__MODULE__{} = thing, value) do
    %{thing | appearance: value}
  end
  ...
  @doc "Sets the Schema.org `firstAppearance` property.\n\nIndicates the first known occurrence of a [[Claim]] in some [[CreativeWork]]."
  def first_appearance(%__MODULE__{} = thing, value) do
    %{thing | first_appearance: value}
  end
