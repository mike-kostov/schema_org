defmodule SchemaOrg.PreOrderAction do
  @moduledoc "An agent orders a (not yet released) object/product/service to be delivered/sent."
  ...
  @doc false
  def __schema_org__, do: %{type: "PreOrderAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PreOrderAction` struct."
