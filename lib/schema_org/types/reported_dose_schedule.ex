defmodule SchemaOrg.ReportedDoseSchedule do
  @moduledoc "A patient-reported or observed dosing schedule for a drug or supplement."
  ...
  @doc false
  def __schema_org__, do: %{type: "ReportedDoseSchedule", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ReportedDoseSchedule` struct."
