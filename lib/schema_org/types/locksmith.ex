defmodule SchemaOrg.Locksmith do
  @moduledoc "A locksmith."
  ...
  @doc false
  def __schema_org__, do: %{type: "Locksmith", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Locksmith` struct."
