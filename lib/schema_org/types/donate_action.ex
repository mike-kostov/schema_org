defmodule SchemaOrg.DonateAction do
  @moduledoc "The act of providing goods, services, or money without compensation, often for philanthropic reasons."
  ...
  @doc false
  def __schema_org__, do: %{type: "DonateAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DonateAction` struct."
