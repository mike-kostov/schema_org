defmodule SchemaOrg.MemberProgramTier do
  ...
  @doc "Sets the Schema.org `isTierOf` property.\n\nThe member program this tier is a part of."
  def is_tier_of(%__MODULE__{} = thing, value) do
    %{thing | is_tier_of: value}
  end
