defmodule SchemaOrg.SportingGoodsStore do
  @moduledoc "A sporting goods store."
  ...
  @doc false
  def __schema_org__, do: %{type: "SportingGoodsStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SportingGoodsStore` struct."
