defmodule SchemaOrg.PodcastSeries do
  @moduledoc "A podcast is an episodic series of digital audio or video files which a user can download and listen to."
  ...
  @doc false
  def __schema_org__, do: %{type: "PodcastSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PodcastSeries` struct."
