defmodule SchemaOrg.DanceGroup do
  @moduledoc "A dance group&#x2014;for example, the Alvin Ailey Dance Theater or Riverdance."
  ...
  @doc false
  def __schema_org__, do: %{type: "DanceGroup", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DanceGroup` struct."
