defmodule SchemaOrg.PawnShop do
  @moduledoc "A shop that will buy, or lend money against the security of, personal possessions."
  ...
  @doc false
  def __schema_org__, do: %{type: "PawnShop", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PawnShop` struct."
