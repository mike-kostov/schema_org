defmodule SchemaOrg.AuthenticateAction do
  @moduledoc "The action of authenticating into a device or application."
  ...
  @doc false
  def __schema_org__, do: %{type: "AuthenticateAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AuthenticateAction` struct."
