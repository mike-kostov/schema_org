defmodule SchemaOrg.OperatingSystem do
  @moduledoc "System software that manages computer hardware and software resources, and provides common services for computer programs."
  ...
  @doc false
  def __schema_org__, do: %{type: "OperatingSystem", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OperatingSystem` struct."
