defmodule SchemaOrg.MedicalCause do
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalCause", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalCause` struct."
  ...
  @doc "Sets the Schema.org `causeOf` property.\n\nThe condition, complication, symptom, sign, etc. caused."
  def cause_of(%__MODULE__{} = thing, value) do
    %{thing | cause_of: value}
  end
