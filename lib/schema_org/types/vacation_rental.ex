defmodule SchemaOrg.VacationRental do
  @moduledoc "A kind of lodging business that focuses on renting single properties for limited time."
  ...
  @doc false
  def __schema_org__, do: %{type: "VacationRental", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VacationRental` struct."
