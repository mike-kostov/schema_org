defmodule SchemaOrg.ArchiveComponent do
  @moduledoc "An intangible type to be applied to any archive content, carrying with it a set of properties required to describe archival items and collections."
  ...
  @json_keys %{
    ...
    has_part: "hasPart",
    headline: "headline",
    holding_archive: "holdingArchive",
  ...
  @doc false
  def __schema_org__, do: %{type: "ArchiveComponent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ArchiveComponent` struct."
  ...
  @doc "Sets the Schema.org `holdingArchive` property.\n\n[[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]]."
  def holding_archive(%__MODULE__{} = thing, value) do
    %{thing | holding_archive: value}
  end
  ...
  @doc "Sets the Schema.org `itemLocation` property.\n\nCurrent location of the item."
  def item_location(%__MODULE__{} = thing, value) do
    %{thing | item_location: value}
  end
