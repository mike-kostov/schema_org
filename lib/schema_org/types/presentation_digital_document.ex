defmodule SchemaOrg.PresentationDigitalDocument do
  @moduledoc "A file containing slides or used for a presentation."
  ...
  @doc false
  def __schema_org__, do: %{type: "PresentationDigitalDocument", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PresentationDigitalDocument` struct."
  ...
  @doc "Sets the Schema.org `hasDigitalDocumentPermission` property.\n\nA permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to \"public\"."
  def has_digital_document_permission(%__MODULE__{} = thing, value) do
    %{thing | has_digital_document_permission: value}
  end
