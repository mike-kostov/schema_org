defmodule SchemaOrg.CookAction do
  ...
  @doc "Sets the Schema.org `foodEstablishment` property.\n\nA sub property of location. The specific food establishment where the action occurred."
  def food_establishment(%__MODULE__{} = thing, value) do
    %{thing | food_establishment: value}
  end

  @doc "Sets the Schema.org `foodEvent` property.\n\nA sub property of location. The specific food event where the action occurred."
  def food_event(%__MODULE__{} = thing, value) do
    %{thing | food_event: value}
  end
  ...
  @doc "Sets the Schema.org `recipe` property.\n\nA sub property of instrument. The recipe/instructions used to perform the action."
  def recipe(%__MODULE__{} = thing, value) do
    %{thing | recipe: value}
  end
