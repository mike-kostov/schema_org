defmodule SchemaOrg.SelfStorage do
  @moduledoc "A self-storage facility."
  ...
  @doc false
  def __schema_org__, do: %{type: "SelfStorage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SelfStorage` struct."
