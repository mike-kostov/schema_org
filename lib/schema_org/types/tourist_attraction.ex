defmodule SchemaOrg.TouristAttraction do
  ...
  @doc false
  def __schema_org__, do: %{type: "TouristAttraction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TouristAttraction` struct."
