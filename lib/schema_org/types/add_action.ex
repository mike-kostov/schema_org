defmodule SchemaOrg.AddAction do
  @moduledoc "The act of editing by adding an object to a collection."
  ...
  @doc false
  def __schema_org__, do: %{type: "AddAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AddAction` struct."
