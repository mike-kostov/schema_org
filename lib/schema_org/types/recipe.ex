defmodule SchemaOrg.Recipe do
  ...
  @doc false
  def __schema_org__, do: %{type: "Recipe", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Recipe` struct."
  ...
  @doc "Sets the Schema.org `cookTime` property.\n\nThe time it takes to actually cook the dish, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601)."
  def cook_time(%__MODULE__{} = thing, value) do
    %{thing | cook_time: value}
  end

  @doc "Sets the Schema.org `cookingMethod` property.\n\nThe method of cooking, such as Frying, Steaming, ..."
  def cooking_method(%__MODULE__{} = thing, value) do
    %{thing | cooking_method: value}
  end
  ...
  @doc "Sets the Schema.org `estimatedCost` property.\n\nThe estimated cost of the supply or supplies consumed when performing instructions."
  def estimated_cost(%__MODULE__{} = thing, value) do
    %{thing | estimated_cost: value}
  end
  ...
  @doc "Sets the Schema.org `ingredients` property.\n\nA single ingredient used in the recipe, e.g. sugar, flour or garlic."
  def ingredients(%__MODULE__{} = thing, value) do
    %{thing | ingredients: value}
  end
  ...
  @doc "Sets the Schema.org `nutrition` property.\n\nNutrition information about the recipe or menu item."
  def nutrition(%__MODULE__{} = thing, value) do
    %{thing | nutrition: value}
  end
  ...
  @doc "Sets the Schema.org `performTime` property.\n\nThe length of time it takes to perform instructions or a direction (not including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601)."
  def perform_time(%__MODULE__{} = thing, value) do
    %{thing | perform_time: value}
  end
  ...
  @doc "Sets the Schema.org `prepTime` property.\n\nThe length of time it takes to prepare the items to be used in instructions or a direction, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601)."
  def prep_time(%__MODULE__{} = thing, value) do
    %{thing | prep_time: value}
  end
  ...
  @doc "Sets the Schema.org `recipeCategory` property.\n\nThe category of the recipe—for example, appetizer, entree, etc."
  def recipe_category(%__MODULE__{} = thing, value) do
    %{thing | recipe_category: value}
  end

  @doc "Sets the Schema.org `recipeCuisine` property.\n\nThe cuisine of the recipe (for example, French or Ethiopian)."
  def recipe_cuisine(%__MODULE__{} = thing, value) do
    %{thing | recipe_cuisine: value}
  end

  @doc "Sets the Schema.org `recipeIngredient` property.\n\nAn ingredient or ordered list of ingredients and potentially quantities used in the recipe, e.g. 1 cup of sugar, flour or garlic.  The ingredients can be represented as free text or more structured values."
  def recipe_ingredient(%__MODULE__{} = thing, value) do
    %{thing | recipe_ingredient: value}
  end

  @doc "Sets the Schema.org `recipeInstructions` property.\n\nA step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items."
  def recipe_instructions(%__MODULE__{} = thing, value) do
    %{thing | recipe_instructions: value}
  end

  @doc "Sets the Schema.org `recipeYield` property.\n\nThe quantity produced by the recipe (for example, number of people served, number of servings, etc)."
  def recipe_yield(%__MODULE__{} = thing, value) do
    %{thing | recipe_yield: value}
  end
  ...
  @doc "Sets the Schema.org `step` property.\n\nA single step item (as HowToStep, text, document, video, etc.) or a HowToSection."
  def step(%__MODULE__{} = thing, value) do
    %{thing | step: value}
  end

  @doc "Sets the Schema.org `steps` property.\n\nA single step item (as HowToStep, text, document, video, etc.) or a HowToSection (originally misnamed 'steps'; 'step' is preferred)."
  def steps(%__MODULE__{} = thing, value) do
    %{thing | steps: value}
  end
  ...
  @doc "Sets the Schema.org `suitableForDiet` property.\n\nIndicates a dietary restriction or guideline for which this recipe or menu item is suitable, e.g. diabetic, halal etc."
  def suitable_for_diet(%__MODULE__{} = thing, value) do
    %{thing | suitable_for_diet: value}
  end

  @doc "Sets the Schema.org `supply` property.\n\nA sub-property of instrument. A supply consumed when performing instructions or a direction."
  def supply(%__MODULE__{} = thing, value) do
    %{thing | supply: value}
  end
  ...
  @doc "Sets the Schema.org `tool` property.\n\nA sub property of instrument. An object used (but not consumed) when performing instructions or a direction."
  def tool(%__MODULE__{} = thing, value) do
    %{thing | tool: value}
  end

  @doc "Sets the Schema.org `totalTime` property.\n\nThe total time required to perform instructions or a direction (including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601)."
  def total_time(%__MODULE__{} = thing, value) do
    %{thing | total_time: value}
  end
  ...
  @doc "Sets the Schema.org `yield` property.\n\nThe quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles."
  def yield(%__MODULE__{} = thing, value) do
    %{thing | yield: value}
  end
end
