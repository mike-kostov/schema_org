defmodule SchemaOrg.VeterinaryCare do
  @moduledoc "A vet's office."
  ...
  @doc false
  def __schema_org__, do: %{type: "VeterinaryCare", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VeterinaryCare` struct."
