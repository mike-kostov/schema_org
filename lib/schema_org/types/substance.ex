defmodule SchemaOrg.Substance do
  @moduledoc "Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical."
  ...
  @doc false
  def __schema_org__, do: %{type: "Substance", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Substance` struct."
