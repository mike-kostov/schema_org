defmodule SchemaOrg.MusicRelease do
  @moduledoc "A MusicRelease is a specific release of a music album."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicRelease", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicRelease` struct."
  ...
  @doc "Sets the Schema.org `catalogNumber` property.\n\nThe catalog number for the release."
  def catalog_number(%__MODULE__{} = thing, value) do
    %{thing | catalog_number: value}
  end
  ...
  @doc "Sets the Schema.org `creditedTo` property.\n\nThe group the release is credited to if different than the byArtist. For example, Red and Blue is credited to \"Stefani Germanotta Band\", but by Lady Gaga."
  def credited_to(%__MODULE__{} = thing, value) do
    %{thing | credited_to: value}
  end
  ...
  @doc "Sets the Schema.org `musicReleaseFormat` property.\n\nFormat of this release (the type of recording media used, i.e. compact disc, digital media, LP, etc.)."
  def music_release_format(%__MODULE__{} = thing, value) do
    %{thing | music_release_format: value}
  end
  ...
  @doc "Sets the Schema.org `numTracks` property.\n\nThe number of tracks in this album or playlist."
  def num_tracks(%__MODULE__{} = thing, value) do
    %{thing | num_tracks: value}
  end
  ...
  @doc "Sets the Schema.org `recordLabel` property.\n\nThe label that issued the release."
  def record_label(%__MODULE__{} = thing, value) do
    %{thing | record_label: value}
  end
  ...
  @doc "Sets the Schema.org `releaseOf` property.\n\nThe album this is a release of."
  def release_of(%__MODULE__{} = thing, value) do
    %{thing | release_of: value}
  end
  ...
  @doc "Sets the Schema.org `track` property.\n\nA music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording."
  def track(%__MODULE__{} = thing, value) do
    %{thing | track: value}
  end

  @doc "Sets the Schema.org `tracks` property.\n\nA music recording (track)&#x2014;usually a single song."
  def tracks(%__MODULE__{} = thing, value) do
    %{thing | tracks: value}
  end
