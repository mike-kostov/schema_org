defmodule SchemaOrg.ClothingStore do
  @moduledoc "A clothing store."
  ...
  @doc false
  def __schema_org__, do: %{type: "ClothingStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ClothingStore` struct."
