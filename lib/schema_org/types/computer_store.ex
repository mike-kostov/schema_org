defmodule SchemaOrg.ComputerStore do
  @moduledoc "A computer store."
  ...
  @doc false
  def __schema_org__, do: %{type: "ComputerStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ComputerStore` struct."
