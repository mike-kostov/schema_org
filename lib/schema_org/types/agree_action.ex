defmodule SchemaOrg.AgreeAction do
  @moduledoc "The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants."
  ...
  @doc false
  def __schema_org__, do: %{type: "AgreeAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AgreeAction` struct."
