defmodule SchemaOrg.MusicGroup do
  ...
  @doc "Sets the Schema.org `album` property.\n\nA music album."
  def album(%__MODULE__{} = thing, value) do
    %{thing | album: value}
  end

  @doc "Sets the Schema.org `albums` property.\n\nA collection of music albums."
  def albums(%__MODULE__{} = thing, value) do
    %{thing | albums: value}
  end
  ...
  @doc "Sets the Schema.org `musicGroupMember` property.\n\nA member of a music group&#x2014;for example, John, Paul, George, or Ringo."
  def music_group_member(%__MODULE__{} = thing, value) do
    %{thing | music_group_member: value}
  end
