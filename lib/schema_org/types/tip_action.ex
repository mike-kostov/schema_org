defmodule SchemaOrg.TipAction do
  @moduledoc "The act of giving money voluntarily to a beneficiary in recognition of services rendered."
  ...
  @doc false
  def __schema_org__, do: %{type: "TipAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TipAction` struct."
