defmodule SchemaOrg.Preschool do
  @moduledoc "A preschool."
  ...
  @doc false
  def __schema_org__, do: %{type: "Preschool", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Preschool` struct."
