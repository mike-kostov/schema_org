defmodule SchemaOrg.ExhibitionEvent do
  @moduledoc "Event type: Exhibition event, e.g. at a museum, library, archive, tradeshow, ..."
  ...
  @doc false
  def __schema_org__, do: %{type: "ExhibitionEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ExhibitionEvent` struct."
