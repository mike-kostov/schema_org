defmodule SchemaOrg.PublicationEvent do
  @moduledoc "A PublicationEvent corresponds indifferently to the event of publication for a CreativeWork of any type, e.g. a broadcast event, an on-demand event, a book/journal publication via a variety of delivery media."
  ...
  @doc false
  def __schema_org__, do: %{type: "PublicationEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PublicationEvent` struct."
