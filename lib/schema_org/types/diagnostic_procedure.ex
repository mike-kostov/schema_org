defmodule SchemaOrg.DiagnosticProcedure do
  @moduledoc "A medical procedure intended primarily for diagnostic, as opposed to therapeutic, purposes."
  ...
  @doc false
  def __schema_org__, do: %{type: "DiagnosticProcedure", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DiagnosticProcedure` struct."
