defmodule SchemaOrg.ShoppingCenter do
  @moduledoc "A shopping center or mall."
  ...
  @doc false
  def __schema_org__, do: %{type: "ShoppingCenter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ShoppingCenter` struct."
