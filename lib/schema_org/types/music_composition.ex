defmodule SchemaOrg.MusicComposition do
  @moduledoc "A musical composition."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicComposition", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicComposition` struct."
  ...
  @doc "Sets the Schema.org `firstPerformance` property.\n\nThe date and place the work was first performed."
  def first_performance(%__MODULE__{} = thing, value) do
    %{thing | first_performance: value}
  end
  ...
  @doc "Sets the Schema.org `includedComposition` property.\n\nSmaller compositions included in this work (e.g. a movement in a symphony)."
  def included_composition(%__MODULE__{} = thing, value) do
    %{thing | included_composition: value}
  end
  ...
  @doc "Sets the Schema.org `iswcCode` property.\n\nThe International Standard Musical Work Code for the composition."
  def iswc_code(%__MODULE__{} = thing, value) do
    %{thing | iswc_code: value}
  end
  ...
  @doc "Sets the Schema.org `lyricist` property.\n\nThe person who wrote the words."
  def lyricist(%__MODULE__{} = thing, value) do
    %{thing | lyricist: value}
  end

  @doc "Sets the Schema.org `lyrics` property.\n\nThe words in the song."
  def lyrics(%__MODULE__{} = thing, value) do
    %{thing | lyrics: value}
  end
  ...
  @doc "Sets the Schema.org `musicArrangement` property.\n\nAn arrangement derived from the composition."
  def music_arrangement(%__MODULE__{} = thing, value) do
    %{thing | music_arrangement: value}
  end

  @doc "Sets the Schema.org `musicCompositionForm` property.\n\nThe type of composition (e.g. overture, sonata, symphony, etc.)."
  def music_composition_form(%__MODULE__{} = thing, value) do
    %{thing | music_composition_form: value}
  end

  @doc "Sets the Schema.org `musicalKey` property.\n\nThe key, mode, or scale this composition uses."
  def musical_key(%__MODULE__{} = thing, value) do
    %{thing | musical_key: value}
  end
  ...
  @doc "Sets the Schema.org `recordedAs` property.\n\nAn audio recording of the work."
  def recorded_as(%__MODULE__{} = thing, value) do
    %{thing | recorded_as: value}
  end
