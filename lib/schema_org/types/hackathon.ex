defmodule SchemaOrg.Hackathon do
  @moduledoc "A [hackathon](https://en.wikipedia.org/wiki/Hackathon) event."
  ...
  @doc false
  def __schema_org__, do: %{type: "Hackathon", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Hackathon` struct."
