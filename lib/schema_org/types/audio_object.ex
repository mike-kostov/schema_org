defmodule SchemaOrg.AudioObject do
  @moduledoc "An audio file."
  ...
  @doc false
  def __schema_org__, do: %{type: "AudioObject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AudioObject` struct."
