defmodule SchemaOrg.SequentialArt do
  ...
  @doc "Sets the Schema.org `artEdition` property.\n\nThe number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example \"20\")."
  def art_edition(%__MODULE__{} = thing, value) do
    %{thing | art_edition: value}
  end

  @doc "Sets the Schema.org `artMedium` property.\n\nThe material used. (E.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)"
  def art_medium(%__MODULE__{} = thing, value) do
    %{thing | art_medium: value}
  end

  @doc "Sets the Schema.org `artform` property.\n\ne.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc."
  def artform(%__MODULE__{} = thing, value) do
    %{thing | artform: value}
  end

  @doc "Sets the Schema.org `artist` property.\n\nThe primary artist for a work\n    \tin a medium other than pencils or digital line art--for example, if the\n    \tprimary artwork is done in watercolors or digital paints."
  def artist(%__MODULE__{} = thing, value) do
    %{thing | artist: value}
  end

  @doc "Sets the Schema.org `artworkSurface` property.\n\nThe supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc."
  def artwork_surface(%__MODULE__{} = thing, value) do
    %{thing | artwork_surface: value}
  end
  ...
  @doc "Sets the Schema.org `colorist` property.\n\nThe individual who adds color to inked drawings."
  def colorist(%__MODULE__{} = thing, value) do
    %{thing | colorist: value}
  end
  ...
  @doc "Sets the Schema.org `inker` property.\n\nThe individual who traces over the pencil drawings in ink after pencils are complete."
  def inker(%__MODULE__{} = thing, value) do
    %{thing | inker: value}
  end
  ...
  @doc "Sets the Schema.org `letterer` property.\n\nThe individual who adds lettering, including speech balloons and sound effects, to artwork."
  def letterer(%__MODULE__{} = thing, value) do
    %{thing | letterer: value}
  end
  ...
  @doc "Sets the Schema.org `penciler` property.\n\nThe individual who draws the primary narrative artwork."
  def penciler(%__MODULE__{} = thing, value) do
    %{thing | penciler: value}
  end
  ...
  @doc "Sets the Schema.org `surface` property.\n\nA material used as a surface in some artwork, e.g. Canvas, Paper, Wood, Board, etc."
  def surface(%__MODULE__{} = thing, value) do
    %{thing | surface: value}
  end
