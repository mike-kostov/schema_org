defmodule SchemaOrg.ShoeStore do
  @moduledoc "A shoe store."
  ...
  @doc false
  def __schema_org__, do: %{type: "ShoeStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ShoeStore` struct."
