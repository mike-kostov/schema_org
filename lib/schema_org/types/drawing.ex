defmodule SchemaOrg.Drawing do
  @moduledoc "A picture or diagram made with a pencil, pen, or crayon rather than paint."
  ...
  @doc false
  def __schema_org__, do: %{type: "Drawing", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Drawing` struct."
