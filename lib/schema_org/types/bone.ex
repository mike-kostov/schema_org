defmodule SchemaOrg.Bone do
  @moduledoc "Rigid connective tissue that comprises up the skeletal structure of the human body."
  ...
  @doc false
  def __schema_org__, do: %{type: "Bone", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Bone` struct."
