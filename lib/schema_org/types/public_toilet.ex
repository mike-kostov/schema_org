defmodule SchemaOrg.PublicToilet do
  @moduledoc "A public toilet is a room or small building containing one or more toilets (and possibly also urinals) which is available for use by the general public, or by customers or employees of certain businesses."
  ...
  @doc false
  def __schema_org__, do: %{type: "PublicToilet", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PublicToilet` struct."
