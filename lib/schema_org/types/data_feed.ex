defmodule SchemaOrg.DataFeed do
  @moduledoc "A single feed providing structured information about one or more entities or topics."
  ...
  @doc false
  def __schema_org__, do: %{type: "DataFeed", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DataFeed` struct."
