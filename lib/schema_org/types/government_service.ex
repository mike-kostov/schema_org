defmodule SchemaOrg.GovernmentService do
  @moduledoc "A service provided by a government organization, e.g. food stamps, veterans benefits, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "GovernmentService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GovernmentService` struct."
  ...
  @doc "Sets the Schema.org `serviceOperator` property.\n\nThe operating organization, if different from the provider.  This enables the representation of services that are provided by an organization, but operated by another organization like a subcontractor."
  def service_operator(%__MODULE__{} = thing, value) do
    %{thing | service_operator: value}
  end
