defmodule SchemaOrg.Gene do
  ...
  @doc "Sets the Schema.org `alternativeOf` property.\n\nAnother gene which is a variation of this one."
  def alternative_of(%__MODULE__{} = thing, value) do
    %{thing | alternative_of: value}
  end
  ...
  @doc "Sets the Schema.org `encodesBioChemEntity` property.\n\nAnother BioChemEntity encoded by this one. "
  def encodes_bio_chem_entity(%__MODULE__{} = thing, value) do
    %{thing | encodes_bio_chem_entity: value}
  end

  @doc "Sets the Schema.org `expressedIn` property.\n\nTissue, organ, biological sample, etc in which activity of this gene has been observed experimentally. For example brain, digestive system."
  def expressed_in(%__MODULE__{} = thing, value) do
    %{thing | expressed_in: value}
  end
  ...
  @doc "Sets the Schema.org `hasBioPolymerSequence` property.\n\nA symbolic representation of a BioChemEntity. For example, a nucleotide sequence of a Gene or an amino acid sequence of a Protein."
  def has_bio_polymer_sequence(%__MODULE__{} = thing, value) do
    %{thing | has_bio_polymer_sequence: value}
  end
