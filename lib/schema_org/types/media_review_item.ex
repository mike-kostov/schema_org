defmodule SchemaOrg.MediaReviewItem do
  @moduledoc "Represents an item or group of closely related items treated as a unit for the sake of evaluation in a [[MediaReview]]. Authorship etc. apply to the items rather than to the curation/grouping or reviewing party."
  ...
  @json_keys %{
    ...
    media_item_appearance: "mediaItemAppearance",
    mentions: "mentions",
    name: "name",
    offers: "offers",
    owner: "owner",
  ...
  @doc false
  def __schema_org__, do: %{type: "MediaReviewItem", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MediaReviewItem` struct."
  ...
  @doc "Sets the Schema.org `mediaItemAppearance` property.\n\nIn the context of a [[MediaReview]], indicates specific media item(s) that are grouped using a [[MediaReviewItem]]."
  def media_item_appearance(%__MODULE__{} = thing, value) do
    %{thing | media_item_appearance: value}
  end
