defmodule SchemaOrg.MaximumDoseSchedule do
  @moduledoc "The maximum dosing schedule considered safe for a drug or supplement as recommended by an authority or by the drug/supplement's manufacturer. Capture the recommending authority in the recognizingAuthority property of MedicalEntity."
  ...
  @doc false
  def __schema_org__, do: %{type: "MaximumDoseSchedule", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MaximumDoseSchedule` struct."
  ...
  @doc "Sets the Schema.org `doseUnit` property.\n\nThe unit of the dose, e.g. 'mg'."
  def dose_unit(%__MODULE__{} = thing, value) do
    %{thing | dose_unit: value}
  end

  @doc "Sets the Schema.org `doseValue` property.\n\nThe value of the dose, e.g. 500."
  def dose_value(%__MODULE__{} = thing, value) do
    %{thing | dose_value: value}
  end

  @doc "Sets the Schema.org `frequency` property.\n\nHow often the dose is taken, e.g. 'daily'."
  def frequency(%__MODULE__{} = thing, value) do
    %{thing | frequency: value}
  end
