defmodule SchemaOrg.AutoWash do
  @moduledoc "A car wash business."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutoWash", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutoWash` struct."
