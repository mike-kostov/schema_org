defmodule SchemaOrg.HowTo do
  @moduledoc "Instructions that explain how to achieve a result by performing a sequence of steps."
  ...
  @doc false
  def __schema_org__, do: %{type: "HowTo", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HowTo` struct."
