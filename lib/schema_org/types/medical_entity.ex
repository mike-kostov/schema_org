defmodule SchemaOrg.MedicalEntity do
  @moduledoc "The most generic type of entity related to health and the practice of medicine."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalEntity", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalEntity` struct."
