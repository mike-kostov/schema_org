defmodule SchemaOrg.MensClothingStore do
  @moduledoc "A men's clothing store."
  ...
  @doc false
  def __schema_org__, do: %{type: "MensClothingStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MensClothingStore` struct."
