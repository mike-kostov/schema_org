defmodule SchemaOrg.Volcano do
  @moduledoc "A volcano, like Fujisan."
  ...
  @doc false
  def __schema_org__, do: %{type: "Volcano", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Volcano` struct."
