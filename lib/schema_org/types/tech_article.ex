defmodule SchemaOrg.TechArticle do
  @moduledoc "A technical article - Example: How-to (task) topics, step-by-step, procedural troubleshooting, specifications, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "TechArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TechArticle` struct."
