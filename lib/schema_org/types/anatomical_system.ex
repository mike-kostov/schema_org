defmodule SchemaOrg.AnatomicalSystem do
  ...
  @doc "Sets the Schema.org `comprisedOf` property.\n\nSpecifying something physically contained by something else. Typically used here for the underlying anatomical structures, such as organs, that comprise the anatomical system."
  def comprised_of(%__MODULE__{} = thing, value) do
    %{thing | comprised_of: value}
  end
  ...
  @doc "Sets the Schema.org `relatedStructure` property.\n\nRelated anatomical structure(s) that are not part of the system but relate or connect to it, such as vascular bundles associated with an organ system."
  def related_structure(%__MODULE__{} = thing, value) do
    %{thing | related_structure: value}
  end
