defmodule SchemaOrg.MeetingRoom do
  @moduledoc "A meeting room, conference room, or conference hall is a room provided for singular events such as business conferences and meetings (source: Wikipedia, the free encyclopedia, see <a href=\"http://en.wikipedia.org/wiki/Conference_hall\">http://en.wikipedia.org/wiki/Conference_hall</a>).\n<br /><br />\nSee also the <a href=\"/docs/hotels.html\">dedicated document on the use of schema.org for marking up hotels and other forms of accommodations</a>.\n"
  ...
  @doc false
  def __schema_org__, do: %{type: "MeetingRoom", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MeetingRoom` struct."
  def new, do: %__MODULE__{}

  @doc "Sets the Schema.org `accommodationCategory` property.\n\nCategory of an [[Accommodation]], following real estate conventions, e.g. RESO (see [PropertySubType](https://ddwiki.reso.org/display/DDW17/PropertySubType+Field), and [PropertyType](https://ddwiki.reso.org/display/DDW17/PropertyType+Field) fields  for suggested values)."
  def accommodation_category(%__MODULE__{} = thing, value) do
    %{thing | accommodation_category: value}
  end

  @doc "Sets the Schema.org `accommodationFloorPlan` property.\n\nA floorplan of some [[Accommodation]]."
  def accommodation_floor_plan(%__MODULE__{} = thing, value) do
    %{thing | accommodation_floor_plan: value}
  end
  ...
  @doc "Sets the Schema.org `bed` property.\n\nThe type of bed or beds included in the accommodation. For the single case of just one bed of a certain type, you use bed directly with a text.\n      If you want to indicate the quantity of a certain kind of bed, use an instance of BedDetails. For more detailed information, use the amenityFeature property."
  def bed(%__MODULE__{} = thing, value) do
    %{thing | bed: value}
  end
  ...
  @doc "Sets the Schema.org `occupancy` property.\n\nThe allowed total occupancy for the accommodation in persons (including infants etc). For individual accommodations, this is not necessarily the legal maximum but defines the permitted usage as per the contractual agreement (e.g. a double room used by a single person).\nTypical unit code(s): C62 for person."
  def occupancy(%__MODULE__{} = thing, value) do
    %{thing | occupancy: value}
  end
  ...
  @doc "Sets the Schema.org `permittedUsage` property.\n\nIndications regarding the permitted usage of the accommodation."
  def permitted_usage(%__MODULE__{} = thing, value) do
    %{thing | permitted_usage: value}
  end
