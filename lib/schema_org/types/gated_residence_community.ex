defmodule SchemaOrg.GatedResidenceCommunity do
  @moduledoc "Residence type: Gated community."
  ...
  @doc false
  def __schema_org__, do: %{type: "GatedResidenceCommunity", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GatedResidenceCommunity` struct."
