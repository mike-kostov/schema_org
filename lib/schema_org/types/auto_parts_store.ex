defmodule SchemaOrg.AutoPartsStore do
  @moduledoc "An auto parts store."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutoPartsStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutoPartsStore` struct."
