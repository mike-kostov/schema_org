defmodule SchemaOrg.PodcastSeason do
  @moduledoc "A single season of a podcast. Many podcasts do not break down into separate seasons. In that case, PodcastSeries should be used."
  ...
  @doc false
  def __schema_org__, do: %{type: "PodcastSeason", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PodcastSeason` struct."
