defmodule SchemaOrg.AuthorizeAction do
  @moduledoc "The act of granting permission to an object."
  ...
  @doc false
  def __schema_org__, do: %{type: "AuthorizeAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AuthorizeAction` struct."
