defmodule SchemaOrg.ProgramMembership do
  ...
  @doc "Sets the Schema.org `hostingOrganization` property.\n\nThe Organization (airline, travelers' club, retailer, etc.) the membership is made with or which offers the  MemberProgram."
  def hosting_organization(%__MODULE__{} = thing, value) do
    %{thing | hosting_organization: value}
  end
  ...
  @doc "Sets the Schema.org `membershipNumber` property.\n\nA unique identifier for the membership."
  def membership_number(%__MODULE__{} = thing, value) do
    %{thing | membership_number: value}
  end
