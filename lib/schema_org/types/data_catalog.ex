defmodule SchemaOrg.DataCatalog do
  @moduledoc "A collection of datasets."
  ...
  @doc false
  def __schema_org__, do: %{type: "DataCatalog", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DataCatalog` struct."
  ...
  @doc "Sets the Schema.org `dataset` property.\n\nA dataset contained in this catalog."
  def dataset(%__MODULE__{} = thing, value) do
    %{thing | dataset: value}
  end
