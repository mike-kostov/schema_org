defmodule SchemaOrg.LiquorStore do
  @moduledoc "A shop that sells alcoholic drinks such as wine, beer, whisky and other spirits."
  ...
  @doc false
  def __schema_org__, do: %{type: "LiquorStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LiquorStore` struct."
