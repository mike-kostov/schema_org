defmodule SchemaOrg.PlanAction do
  @moduledoc "The act of planning the execution of an event/task/action/reservation/plan to a future date."
  ...
  @doc false
  def __schema_org__, do: %{type: "PlanAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PlanAction` struct."
  ...
  @doc "Sets the Schema.org `scheduledTime` property.\n\nThe time the object is scheduled to."
  def scheduled_time(%__MODULE__{} = thing, value) do
    %{thing | scheduled_time: value}
  end
