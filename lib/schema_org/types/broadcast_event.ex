defmodule SchemaOrg.BroadcastEvent do
  ...
  @doc "Sets the Schema.org `broadcastOfEvent` property.\n\nThe event being broadcast such as a sporting event or awards ceremony."
  def broadcast_of_event(%__MODULE__{} = thing, value) do
    %{thing | broadcast_of_event: value}
  end
  ...
  @doc "Sets the Schema.org `free` property.\n\nA flag to signal that the item, event, or place is accessible for free."
  def free(%__MODULE__{} = thing, value) do
    %{thing | free: value}
  end
  ...
  @doc "Sets the Schema.org `isLiveBroadcast` property.\n\nTrue if the broadcast is of a live event."
  def is_live_broadcast(%__MODULE__{} = thing, value) do
    %{thing | is_live_broadcast: value}
  end
  ...
  @doc "Sets the Schema.org `publishedBy` property.\n\nAn agent associated with the publication event."
  def published_by(%__MODULE__{} = thing, value) do
    %{thing | published_by: value}
  end

  @doc "Sets the Schema.org `publishedOn` property.\n\nA broadcast service associated with the publication event."
  def published_on(%__MODULE__{} = thing, value) do
    %{thing | published_on: value}
  end
