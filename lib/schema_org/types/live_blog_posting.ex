defmodule SchemaOrg.LiveBlogPosting do
  ...
  @doc false
  def __schema_org__, do: %{type: "LiveBlogPosting", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LiveBlogPosting` struct."
  ...
  @doc "Sets the Schema.org `coverageEndTime` property.\n\nThe time when the live blog will stop covering the Event. Note that coverage may continue after the Event concludes."
  def coverage_end_time(%__MODULE__{} = thing, value) do
    %{thing | coverage_end_time: value}
  end

  @doc "Sets the Schema.org `coverageStartTime` property.\n\nThe time when the live blog will begin covering the Event. Note that coverage may begin before the Event's start time. The LiveBlogPosting may also be created before coverage begins."
  def coverage_start_time(%__MODULE__{} = thing, value) do
    %{thing | coverage_start_time: value}
  end
  ...
  @doc "Sets the Schema.org `liveBlogUpdate` property.\n\nAn update to the LiveBlog."
  def live_blog_update(%__MODULE__{} = thing, value) do
    %{thing | live_blog_update: value}
  end
  ...
  @doc "Sets the Schema.org `sharedContent` property.\n\nA CreativeWork such as an image, video, or audio clip shared as part of this posting."
  def shared_content(%__MODULE__{} = thing, value) do
    %{thing | shared_content: value}
  end
