defmodule SchemaOrg.LodgingBusiness do
  @moduledoc "A lodging business, such as a motel, hotel, or inn."
  ...
  @doc false
  def __schema_org__, do: %{type: "LodgingBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LodgingBusiness` struct."
