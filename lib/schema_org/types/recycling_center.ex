defmodule SchemaOrg.RecyclingCenter do
  @moduledoc "A recycling center."
  ...
  @doc false
  def __schema_org__, do: %{type: "RecyclingCenter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RecyclingCenter` struct."
