defmodule SchemaOrg.ArriveAction do
  @moduledoc "The act of arriving at a place. An agent arrives at a destination from a fromLocation, optionally with participants."
  ...
  @doc false
  def __schema_org__, do: %{type: "ArriveAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ArriveAction` struct."
