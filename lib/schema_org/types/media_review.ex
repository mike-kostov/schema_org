defmodule SchemaOrg.MediaReview do
  ...
  @json_keys %{
    ...
    original_media_link: "originalMediaLink",
    owner: "owner",
    pattern: "pattern",
    position: "position",
  ...
  @doc false
  def __schema_org__, do: %{type: "MediaReview", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MediaReview` struct."
  ...
  @doc "Sets the Schema.org `mediaAuthenticityCategory` property.\n\nIndicates a MediaManipulationRatingEnumeration classification of a media object (in the context of how it was published or shared)."
  def media_authenticity_category(%__MODULE__{} = thing, value) do
    %{thing | media_authenticity_category: value}
  end
  ...
  @doc "Sets the Schema.org `originalMediaContextDescription` property.\n\nDescribes, in a [[MediaReview]] when dealing with [[DecontextualizedContent]], background information that can contribute to better interpretation of the [[MediaObject]]."
  def original_media_context_description(%__MODULE__{} = thing, value) do
    %{thing | original_media_context_description: value}
  end

  @doc "Sets the Schema.org `originalMediaLink` property.\n\nLink to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file."
  def original_media_link(%__MODULE__{} = thing, value) do
    %{thing | original_media_link: value}
  end
