defmodule SchemaOrg.AutoBodyShop do
  @moduledoc "Auto body shop."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutoBodyShop", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutoBodyShop` struct."
