defmodule SchemaOrg.MotorcycleDealer do
  @moduledoc "A motorcycle dealer."
  ...
  @doc false
  def __schema_org__, do: %{type: "MotorcycleDealer", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MotorcycleDealer` struct."
