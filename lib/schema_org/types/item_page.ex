defmodule SchemaOrg.ItemPage do
  @moduledoc "A page devoted to a single item, such as a particular product or hotel."
  ...
  @doc false
  def __schema_org__, do: %{type: "ItemPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ItemPage` struct."
