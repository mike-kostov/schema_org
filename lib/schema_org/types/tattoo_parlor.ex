defmodule SchemaOrg.TattooParlor do
  @moduledoc "A tattoo parlor."
  ...
  @doc false
  def __schema_org__, do: %{type: "TattooParlor", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TattooParlor` struct."
