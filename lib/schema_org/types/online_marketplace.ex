defmodule SchemaOrg.OnlineMarketplace do
  @moduledoc "An eCommerce marketplace."
  ...
  @doc false
  def __schema_org__, do: %{type: "OnlineMarketplace", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OnlineMarketplace` struct."
  ...
  @doc "Sets the Schema.org `hasStore` property.\n\nAn eCommerce store part of an online marketplace."
  def has_store(%__MODULE__{} = thing, value) do
    %{thing | has_store: value}
  end
  ...
  @doc "Sets the Schema.org `isStoreOn` property.\n\nThe eCommerce marketplace this online store is on."
  def is_store_on(%__MODULE__{} = thing, value) do
    %{thing | is_store_on: value}
  end
