defmodule SchemaOrg.DefenceEstablishment do
  @moduledoc "A defence establishment, such as an army or navy base."
  ...
  @doc false
  def __schema_org__, do: %{type: "DefenceEstablishment", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DefenceEstablishment` struct."
