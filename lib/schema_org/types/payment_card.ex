defmodule SchemaOrg.PaymentCard do
  @moduledoc "A payment method using a credit, debit, store or other card to associate the payment with an account."
  ...
  @doc false
  def __schema_org__, do: %{type: "PaymentCard", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PaymentCard` struct."
