defmodule SchemaOrg.PetStore do
  @moduledoc "A pet store."
  ...
  @doc false
  def __schema_org__, do: %{type: "PetStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PetStore` struct."
