defmodule SchemaOrg.Continent do
  @moduledoc "One of the continents (for example, Europe or Africa)."
  ...
  @doc false
  def __schema_org__, do: %{type: "Continent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Continent` struct."
