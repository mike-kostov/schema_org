defmodule SchemaOrg.EventReservation do
  @moduledoc "A reservation for an event like a concert, sporting event, or lecture.\\n\\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]]."
  ...
  @doc false
  def __schema_org__, do: %{type: "EventReservation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EventReservation` struct."
