defmodule SchemaOrg.MovieSeries do
  @moduledoc "A series of movies. Included movies can be indicated with the hasPart property."
  ...
  @doc false
  def __schema_org__, do: %{type: "MovieSeries", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MovieSeries` struct."
