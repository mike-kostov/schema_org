defmodule SchemaOrg.PsychologicalTreatment do
  @moduledoc "A process of care relying upon counseling, dialogue and communication  aimed at improving a mental health condition without use of drugs."
  ...
  @doc false
  def __schema_org__, do: %{type: "PsychologicalTreatment", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PsychologicalTreatment` struct."
