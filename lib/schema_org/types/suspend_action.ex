defmodule SchemaOrg.SuspendAction do
  @moduledoc "The act of momentarily pausing a device or application (e.g. pause music playback or pause a timer)."
  ...
  @doc false
  def __schema_org__, do: %{type: "SuspendAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SuspendAction` struct."
