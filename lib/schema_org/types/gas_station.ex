defmodule SchemaOrg.GasStation do
  @moduledoc "A gas station."
  ...
  @doc false
  def __schema_org__, do: %{type: "GasStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GasStation` struct."
