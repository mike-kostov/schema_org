defmodule SchemaOrg.MedicalBusiness do
  @moduledoc "A particular physical or virtual business of an organization for medical purposes. Examples of MedicalBusiness include different businesses run by health professionals."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalBusiness` struct."
