defmodule SchemaOrg.Distillery do
  @moduledoc "A distillery."
  ...
  @doc false
  def __schema_org__, do: %{type: "Distillery", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Distillery` struct."
