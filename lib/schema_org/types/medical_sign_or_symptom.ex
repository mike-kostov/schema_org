defmodule SchemaOrg.MedicalSignOrSymptom do
  @moduledoc "Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalSignOrSymptom", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalSignOrSymptom` struct."
