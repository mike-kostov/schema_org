defmodule SchemaOrg.MedicalSign do
  ...
  @doc "Sets the Schema.org `identifyingExam` property.\n\nA physical examination that can identify this sign."
  def identifying_exam(%__MODULE__{} = thing, value) do
    %{thing | identifying_exam: value}
  end

  @doc "Sets the Schema.org `identifyingTest` property.\n\nA diagnostic test that can identify this sign."
  def identifying_test(%__MODULE__{} = thing, value) do
    %{thing | identifying_test: value}
  end
