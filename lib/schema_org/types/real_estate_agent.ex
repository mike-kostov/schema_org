defmodule SchemaOrg.RealEstateAgent do
  @moduledoc "A real-estate agent."
  ...
  @doc false
  def __schema_org__, do: %{type: "RealEstateAgent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RealEstateAgent` struct."
