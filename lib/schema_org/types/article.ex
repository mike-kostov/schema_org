defmodule SchemaOrg.Article do
  @moduledoc "An article, such as a news article or piece of investigative report. Newspapers and magazines have articles of many different types and this is intended to cover them all.\\n\\nSee also [blog post](https://blog.schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/)."
  ...
  @doc false
  def __schema_org__, do: %{type: "Article", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Article` struct."
