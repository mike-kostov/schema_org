defmodule SchemaOrg.BusTrip do
  ...
  @doc "Sets the Schema.org `arrivalBusStop` property.\n\nThe stop or station from which the bus arrives."
  def arrival_bus_stop(%__MODULE__{} = thing, value) do
    %{thing | arrival_bus_stop: value}
  end
  ...
  @doc "Sets the Schema.org `busName` property.\n\nThe name of the bus (e.g. Bolt Express)."
  def bus_name(%__MODULE__{} = thing, value) do
    %{thing | bus_name: value}
  end

  @doc "Sets the Schema.org `busNumber` property.\n\nThe unique identifier for the bus."
  def bus_number(%__MODULE__{} = thing, value) do
    %{thing | bus_number: value}
  end

  @doc "Sets the Schema.org `departureBusStop` property.\n\nThe stop or station from which the bus departs."
  def departure_bus_stop(%__MODULE__{} = thing, value) do
    %{thing | departure_bus_stop: value}
  end
