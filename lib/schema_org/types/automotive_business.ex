defmodule SchemaOrg.AutomotiveBusiness do
  @moduledoc "Car repair, sales, or parts."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutomotiveBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutomotiveBusiness` struct."
