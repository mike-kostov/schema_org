defmodule SchemaOrg.VideoObjectSnapshot do
  ...
  @doc false
  def __schema_org__, do: %{type: "VideoObjectSnapshot", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VideoObjectSnapshot` struct."
  ...
  @doc "Sets the Schema.org `videoFrameSize` property.\n\nThe frame size of the video."
  def video_frame_size(%__MODULE__{} = thing, value) do
    %{thing | video_frame_size: value}
  end

  @doc "Sets the Schema.org `videoQuality` property.\n\nThe quality of the video."
  def video_quality(%__MODULE__{} = thing, value) do
    %{thing | video_quality: value}
  end
