defmodule SchemaOrg.VoteAction do
  @moduledoc "The act of expressing a preference from a fixed/finite/structured set of choices/options."
  ...
  @doc false
  def __schema_org__, do: %{type: "VoteAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VoteAction` struct."
  def new, do: %__MODULE__{}

  @doc "Sets the Schema.org `actionOption` property.\n\nA sub property of object. The options subject to this action."
  def action_option(%__MODULE__{} = thing, value) do
    %{thing | action_option: value}
  end
  ...
  @doc "Sets the Schema.org `candidate` property.\n\nA sub property of object. The candidate subject of this action."
  def candidate(%__MODULE__{} = thing, value) do
    %{thing | candidate: value}
  end
  ...
  @doc "Sets the Schema.org `option` property.\n\nA sub property of object. The options subject to this action."
  def option(%__MODULE__{} = thing, value) do
    %{thing | option: value}
  end
