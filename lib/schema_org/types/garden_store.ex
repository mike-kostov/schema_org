defmodule SchemaOrg.GardenStore do
  @moduledoc "A garden store."
  ...
  @doc false
  def __schema_org__, do: %{type: "GardenStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GardenStore` struct."
