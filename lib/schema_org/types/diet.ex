defmodule SchemaOrg.Diet do
  @moduledoc "A strategy of regulating the intake of food to achieve or maintain a specific health-related goal."
  ...
  @json_keys %{
    ...
    expert_considerations: "expertConsiderations",
    expires: "expires",
    ...
    owner: "owner",
    pattern: "pattern",
    physiological_benefits: "physiologicalBenefits",
    position: "position",
  ...
  @doc false
  def __schema_org__, do: %{type: "Diet", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Diet` struct."
  ...
  @doc "Sets the Schema.org `dietFeatures` property.\n\nNutritional information specific to the dietary plan. May include dietary recommendations on what foods to avoid, what foods to consume, and specific alterations/deviations from the USDA or other regulatory body's approved dietary guidelines."
  def diet_features(%__MODULE__{} = thing, value) do
    %{thing | diet_features: value}
  end
  ...
  @doc "Sets the Schema.org `endorsers` property.\n\nPeople or organizations that endorse the plan."
  def endorsers(%__MODULE__{} = thing, value) do
    %{thing | endorsers: value}
  end
  ...
  @doc "Sets the Schema.org `expertConsiderations` property.\n\nMedical expert advice related to the plan."
  def expert_considerations(%__MODULE__{} = thing, value) do
    %{thing | expert_considerations: value}
  end
  ...
  @doc "Sets the Schema.org `physiologicalBenefits` property.\n\nSpecific physiologic benefits associated to the plan."
  def physiological_benefits(%__MODULE__{} = thing, value) do
    %{thing | physiological_benefits: value}
  end
  ...
  @doc "Sets the Schema.org `risks` property.\n\nSpecific physiologic risks associated to the diet plan."
  def risks(%__MODULE__{} = thing, value) do
    %{thing | risks: value}
  end
