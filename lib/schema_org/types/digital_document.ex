defmodule SchemaOrg.DigitalDocument do
  @moduledoc "An electronic file or document."
  ...
  @doc false
  def __schema_org__, do: %{type: "DigitalDocument", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DigitalDocument` struct."
