defmodule SchemaOrg.LegislationObject do
  @moduledoc "A specific object or file containing a Legislation. Note that the same Legislation can be published in multiple files. For example, a digitally signed PDF, a plain PDF and an HTML version."
  ...
  @json_keys %{
    ...
    legislation_legal_value: "legislationLegalValue",
  ...
  @doc false
  def __schema_org__, do: %{type: "LegislationObject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LegislationObject` struct."
  ...
  @doc "Sets the Schema.org `associatedArticle` property.\n\nA NewsArticle associated with the Media Object."
  def associated_article(%__MODULE__{} = thing, value) do
    %{thing | associated_article: value}
  end
  ...
  @doc "Sets the Schema.org `bitrate` property.\n\nThe bitrate of the media object."
  def bitrate(%__MODULE__{} = thing, value) do
    %{thing | bitrate: value}
  end
  ...
  @doc "Sets the Schema.org `contentSize` property.\n\nFile size in (mega/kilo)bytes."
  def content_size(%__MODULE__{} = thing, value) do
    %{thing | content_size: value}
  end

  @doc "Sets the Schema.org `contentUrl` property.\n\nActual bytes of the media object, for example the image file or video file."
  def content_url(%__MODULE__{} = thing, value) do
    %{thing | content_url: value}
  end
  ...
  @doc "Sets the Schema.org `embedUrl` property.\n\nA URL pointing to a player for a specific video. In general, this is the information in the ```src``` element of an ```embed``` tag and should not be the same as the content of the ```loc``` tag."
  def embed_url(%__MODULE__{} = thing, value) do
    %{thing | embed_url: value}
  end

  @doc "Sets the Schema.org `encodesCreativeWork` property.\n\nThe CreativeWork encoded by this media object."
  def encodes_creative_work(%__MODULE__{} = thing, value) do
    %{thing | encodes_creative_work: value}
  end
  ...
  @doc "Sets the Schema.org `jurisdiction` property.\n\nIndicates a legal jurisdiction, e.g. of some legislation, or where some government service is based."
  def jurisdiction(%__MODULE__{} = thing, value) do
    %{thing | jurisdiction: value}
  end
  ...
  @doc "Sets the Schema.org `legislationAmends` property.\n\nAnother legislation that this legislation amends, introducing legal changes."
  def legislation_amends(%__MODULE__{} = thing, value) do
    %{thing | legislation_amends: value}
  end

  @doc "Sets the Schema.org `legislationApplies` property.\n\nIndicates that this legislation (or part of a legislation) somehow transfers another legislation in a different legislative context. This is an informative link, and it has no legal value. For legally-binding links of transposition, use the <a href=\"/legislationTransposes\">legislationTransposes</a> property. For example an informative consolidated law of a European Union's member state \"applies\" the consolidated version of the European Directive implemented in it."
  def legislation_applies(%__MODULE__{} = thing, value) do
    %{thing | legislation_applies: value}
  end

  @doc "Sets the Schema.org `legislationChanges` property.\n\nAnother legislation that this legislation changes. This encompasses the notions of amendment, replacement, correction, repeal, or other types of change. This may be a direct change (textual or non-textual amendment) or a consequential or indirect change. The property is to be used to express the existence of a change relationship between two acts rather than the existence of a consolidated version of the text that shows the result of the change. For consolidation relationships, use the <a href=\"/legislationConsolidates\">legislationConsolidates</a> property."
  def legislation_changes(%__MODULE__{} = thing, value) do
    %{thing | legislation_changes: value}
  end

  @doc "Sets the Schema.org `legislationCommences` property.\n\nAnother legislation that this one sets into force."
  def legislation_commences(%__MODULE__{} = thing, value) do
    %{thing | legislation_commences: value}
  end

  @doc "Sets the Schema.org `legislationConsolidates` property.\n\nIndicates another legislation taken into account in this consolidated legislation (which is usually the product of an editorial process that revises the legislation). This property should be used multiple times to refer to both the original version or the previous consolidated version, and to the legislations making the change."
  def legislation_consolidates(%__MODULE__{} = thing, value) do
    %{thing | legislation_consolidates: value}
  end

  @doc "Sets the Schema.org `legislationCorrects` property.\n\nAnother legislation in which this one introduces textual changes, like correction of spelling mistakes, with no legal impact (for modifications that have legal impact, use <a href=\"/legislationAmends\">legislationAmends</a>)."
  def legislation_corrects(%__MODULE__{} = thing, value) do
    %{thing | legislation_corrects: value}
  end

  @doc "Sets the Schema.org `legislationCountersignedBy` property.\n\nThe person or organization that countersigned the legislation. Depending on the legal context, a countersignature can indicate that the signed authority undertakes to assume responsibility for texts emanating from a person who is inviolable and irresponsible, (for example a King, Grand Duc or President), or that the authority is in charge of the implementation of the text."
  def legislation_countersigned_by(%__MODULE__{} = thing, value) do
    %{thing | legislation_countersigned_by: value}
  end

  @doc "Sets the Schema.org `legislationDate` property.\n\nThe date of adoption or signature of the legislation. This is the date at which the text is officially aknowledged to be a legislation, even though it might not even be published or in force."
  def legislation_date(%__MODULE__{} = thing, value) do
    %{thing | legislation_date: value}
  end

  @doc "Sets the Schema.org `legislationDateOfApplicability` property.\n\nThe date at which the Legislation becomes applicable. This can sometimes be distinct from the date of entry into force : a text may come in force today, and state it will become applicable in 3 months."
  def legislation_date_of_applicability(%__MODULE__{} = thing, value) do
    %{thing | legislation_date_of_applicability: value}
  end

  @doc "Sets the Schema.org `legislationDateVersion` property.\n\nThe point-in-time at which the provided description of the legislation is valid (e.g.: when looking at the law on the 2016-04-07 (= dateVersion), I get the consolidation of 2015-04-12 of the \"National Insurance Contributions Act 2015\")"
  def legislation_date_version(%__MODULE__{} = thing, value) do
    %{thing | legislation_date_version: value}
  end

  @doc "Sets the Schema.org `legislationEnsuresImplementationOf` property.\n\nIndicates that this Legislation ensures the implementation of another Legislation, for example by modifying national legislations so that they do not contradict to an EU regulation or decision. This implies a legal meaning. Transpositions of EU Directive should be captured with <a href=\"/legislationTransposes\">legislationTransposes</a>."
  def legislation_ensures_implementation_of(%__MODULE__{} = thing, value) do
    %{thing | legislation_ensures_implementation_of: value}
  end

  @doc "Sets the Schema.org `legislationIdentifier` property.\n\nAn identifier for the legislation. This can be either a string-based identifier, like the CELEX at EU level or the NOR in France, or a web-based, URL/URI identifier, like an ELI (European Legislation Identifier) or an URN-Lex."
  def legislation_identifier(%__MODULE__{} = thing, value) do
    %{thing | legislation_identifier: value}
  end

  @doc "Sets the Schema.org `legislationJurisdiction` property.\n\nThe jurisdiction from which the legislation originates."
  def legislation_jurisdiction(%__MODULE__{} = thing, value) do
    %{thing | legislation_jurisdiction: value}
  end

  @doc "Sets the Schema.org `legislationLegalForce` property.\n\nWhether the legislation is currently in force, not in force, or partially in force."
  def legislation_legal_force(%__MODULE__{} = thing, value) do
    %{thing | legislation_legal_force: value}
  end

  @doc "Sets the Schema.org `legislationLegalValue` property.\n\nThe legal value of this legislation file. The same legislation can be written in multiple files with different legal values. Typically a digitally signed PDF have a \"stronger\" legal value than the HTML file of the same act."
  def legislation_legal_value(%__MODULE__{} = thing, value) do
    %{thing | legislation_legal_value: value}
  end

  @doc "Sets the Schema.org `legislationPassedBy` property.\n\nThe person or organization that originally passed or made the law: typically parliament (for primary legislation) or government (for secondary legislation). This indicates the \"legal author\" of the law, as opposed to its physical author."
  def legislation_passed_by(%__MODULE__{} = thing, value) do
    %{thing | legislation_passed_by: value}
  end

  @doc "Sets the Schema.org `legislationRepeals` property.\n\nAnother legislation that this legislation repeals (cancels, abrogates)."
  def legislation_repeals(%__MODULE__{} = thing, value) do
    %{thing | legislation_repeals: value}
  end

  @doc "Sets the Schema.org `legislationResponsible` property.\n\nAn individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published."
  def legislation_responsible(%__MODULE__{} = thing, value) do
    %{thing | legislation_responsible: value}
  end

  @doc "Sets the Schema.org `legislationTransposes` property.\n\nIndicates that this legislation (or part of legislation) fulfills the objectives set by another legislation, by passing appropriate implementation measures. Typically, some legislations of European Union's member states or regions transpose European Directives. This indicates a legally binding link between the 2 legislations."
  def legislation_transposes(%__MODULE__{} = thing, value) do
    %{thing | legislation_transposes: value}
  end

  @doc "Sets the Schema.org `legislationType` property.\n\nThe type of the legislation. Examples of values are \"law\", \"act\", \"directive\", \"decree\", \"regulation\", \"statutory instrument\", \"loi organique\", \"règlement grand-ducal\", etc., depending on the country."
  def legislation_type(%__MODULE__{} = thing, value) do
    %{thing | legislation_type: value}
  end
  ...
  @doc "Sets the Schema.org `playerType` property.\n\nPlayer type required&#x2014;for example, Flash or Silverlight."
  def player_type(%__MODULE__{} = thing, value) do
    %{thing | player_type: value}
  end
  ...
  @doc "Sets the Schema.org `productionCompany` property.\n\nThe production company or studio responsible for the item, e.g. series, video game, episode etc."
  def production_company(%__MODULE__{} = thing, value) do
    %{thing | production_company: value}
  end
  ...
  @doc "Sets the Schema.org `sha256` property.\n\nThe [SHA-2](https://en.wikipedia.org/wiki/SHA-2) SHA256 hash of the content of the item. For example, a zero-length input has value 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'."
  def sha256(%__MODULE__{} = thing, value) do
    %{thing | sha256: value}
  end
  ...
  @doc "Sets the Schema.org `uploadDate` property.\n\nDate (including time if available) when this media object was uploaded to this site."
  def upload_date(%__MODULE__{} = thing, value) do
    %{thing | upload_date: value}
  end
