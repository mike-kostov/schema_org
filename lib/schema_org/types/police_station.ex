defmodule SchemaOrg.PoliceStation do
  @moduledoc "A police station."
  ...
  @doc false
  def __schema_org__, do: %{type: "PoliceStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PoliceStation` struct."
