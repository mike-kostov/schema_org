defmodule SchemaOrg.LakeBodyOfWater do
  @moduledoc "A lake (for example, Lake Pontrachain)."
  ...
  @doc false
  def __schema_org__, do: %{type: "LakeBodyOfWater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LakeBodyOfWater` struct."
