defmodule SchemaOrg.DoseSchedule do
  @moduledoc "A specific dosing schedule for a drug or supplement."
  ...
  @doc false
  def __schema_org__, do: %{type: "DoseSchedule", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DoseSchedule` struct."
