defmodule SchemaOrg.VideoObject do
  @moduledoc "A video file."
  ...
  @doc false
  def __schema_org__, do: %{type: "VideoObject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VideoObject` struct."
