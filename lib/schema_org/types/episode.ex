defmodule SchemaOrg.Episode do
  @moduledoc "A media episode (e.g. TV, radio, video game) which can be part of a series or season."
  ...
  @doc false
  def __schema_org__, do: %{type: "Episode", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Episode` struct."
