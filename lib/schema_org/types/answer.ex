defmodule SchemaOrg.Answer do
  @moduledoc "An answer offered to a question; perhaps correct, perhaps opinionated or wrong."
  ...
  @doc false
  def __schema_org__, do: %{type: "Answer", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Answer` struct."
  ...
  @doc "Sets the Schema.org `answerExplanation` property.\n\nA step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. "
  def answer_explanation(%__MODULE__{} = thing, value) do
    %{thing | answer_explanation: value}
  end
