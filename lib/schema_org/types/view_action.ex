defmodule SchemaOrg.ViewAction do
  @moduledoc "The act of consuming static visual content."
  ...
  @doc false
  def __schema_org__, do: %{type: "ViewAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ViewAction` struct."
