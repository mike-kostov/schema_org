defmodule SchemaOrg.SportsOrganization do
  @moduledoc "Represents the collection of all sports organizations, including sports teams, governing bodies, and sports associations."
  ...
  @doc false
  def __schema_org__, do: %{type: "SportsOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SportsOrganization` struct."
