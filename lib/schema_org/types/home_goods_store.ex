defmodule SchemaOrg.HomeGoodsStore do
  @moduledoc "A home goods store."
  ...
  @doc false
  def __schema_org__, do: %{type: "HomeGoodsStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HomeGoodsStore` struct."
