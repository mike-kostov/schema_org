defmodule SchemaOrg.CreativeWork do
  @moduledoc "The most generic kind of creative work, including books, movies, photographs, software programs, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "CreativeWork", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CreativeWork` struct."
