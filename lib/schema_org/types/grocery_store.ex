defmodule SchemaOrg.GroceryStore do
  @moduledoc "A grocery store."
  ...
  @doc false
  def __schema_org__, do: %{type: "GroceryStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GroceryStore` struct."
