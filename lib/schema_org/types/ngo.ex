defmodule SchemaOrg.NGO do
  @moduledoc "Organization: Non-governmental Organization."
  ...
  @doc false
  def __schema_org__, do: %{type: "NGO", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.NGO` struct."
