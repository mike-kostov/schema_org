defmodule SchemaOrg.HealthPlanFormulary do
  ...
  @doc "Sets the Schema.org `healthPlanCostSharing` property.\n\nThe costs to the patient for services under this network or formulary."
  def health_plan_cost_sharing(%__MODULE__{} = thing, value) do
    %{thing | health_plan_cost_sharing: value}
  end
  ...
  @doc "Sets the Schema.org `offersPrescriptionByMail` property.\n\nWhether prescriptions can be delivered by mail."
  def offers_prescription_by_mail(%__MODULE__{} = thing, value) do
    %{thing | offers_prescription_by_mail: value}
  end
