defmodule SchemaOrg.DiscoverAction do
  @moduledoc "The act of discovering/finding an object."
  ...
  @doc false
  def __schema_org__, do: %{type: "DiscoverAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DiscoverAction` struct."
