defmodule SchemaOrg.WebSite do
  @moduledoc "A WebSite is a set of related web pages and other items typically served from a single web domain and accessible via URLs."
  ...
  @doc false
  def __schema_org__, do: %{type: "WebSite", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WebSite` struct."
