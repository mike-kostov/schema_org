defmodule SchemaOrg.APIReference do
  @moduledoc "Reference documentation for application programming interfaces (APIs)."
  ...
  @doc false
  def __schema_org__, do: %{type: "APIReference", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.APIReference` struct."
  ...
  @doc "Sets the Schema.org `assembly` property.\n\nLibrary file name, e.g., mscorlib.dll, system.web.dll."
  def assembly(%__MODULE__{} = thing, value) do
    %{thing | assembly: value}
  end

  @doc "Sets the Schema.org `assemblyVersion` property.\n\nAssociated product/technology version. E.g., .NET Framework 4.5."
  def assembly_version(%__MODULE__{} = thing, value) do
    %{thing | assembly_version: value}
  end
  ...
  @doc "Sets the Schema.org `dependencies` property.\n\nPrerequisites needed to fulfill steps in article."
  def dependencies(%__MODULE__{} = thing, value) do
    %{thing | dependencies: value}
  end
  ...
  @doc "Sets the Schema.org `executableLibraryName` property.\n\nLibrary file name, e.g., mscorlib.dll, system.web.dll."
  def executable_library_name(%__MODULE__{} = thing, value) do
    %{thing | executable_library_name: value}
  end
  ...
  @doc "Sets the Schema.org `proficiencyLevel` property.\n\nProficiency needed for this content; expected values: 'Beginner', 'Expert'."
  def proficiency_level(%__MODULE__{} = thing, value) do
    %{thing | proficiency_level: value}
  end

  @doc "Sets the Schema.org `programmingModel` property.\n\nIndicates whether API is managed or unmanaged."
  def programming_model(%__MODULE__{} = thing, value) do
    %{thing | programming_model: value}
  end
  ...
  @doc "Sets the Schema.org `targetPlatform` property.\n\nType of app development: phone, Metro style, desktop, XBox, etc."
  def target_platform(%__MODULE__{} = thing, value) do
    %{thing | target_platform: value}
  end
