defmodule SchemaOrg.EndorseAction do
  @moduledoc "An agent approves/certifies/likes/supports/sanctions an object."
  ...
  @doc false
  def __schema_org__, do: %{type: "EndorseAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EndorseAction` struct."
  ...
  @doc "Sets the Schema.org `endorsee` property.\n\nA sub property of participant. The person/organization being supported."
  def endorsee(%__MODULE__{} = thing, value) do
    %{thing | endorsee: value}
  end
