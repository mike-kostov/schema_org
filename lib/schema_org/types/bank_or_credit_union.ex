defmodule SchemaOrg.BankOrCreditUnion do
  @moduledoc "Bank or credit union."
  ...
  @doc false
  def __schema_org__, do: %{type: "BankOrCreditUnion", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BankOrCreditUnion` struct."
