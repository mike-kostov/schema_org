defmodule SchemaOrg.HowToSection do
  @moduledoc "A sub-grouping of steps in the instructions for how to achieve a result (e.g. steps for making a pie crust within a pie recipe)."
  ...
  @doc false
  def __schema_org__, do: %{type: "HowToSection", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HowToSection` struct."
