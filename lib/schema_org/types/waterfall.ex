defmodule SchemaOrg.Waterfall do
  @moduledoc "A waterfall, like Niagara."
  ...
  @doc false
  def __schema_org__, do: %{type: "Waterfall", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Waterfall` struct."
