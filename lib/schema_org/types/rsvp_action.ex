defmodule SchemaOrg.RsvpAction do
  ...
  @doc "Sets the Schema.org `additionalNumberOfGuests` property.\n\nIf responding yes, the number of guests who will attend in addition to the invitee."
  def additional_number_of_guests(%__MODULE__{} = thing, value) do
    %{thing | additional_number_of_guests: value}
  end
  ...
  @doc "Sets the Schema.org `rsvpResponse` property.\n\nThe response (yes, no, maybe) to the RSVP."
  def rsvp_response(%__MODULE__{} = thing, value) do
    %{thing | rsvp_response: value}
  end
