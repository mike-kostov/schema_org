defmodule SchemaOrg.EventVenue do
  @moduledoc "An event venue."
  ...
  @doc false
  def __schema_org__, do: %{type: "EventVenue", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EventVenue` struct."
