defmodule SchemaOrg.SearchRescueOrganization do
  @moduledoc "A Search and Rescue organization of some kind."
  ...
  @doc false
  def __schema_org__, do: %{type: "SearchRescueOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SearchRescueOrganization` struct."
