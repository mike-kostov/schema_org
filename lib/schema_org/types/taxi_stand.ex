defmodule SchemaOrg.TaxiStand do
  @moduledoc "A taxi stand."
  ...
  @doc false
  def __schema_org__, do: %{type: "TaxiStand", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TaxiStand` struct."
