defmodule SchemaOrg.HyperTocEntry do
  ...
  @json_keys %{
    ...
    toc_continuation: "tocContinuation",
  ...
  @doc false
  def __schema_org__, do: %{type: "HyperTocEntry", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HyperTocEntry` struct."
  ...
  @doc "Sets the Schema.org `utterances` property.\n\nText of an utterances (spoken words, lyrics etc.) that occurs at a certain section of a media object, represented as a [[HyperTocEntry]]."
  def utterances(%__MODULE__{} = thing, value) do
    %{thing | utterances: value}
  end
