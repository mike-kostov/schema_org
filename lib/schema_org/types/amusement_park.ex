defmodule SchemaOrg.AmusementPark do
  @moduledoc "An amusement park."
  ...
  @doc false
  def __schema_org__, do: %{type: "AmusementPark", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AmusementPark` struct."
