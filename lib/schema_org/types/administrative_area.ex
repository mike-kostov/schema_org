defmodule SchemaOrg.AdministrativeArea do
  @moduledoc "A geographical region, typically under the jurisdiction of a particular government."
  ...
  @doc false
  def __schema_org__, do: %{type: "AdministrativeArea", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AdministrativeArea` struct."
