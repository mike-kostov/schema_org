defmodule SchemaOrg.ParkingFacility do
  @moduledoc "A parking lot or other parking facility."
  ...
  @doc false
  def __schema_org__, do: %{type: "ParkingFacility", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ParkingFacility` struct."
