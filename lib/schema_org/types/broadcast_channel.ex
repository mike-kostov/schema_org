defmodule SchemaOrg.BroadcastChannel do
  @moduledoc "A unique instance of a BroadcastService on a CableOrSatelliteService lineup."
  ...
  @doc false
  def __schema_org__, do: %{type: "BroadcastChannel", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BroadcastChannel` struct."
