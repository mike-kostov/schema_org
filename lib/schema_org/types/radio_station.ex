defmodule SchemaOrg.RadioStation do
  @moduledoc "A radio station."
  ...
  @doc false
  def __schema_org__, do: %{type: "RadioStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.RadioStation` struct."
