defmodule SchemaOrg.ContactPage do
  @moduledoc "Web page type: Contact page."
  ...
  @doc false
  def __schema_org__, do: %{type: "ContactPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ContactPage` struct."
