defmodule SchemaOrg.MovieTheater do
  @moduledoc "A movie theater."
  ...
  @doc false
  def __schema_org__, do: %{type: "MovieTheater", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MovieTheater` struct."
  ...
  @doc "Sets the Schema.org `screenCount` property.\n\nThe number of screens in the movie theater."
  def screen_count(%__MODULE__{} = thing, value) do
    %{thing | screen_count: value}
  end
