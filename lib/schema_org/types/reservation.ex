defmodule SchemaOrg.Reservation do
  @moduledoc "Describes a reservation for travel, dining or an event. Some reservations require tickets. \\n\\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, restaurant reservations, flights, or rental cars, use [[Offer]]."
  ...
  @doc false
  def __schema_org__, do: %{type: "Reservation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Reservation` struct."
