defmodule SchemaOrg.AggregateOffer do
  ...
  @doc "Sets the Schema.org `highPrice` property.\n\nThe highest price of all offers available.\\n\\nUsage guidelines:\\n\\n* Use values from 0123456789 (Unicode 'DIGIT ZERO' (U+0030) to 'DIGIT NINE' (U+0039)) rather than superficially similar Unicode symbols.\\n* Use '.' (Unicode 'FULL STOP' (U+002E)) rather than ',' to indicate a decimal point. Avoid using these symbols as a readability separator."
  def high_price(%__MODULE__{} = thing, value) do
    %{thing | high_price: value}
  end
  ...
  @doc "Sets the Schema.org `lowPrice` property.\n\nThe lowest price of all offers available.\\n\\nUsage guidelines:\\n\\n* Use values from 0123456789 (Unicode 'DIGIT ZERO' (U+0030) to 'DIGIT NINE' (U+0039)) rather than superficially similar Unicode symbols.\\n* Use '.' (Unicode 'FULL STOP' (U+002E)) rather than ',' to indicate a decimal point. Avoid using these symbols as a readability separator."
  def low_price(%__MODULE__{} = thing, value) do
    %{thing | low_price: value}
  end
  ...
  @doc "Sets the Schema.org `offerCount` property.\n\nThe number of offers for the product."
  def offer_count(%__MODULE__{} = thing, value) do
    %{thing | offer_count: value}
  end
