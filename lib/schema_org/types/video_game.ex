defmodule SchemaOrg.VideoGame do
  @moduledoc "A video game is an electronic game that involves human interaction with a user interface to generate visual feedback on a video device."
  ...
  @doc false
  def __schema_org__, do: %{type: "VideoGame", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VideoGame` struct."
  ...
  @doc "Sets the Schema.org `actors` property.\n\nAn actor, e.g. in TV, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip."
  def actors(%__MODULE__{} = thing, value) do
    %{thing | actors: value}
  end
  ...
  @doc "Sets the Schema.org `applicationCategory` property.\n\nType of software application, e.g. 'Game, Multimedia'."
  def application_category(%__MODULE__{} = thing, value) do
    %{thing | application_category: value}
  end

  @doc "Sets the Schema.org `applicationSubCategory` property.\n\nSubcategory of the application, e.g. 'Arcade Game'."
  def application_sub_category(%__MODULE__{} = thing, value) do
    %{thing | application_sub_category: value}
  end

  @doc "Sets the Schema.org `applicationSuite` property.\n\nThe name of the application suite to which the application belongs (e.g. Excel belongs to Office)."
  def application_suite(%__MODULE__{} = thing, value) do
    %{thing | application_suite: value}
  end
  ...
  @doc "Sets the Schema.org `availableOnDevice` property.\n\nDevice required to run the application. Used in cases where a specific make/model is required to run the application."
  def available_on_device(%__MODULE__{} = thing, value) do
    %{thing | available_on_device: value}
  end
  ...
  @doc "Sets the Schema.org `characterAttribute` property.\n\nA piece of data that represents a particular aspect of a fictional character (skill, power, character points, advantage, disadvantage)."
  def character_attribute(%__MODULE__{} = thing, value) do
    %{thing | character_attribute: value}
  end

  @doc "Sets the Schema.org `cheatCode` property.\n\nCheat codes to the game."
  def cheat_code(%__MODULE__{} = thing, value) do
    %{thing | cheat_code: value}
  end
  ...
  @doc "Sets the Schema.org `countriesNotSupported` property.\n\nCountries for which the application is not supported. You can also provide the two-letter ISO 3166-1 alpha-2 country code."
  def countries_not_supported(%__MODULE__{} = thing, value) do
    %{thing | countries_not_supported: value}
  end

  @doc "Sets the Schema.org `countriesSupported` property.\n\nCountries for which the application is supported. You can also provide the two-letter ISO 3166-1 alpha-2 country code."
  def countries_supported(%__MODULE__{} = thing, value) do
    %{thing | countries_supported: value}
  end
  ...
  @doc "Sets the Schema.org `device` property.\n\nDevice required to run the application. Used in cases where a specific make/model is required to run the application."
  def device(%__MODULE__{} = thing, value) do
    %{thing | device: value}
  end
  ...
  @doc "Sets the Schema.org `directors` property.\n\nA director of e.g. TV, radio, movie, video games etc. content. Directors can be associated with individual items or with a series, episode, clip."
  def directors(%__MODULE__{} = thing, value) do
    %{thing | directors: value}
  end
  ...
  @doc "Sets the Schema.org `downloadUrl` property.\n\nIf the file can be downloaded, URL to download the binary."
  def download_url(%__MODULE__{} = thing, value) do
    %{thing | download_url: value}
  end
  ...
  @doc "Sets the Schema.org `featureList` property.\n\nFeatures or modules provided by this application (and possibly required by other applications)."
  def feature_list(%__MODULE__{} = thing, value) do
    %{thing | feature_list: value}
  end
  ...
  @doc "Sets the Schema.org `fileSize` property.\n\nSize of the application / package (e.g. 18MB). In the absence of a unit (MB, KB etc.), KB will be assumed."
  def file_size(%__MODULE__{} = thing, value) do
    %{thing | file_size: value}
  end
  ...
  @doc "Sets the Schema.org `gameEdition` property.\n\nThe edition of a video game."
  def game_edition(%__MODULE__{} = thing, value) do
    %{thing | game_edition: value}
  end

  @doc "Sets the Schema.org `gameItem` property.\n\nAn item is an object within the game world that can be collected by a player or, occasionally, a non-player character."
  def game_item(%__MODULE__{} = thing, value) do
    %{thing | game_item: value}
  end

  @doc "Sets the Schema.org `gameLocation` property.\n\nReal or fictional location of the game (or part of game)."
  def game_location(%__MODULE__{} = thing, value) do
    %{thing | game_location: value}
  end

  @doc "Sets the Schema.org `gamePlatform` property.\n\nThe electronic systems used to play <a href=\"http://en.wikipedia.org/wiki/Category:Video_game_platforms\">video games</a>."
  def game_platform(%__MODULE__{} = thing, value) do
    %{thing | game_platform: value}
  end

  @doc "Sets the Schema.org `gameServer` property.\n\nThe server on which  it is possible to play the game."
  def game_server(%__MODULE__{} = thing, value) do
    %{thing | game_server: value}
  end

  @doc "Sets the Schema.org `gameTip` property.\n\nLinks to tips, tactics, etc."
  def game_tip(%__MODULE__{} = thing, value) do
    %{thing | game_tip: value}
  end
  ...
  @doc "Sets the Schema.org `installUrl` property.\n\nURL at which the app may be installed, if different from the URL of the item."
  def install_url(%__MODULE__{} = thing, value) do
    %{thing | install_url: value}
  end
  ...
  @doc "Sets the Schema.org `memoryRequirements` property.\n\nMinimum memory requirements."
  def memory_requirements(%__MODULE__{} = thing, value) do
    %{thing | memory_requirements: value}
  end
  ...
  @doc "Sets the Schema.org `musicBy` property.\n\nThe composer of the soundtrack."
  def music_by(%__MODULE__{} = thing, value) do
    %{thing | music_by: value}
  end
  ...
  @doc "Sets the Schema.org `numberOfPlayers` property.\n\nIndicate how many people can play this game (minimum, maximum, or range)."
  def number_of_players(%__MODULE__{} = thing, value) do
    %{thing | number_of_players: value}
  end
  ...
  @doc "Sets the Schema.org `operatingSystem` property.\n\nOperating systems supported (Windows 7, OS X 10.6, Android 1.6)."
  def operating_system(%__MODULE__{} = thing, value) do
    %{thing | operating_system: value}
  end
  ...
  @doc "Sets the Schema.org `permissions` property.\n\nPermission(s) required to run the app (for example, a mobile app may require full internet access or may run only on wifi)."
  def permissions(%__MODULE__{} = thing, value) do
    %{thing | permissions: value}
  end

  @doc "Sets the Schema.org `playMode` property.\n\nIndicates whether this game is multi-player, co-op or single-player.  The game can be marked as multi-player, co-op and single-player at the same time."
  def play_mode(%__MODULE__{} = thing, value) do
    %{thing | play_mode: value}
  end
  ...
  @doc "Sets the Schema.org `processorRequirements` property.\n\nProcessor architecture required to run the application (e.g. IA64)."
  def processor_requirements(%__MODULE__{} = thing, value) do
    %{thing | processor_requirements: value}
  end
  ...
  @doc "Sets the Schema.org `quest` property.\n\nThe task that a player-controlled character, or group of characters may complete in order to gain a reward."
  def quest(%__MODULE__{} = thing, value) do
    %{thing | quest: value}
  end
  ...
  @doc "Sets the Schema.org `releaseNotes` property.\n\nDescription of what changed in this version."
  def release_notes(%__MODULE__{} = thing, value) do
    %{thing | release_notes: value}
  end
  ...
  @doc "Sets the Schema.org `requirements` property.\n\nComponent dependency requirements for application. This includes runtime environments and shared libraries that are not included in the application distribution package, but required to run the application (examples: DirectX, Java or .NET runtime)."
  def requirements(%__MODULE__{} = thing, value) do
    %{thing | requirements: value}
  end
  ...
  @doc "Sets the Schema.org `runtimePlatform` property.\n\nRuntime platform or script interpreter dependencies (example: Java v1, Python 2.3, .NET Framework 3.0)."
  def runtime_platform(%__MODULE__{} = thing, value) do
    %{thing | runtime_platform: value}
  end
  ...
  @doc "Sets the Schema.org `screenshot` property.\n\nA link to a screenshot image of the app."
  def screenshot(%__MODULE__{} = thing, value) do
    %{thing | screenshot: value}
  end
  ...
  @doc "Sets the Schema.org `softwareAddOn` property.\n\nAdditional content for a software application."
  def software_add_on(%__MODULE__{} = thing, value) do
    %{thing | software_add_on: value}
  end

  @doc "Sets the Schema.org `softwareHelp` property.\n\nSoftware application help."
  def software_help(%__MODULE__{} = thing, value) do
    %{thing | software_help: value}
  end

  @doc "Sets the Schema.org `softwareRequirements` property.\n\nComponent dependency requirements for application. This includes runtime environments and shared libraries that are not included in the application distribution package, but required to run the application (examples: DirectX, Java or .NET runtime)."
  def software_requirements(%__MODULE__{} = thing, value) do
    %{thing | software_requirements: value}
  end

  @doc "Sets the Schema.org `softwareVersion` property.\n\nVersion of the software instance."
  def software_version(%__MODULE__{} = thing, value) do
    %{thing | software_version: value}
  end
  ...
  @doc "Sets the Schema.org `storageRequirements` property.\n\nStorage requirements (free space required)."
  def storage_requirements(%__MODULE__{} = thing, value) do
    %{thing | storage_requirements: value}
  end
  ...
  @doc "Sets the Schema.org `supportingData` property.\n\nSupporting data for a SoftwareApplication."
  def supporting_data(%__MODULE__{} = thing, value) do
    %{thing | supporting_data: value}
  end
  ...
  @doc "Sets the Schema.org `trailer` property.\n\nThe trailer of a movie or TV/radio series, season, episode, etc."
  def trailer(%__MODULE__{} = thing, value) do
    %{thing | trailer: value}
  end
