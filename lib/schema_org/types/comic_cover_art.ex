defmodule SchemaOrg.ComicCoverArt do
  @moduledoc "The artwork on the cover of a comic."
  ...
  @doc false
  def __schema_org__, do: %{type: "ComicCoverArt", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ComicCoverArt` struct."
