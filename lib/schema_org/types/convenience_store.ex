defmodule SchemaOrg.ConvenienceStore do
  @moduledoc "A convenience store."
  ...
  @doc false
  def __schema_org__, do: %{type: "ConvenienceStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ConvenienceStore` struct."
