defmodule SchemaOrg.ResearchOrganization do
  @moduledoc "A Research Organization (e.g. scientific institute, research company)."
  ...
  @doc false
  def __schema_org__, do: %{type: "ResearchOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ResearchOrganization` struct."
