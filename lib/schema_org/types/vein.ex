defmodule SchemaOrg.Vein do
  ...
  @doc "Sets the Schema.org `drainsTo` property.\n\nThe vasculature that the vein drains into."
  def drains_to(%__MODULE__{} = thing, value) do
    %{thing | drains_to: value}
  end
  ...
  @doc "Sets the Schema.org `tributary` property.\n\nThe anatomical or organ system that the vein flows into; a larger structure that the vein connects to."
  def tributary(%__MODULE__{} = thing, value) do
    %{thing | tributary: value}
  end
