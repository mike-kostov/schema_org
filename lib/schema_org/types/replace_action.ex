defmodule SchemaOrg.ReplaceAction do
  ...
  @doc "Sets the Schema.org `replacee` property.\n\nA sub property of object. The object that is being replaced."
  def replacee(%__MODULE__{} = thing, value) do
    %{thing | replacee: value}
  end

  @doc "Sets the Schema.org `replacer` property.\n\nA sub property of object. The object that replaces."
  def replacer(%__MODULE__{} = thing, value) do
    %{thing | replacer: value}
  end
