defmodule SchemaOrg.ToyStore do
  @moduledoc "A toy store."
  ...
  @doc false
  def __schema_org__, do: %{type: "ToyStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ToyStore` struct."
