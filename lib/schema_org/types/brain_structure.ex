defmodule SchemaOrg.BrainStructure do
  @moduledoc "Any anatomical structure which pertains to the soft nervous tissue functioning as the coordinating center of sensation and intellectual and nervous activity."
  ...
  @doc false
  def __schema_org__, do: %{type: "BrainStructure", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BrainStructure` struct."
