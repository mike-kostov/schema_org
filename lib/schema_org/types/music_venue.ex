defmodule SchemaOrg.MusicVenue do
  @moduledoc "A music venue."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicVenue", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicVenue` struct."
