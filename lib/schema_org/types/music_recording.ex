defmodule SchemaOrg.MusicRecording do
  @moduledoc "A music recording (track), usually a single song."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicRecording", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicRecording` struct."
  ...
  @doc "Sets the Schema.org `inAlbum` property.\n\nThe album to which this recording belongs."
  def in_album(%__MODULE__{} = thing, value) do
    %{thing | in_album: value}
  end
  ...
  @doc "Sets the Schema.org `inPlaylist` property.\n\nThe playlist to which this recording belongs."
  def in_playlist(%__MODULE__{} = thing, value) do
    %{thing | in_playlist: value}
  end
  ...
  @doc "Sets the Schema.org `isrcCode` property.\n\nThe International Standard Recording Code for the recording."
  def isrc_code(%__MODULE__{} = thing, value) do
    %{thing | isrc_code: value}
  end
  ...
  @doc "Sets the Schema.org `recordingOf` property.\n\nThe composition this track is a recording of."
  def recording_of(%__MODULE__{} = thing, value) do
    %{thing | recording_of: value}
  end
