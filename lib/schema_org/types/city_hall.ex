defmodule SchemaOrg.CityHall do
  @moduledoc "A city hall."
  ...
  @doc false
  def __schema_org__, do: %{type: "CityHall", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CityHall` struct."
