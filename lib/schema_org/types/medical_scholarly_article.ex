defmodule SchemaOrg.MedicalScholarlyArticle do
  @moduledoc "A scholarly article in the medical domain."
  ...
  @doc false
  def __schema_org__, do: %{type: "MedicalScholarlyArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MedicalScholarlyArticle` struct."
