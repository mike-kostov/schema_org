defmodule SchemaOrg.LymphaticVessel do
  @moduledoc "A type of blood vessel that specifically carries lymph fluid unidirectionally toward the heart."
  ...
  @doc false
  def __schema_org__, do: %{type: "LymphaticVessel", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.LymphaticVessel` struct."
  ...
  @doc "Sets the Schema.org `originatesFrom` property.\n\nThe vasculature the lymphatic structure originates, or afferents, from."
  def originates_from(%__MODULE__{} = thing, value) do
    %{thing | originates_from: value}
  end
  ...
  @doc "Sets the Schema.org `regionDrained` property.\n\nThe anatomical or organ system drained by this vessel; generally refers to a specific part of an organ."
  def region_drained(%__MODULE__{} = thing, value) do
    %{thing | region_drained: value}
  end
  ...
  @doc "Sets the Schema.org `runsTo` property.\n\nThe vasculature the lymphatic structure runs, or efferents, to."
  def runs_to(%__MODULE__{} = thing, value) do
    %{thing | runs_to: value}
  end
