defmodule SchemaOrg.SocialMediaPosting do
  @moduledoc "A post to a social media platform, including blog posts, tweets, Facebook posts, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "SocialMediaPosting", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SocialMediaPosting` struct."
