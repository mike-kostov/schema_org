defmodule SchemaOrg.HardwareStore do
  @moduledoc "A hardware store."
  ...
  @doc false
  def __schema_org__, do: %{type: "HardwareStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HardwareStore` struct."
