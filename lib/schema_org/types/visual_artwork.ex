defmodule SchemaOrg.VisualArtwork do
  @moduledoc "A work of art that is primarily visual in character."
  ...
  @doc false
  def __schema_org__, do: %{type: "VisualArtwork", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VisualArtwork` struct."
