defmodule SchemaOrg.EatAction do
  @moduledoc "The act of swallowing solid objects."
  ...
  @doc false
  def __schema_org__, do: %{type: "EatAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EatAction` struct."
