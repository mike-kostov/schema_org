defmodule SchemaOrg.DrugCost do
  ...
  @doc "Sets the Schema.org `applicableLocation` property.\n\nThe location in which the status applies."
  def applicable_location(%__MODULE__{} = thing, value) do
    %{thing | applicable_location: value}
  end
  ...
  @doc "Sets the Schema.org `costCategory` property.\n\nThe category of cost, such as wholesale, retail, reimbursement cap, etc."
  def cost_category(%__MODULE__{} = thing, value) do
    %{thing | cost_category: value}
  end

  @doc "Sets the Schema.org `costCurrency` property.\n\nThe currency (in 3-letter) of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217. "
  def cost_currency(%__MODULE__{} = thing, value) do
    %{thing | cost_currency: value}
  end

  @doc "Sets the Schema.org `costOrigin` property.\n\nAdditional details to capture the origin of the cost data. For example, 'Medicare Part B'."
  def cost_origin(%__MODULE__{} = thing, value) do
    %{thing | cost_origin: value}
  end

  @doc "Sets the Schema.org `costPerUnit` property.\n\nThe cost per unit of the drug."
  def cost_per_unit(%__MODULE__{} = thing, value) do
    %{thing | cost_per_unit: value}
  end
