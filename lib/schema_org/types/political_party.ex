defmodule SchemaOrg.PoliticalParty do
  @moduledoc "Organization: Political Party."
  ...
  @doc false
  def __schema_org__, do: %{type: "PoliticalParty", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PoliticalParty` struct."
