defmodule SchemaOrg.ImageObject do
  @moduledoc "An image file."
  ...
  @doc false
  def __schema_org__, do: %{type: "ImageObject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ImageObject` struct."
