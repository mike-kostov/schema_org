defmodule SchemaOrg.BankAccount do
  ...
  @doc "Sets the Schema.org `accountMinimumInflow` property.\n\nA minimum amount that has to be paid in every month."
  def account_minimum_inflow(%__MODULE__{} = thing, value) do
    %{thing | account_minimum_inflow: value}
  end

  @doc "Sets the Schema.org `accountOverdraftLimit` property.\n\nAn overdraft is an extension of credit from a lending institution when an account reaches zero. An overdraft allows the individual to continue withdrawing money even if the account has no funds in it. Basically the bank allows people to borrow a set amount of money."
  def account_overdraft_limit(%__MODULE__{} = thing, value) do
    %{thing | account_overdraft_limit: value}
  end
  ...
  @doc "Sets the Schema.org `bankAccountType` property.\n\nThe type of a bank account."
  def bank_account_type(%__MODULE__{} = thing, value) do
    %{thing | bank_account_type: value}
  end
