defmodule SchemaOrg.PlaceOfWorship do
  @moduledoc "Place of worship, such as a church, synagogue, or mosque."
  ...
  @doc false
  def __schema_org__, do: %{type: "PlaceOfWorship", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PlaceOfWorship` struct."
