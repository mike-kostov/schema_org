defmodule SchemaOrg.VisualArtsEvent do
  @moduledoc "Event type: Visual arts event."
  ...
  @doc false
  def __schema_org__, do: %{type: "VisualArtsEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.VisualArtsEvent` struct."
