defmodule SchemaOrg.ComicStory do
  @moduledoc "The term \"story\" is any indivisible, re-printable\n    \tunit of a comic, including the interior stories, covers, and backmatter. Most\n    \tcomics have at least two stories: a cover (ComicCoverArt) and an interior story."
  ...
  @doc false
  def __schema_org__, do: %{type: "ComicStory", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ComicStory` struct."
