defmodule SchemaOrg.WPAdBlock do
  @moduledoc "An advertising section of the page."
  ...
  @doc false
  def __schema_org__, do: %{type: "WPAdBlock", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WPAdBlock` struct."
