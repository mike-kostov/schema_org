defmodule SchemaOrg.SheetMusic do
  @moduledoc "Printed music, as opposed to performed or recorded music."
  ...
  @doc false
  def __schema_org__, do: %{type: "SheetMusic", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SheetMusic` struct."
