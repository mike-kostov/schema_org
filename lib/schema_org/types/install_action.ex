defmodule SchemaOrg.InstallAction do
  @moduledoc "The act of installing an application."
  ...
  @doc false
  def __schema_org__, do: %{type: "InstallAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InstallAction` struct."
