defmodule SchemaOrg.FoodService do
  @moduledoc "A food service, like breakfast, lunch, or dinner."
  ...
  @doc false
  def __schema_org__, do: %{type: "FoodService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FoodService` struct."
