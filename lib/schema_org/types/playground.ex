defmodule SchemaOrg.Playground do
  @moduledoc "A playground."
  ...
  @doc false
  def __schema_org__, do: %{type: "Playground", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Playground` struct."
