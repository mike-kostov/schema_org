defmodule SchemaOrg.Course do
  ...
  @doc "Sets the Schema.org `competencyRequired` property.\n\nKnowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource."
  def competency_required(%__MODULE__{} = thing, value) do
    %{thing | competency_required: value}
  end
  ...
  @doc "Sets the Schema.org `courseCode` property.\n\nThe identifier for the [[Course]] used by the course [[provider]] (e.g. CS101 or 6.001)."
  def course_code(%__MODULE__{} = thing, value) do
    %{thing | course_code: value}
  end

  @doc "Sets the Schema.org `coursePrerequisites` property.\n\nRequirements for taking the Course. May be completion of another [[Course]] or a textual description like \"permission of instructor\". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]]."
  def course_prerequisites(%__MODULE__{} = thing, value) do
    %{thing | course_prerequisites: value}
  end
  ...
  @doc "Sets the Schema.org `hasCourseInstance` property.\n\nAn offering of the course at a specific time and place or through specific media or mode of study or to a specific section of students."
  def has_course_instance(%__MODULE__{} = thing, value) do
    %{thing | has_course_instance: value}
  end
  ...
  @doc "Sets the Schema.org `syllabusSections` property.\n\nIndicates (typically several) Syllabus entities that lay out what each section of the overall course will cover."
  def syllabus_sections(%__MODULE__{} = thing, value) do
    %{thing | syllabus_sections: value}
  end
  ...
  @doc "Sets the Schema.org `totalHistoricalEnrollment` property.\n\nThe total number of students that have enrolled in the history of the course."
  def total_historical_enrollment(%__MODULE__{} = thing, value) do
    %{thing | total_historical_enrollment: value}
  end
