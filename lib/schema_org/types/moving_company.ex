defmodule SchemaOrg.MovingCompany do
  @moduledoc "A moving company."
  ...
  @doc false
  def __schema_org__, do: %{type: "MovingCompany", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MovingCompany` struct."
