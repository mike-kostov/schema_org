defmodule SchemaOrg.MedicalRiskScore do
  ...
  @doc "Sets the Schema.org `algorithm` property.\n\nThe algorithm or rules to follow to compute the score."
  def algorithm(%__MODULE__{} = thing, value) do
    %{thing | algorithm: value}
  end
  ...
  @doc "Sets the Schema.org `estimatesRiskOf` property.\n\nThe condition, complication, or symptom whose risk is being estimated."
  def estimates_risk_of(%__MODULE__{} = thing, value) do
    %{thing | estimates_risk_of: value}
  end
  ...
  @doc "Sets the Schema.org `includedRiskFactor` property.\n\nA modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition."
  def included_risk_factor(%__MODULE__{} = thing, value) do
    %{thing | included_risk_factor: value}
  end
