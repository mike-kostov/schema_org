defmodule SchemaOrg.Motorcycle do
  @moduledoc "A motorcycle or motorbike is a single-track, two-wheeled motor vehicle."
  ...
  @doc false
  def __schema_org__, do: %{type: "Motorcycle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Motorcycle` struct."
