defmodule SchemaOrg.AggregateRating do
  ...
  @doc "Sets the Schema.org `ratingCount` property.\n\nThe count of total number of ratings."
  def rating_count(%__MODULE__{} = thing, value) do
    %{thing | rating_count: value}
  end
  ...
  @doc "Sets the Schema.org `reviewCount` property.\n\nThe count of total number of reviews."
  def review_count(%__MODULE__{} = thing, value) do
    %{thing | review_count: value}
  end
