defmodule SchemaOrg.Nerve do
  ...
  @doc "Sets the Schema.org `nerveMotor` property.\n\nThe neurological pathway extension that involves muscle control."
  def nerve_motor(%__MODULE__{} = thing, value) do
    %{thing | nerve_motor: value}
  end
  ...
  @doc "Sets the Schema.org `sensoryUnit` property.\n\nThe neurological pathway extension that inputs and sends information to the brain or spinal cord."
  def sensory_unit(%__MODULE__{} = thing, value) do
    %{thing | sensory_unit: value}
  end

  @doc "Sets the Schema.org `sourcedFrom` property.\n\nThe neurological pathway that originates the neurons."
  def sourced_from(%__MODULE__{} = thing, value) do
    %{thing | sourced_from: value}
  end
