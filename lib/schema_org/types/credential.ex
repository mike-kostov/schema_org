defmodule SchemaOrg.Credential do
  @moduledoc "A credential is a certificate that is used to verify the identity of a person or entity."
  ...
  @doc false
  def __schema_org__, do: %{type: "Credential", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Credential` struct."
