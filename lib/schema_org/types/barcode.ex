defmodule SchemaOrg.Barcode do
  @moduledoc "An image of a visual machine-readable code such as a barcode or QR code."
  ...
  @doc false
  def __schema_org__, do: %{type: "Barcode", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Barcode` struct."
  ...
  @doc "Sets the Schema.org `exifData` property.\n\nexif data for this object."
  def exif_data(%__MODULE__{} = thing, value) do
    %{thing | exif_data: value}
  end
  ...
  @doc "Sets the Schema.org `representativeOfPage` property.\n\nIndicates whether this image is representative of the content of the page."
  def representative_of_page(%__MODULE__{} = thing, value) do
    %{thing | representative_of_page: value}
  end
