defmodule SchemaOrg.PerformingArtsEvent do
  ...
  @doc false
  def __schema_org__, do: %{type: "PerformingArtsEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PerformingArtsEvent` struct."
