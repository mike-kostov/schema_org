defmodule SchemaOrg.MotorcycleRepair do
  @moduledoc "A motorcycle repair shop."
  ...
  @doc false
  def __schema_org__, do: %{type: "MotorcycleRepair", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MotorcycleRepair` struct."
