defmodule SchemaOrg.OnlineStore do
  @moduledoc "An eCommerce site."
  ...
  @doc false
  def __schema_org__, do: %{type: "OnlineStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OnlineStore` struct."
