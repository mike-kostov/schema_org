defmodule SchemaOrg.EntertainmentBusiness do
  @moduledoc "A business providing entertainment."
  ...
  @doc false
  def __schema_org__, do: %{type: "EntertainmentBusiness", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EntertainmentBusiness` struct."
