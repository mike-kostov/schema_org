defmodule SchemaOrg.BusinessAudience do
  ...
  @doc "Sets the Schema.org `yearlyRevenue` property.\n\nThe size of the business in annual revenue."
  def yearly_revenue(%__MODULE__{} = thing, value) do
    %{thing | yearly_revenue: value}
  end

  @doc "Sets the Schema.org `yearsInOperation` property.\n\nThe age of the business."
  def years_in_operation(%__MODULE__{} = thing, value) do
    %{thing | years_in_operation: value}
  end
end
