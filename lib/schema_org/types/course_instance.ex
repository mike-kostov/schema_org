defmodule SchemaOrg.CourseInstance do
  ...
  @doc "Sets the Schema.org `courseMode` property.\n\nThe medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. \"online\", \"onsite\" or \"blended\"; \"synchronous\" or \"asynchronous\"; \"full-time\" or \"part-time\") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous)."
  def course_mode(%__MODULE__{} = thing, value) do
    %{thing | course_mode: value}
  end

  @doc "Sets the Schema.org `courseSchedule` property.\n\nRepresents the length and pace of a course, expressed as a [[Schedule]]."
  def course_schedule(%__MODULE__{} = thing, value) do
    %{thing | course_schedule: value}
  end

  @doc "Sets the Schema.org `courseWorkload` property.\n\nThe amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, \"2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week\"."
  def course_workload(%__MODULE__{} = thing, value) do
    %{thing | course_workload: value}
  end
  ...
  @doc "Sets the Schema.org `instructor` property.\n\nA person assigned to instruct or provide instructional assistance for the [[CourseInstance]]."
  def instructor(%__MODULE__{} = thing, value) do
    %{thing | instructor: value}
  end
