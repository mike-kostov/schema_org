defmodule SchemaOrg.EducationalOrganization do
  @moduledoc "An educational organization."
  ...
  @doc false
  def __schema_org__, do: %{type: "EducationalOrganization", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EducationalOrganization` struct."
