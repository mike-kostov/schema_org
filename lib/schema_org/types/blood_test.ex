defmodule SchemaOrg.BloodTest do
  @moduledoc "A medical test performed on a sample of a patient's blood."
  ...
  @doc false
  def __schema_org__, do: %{type: "BloodTest", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BloodTest` struct."
