defmodule SchemaOrg.Electrician do
  @moduledoc "An electrician."
  ...
  @doc false
  def __schema_org__, do: %{type: "Electrician", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Electrician` struct."
