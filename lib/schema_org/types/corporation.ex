defmodule SchemaOrg.Corporation do
  @moduledoc "Organization: A business corporation."
  ...
  @doc false
  def __schema_org__, do: %{type: "Corporation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Corporation` struct."
  ...
  @doc "Sets the Schema.org `tickerSymbol` property.\n\nThe exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO 15022."
  def ticker_symbol(%__MODULE__{} = thing, value) do
    %{thing | ticker_symbol: value}
  end
