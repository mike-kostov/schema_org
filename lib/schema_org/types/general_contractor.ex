defmodule SchemaOrg.GeneralContractor do
  @moduledoc "A general contractor."
  ...
  @doc false
  def __schema_org__, do: %{type: "GeneralContractor", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.GeneralContractor` struct."
