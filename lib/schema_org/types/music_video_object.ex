defmodule SchemaOrg.MusicVideoObject do
  @moduledoc "A music video file."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicVideoObject", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicVideoObject` struct."
