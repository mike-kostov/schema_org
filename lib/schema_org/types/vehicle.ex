defmodule SchemaOrg.Vehicle do
  @moduledoc "A vehicle is a device that is designed or used to transport people or cargo over land, water, air, or through space."
  ...
  @doc false
  def __schema_org__, do: %{type: "Vehicle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Vehicle` struct."
