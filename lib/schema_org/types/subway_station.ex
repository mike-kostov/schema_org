defmodule SchemaOrg.SubwayStation do
  @moduledoc "A subway station."
  ...
  @doc false
  def __schema_org__, do: %{type: "SubwayStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SubwayStation` struct."
