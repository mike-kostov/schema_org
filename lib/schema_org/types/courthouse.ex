defmodule SchemaOrg.Courthouse do
  @moduledoc "A courthouse."
  ...
  @doc false
  def __schema_org__, do: %{type: "Courthouse", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Courthouse` struct."
