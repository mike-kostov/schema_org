defmodule SchemaOrg.WebApplication do
  @moduledoc "Web applications."
  ...
  @doc false
  def __schema_org__, do: %{type: "WebApplication", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.WebApplication` struct."
  ...
  @doc "Sets the Schema.org `browserRequirements` property.\n\nSpecifies browser requirements in human-readable text. For example, 'requires HTML5 support'."
  def browser_requirements(%__MODULE__{} = thing, value) do
    %{thing | browser_requirements: value}
  end
