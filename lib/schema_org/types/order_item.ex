defmodule SchemaOrg.OrderItem do
  ...
  @doc "Sets the Schema.org `orderItemNumber` property.\n\nThe identifier of the order item."
  def order_item_number(%__MODULE__{} = thing, value) do
    %{thing | order_item_number: value}
  end

  @doc "Sets the Schema.org `orderItemStatus` property.\n\nThe current status of the order item."
  def order_item_status(%__MODULE__{} = thing, value) do
    %{thing | order_item_status: value}
  end

  @doc "Sets the Schema.org `orderQuantity` property.\n\nThe number of the item ordered. If the property is not set, assume the quantity is one."
  def order_quantity(%__MODULE__{} = thing, value) do
    %{thing | order_quantity: value}
  end
