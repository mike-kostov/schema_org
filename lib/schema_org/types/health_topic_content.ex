defmodule SchemaOrg.HealthTopicContent do
  ...
  @doc false
  def __schema_org__, do: %{type: "HealthTopicContent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HealthTopicContent` struct."
