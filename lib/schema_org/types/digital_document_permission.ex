defmodule SchemaOrg.DigitalDocumentPermission do
  ...
  @doc "Sets the Schema.org `grantee` property.\n\nThe person, organization, contact point, or audience that has been granted this permission."
  def grantee(%__MODULE__{} = thing, value) do
    %{thing | grantee: value}
  end
  ...
  @doc "Sets the Schema.org `permissionType` property.\n\nThe type of permission granted the person, organization, or audience."
  def permission_type(%__MODULE__{} = thing, value) do
    %{thing | permission_type: value}
  end
