defmodule SchemaOrg.ReadAction do
  @moduledoc "The act of consuming written content."
  ...
  @doc false
  def __schema_org__, do: %{type: "ReadAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ReadAction` struct."
