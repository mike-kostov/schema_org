defmodule SchemaOrg.AutomatedTeller do
  @moduledoc "ATM/cash machine."
  ...
  @doc false
  def __schema_org__, do: %{type: "AutomatedTeller", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AutomatedTeller` struct."
