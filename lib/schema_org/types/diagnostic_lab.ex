defmodule SchemaOrg.DiagnosticLab do
  @moduledoc "A medical laboratory that offers on-site or off-site diagnostic services."
  ...
  @doc false
  def __schema_org__, do: %{type: "DiagnosticLab", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DiagnosticLab` struct."
  ...
  @doc "Sets the Schema.org `availableTest` property.\n\nA diagnostic test or procedure offered by this lab."
  def available_test(%__MODULE__{} = thing, value) do
    %{thing | available_test: value}
  end
