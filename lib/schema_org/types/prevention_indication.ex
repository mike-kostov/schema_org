defmodule SchemaOrg.PreventionIndication do
  @moduledoc "An indication for preventing an underlying condition, symptom, etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "PreventionIndication", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PreventionIndication` struct."
