defmodule SchemaOrg.HairSalon do
  @moduledoc "A hair salon."
  ...
  @doc false
  def __schema_org__, do: %{type: "HairSalon", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HairSalon` struct."
