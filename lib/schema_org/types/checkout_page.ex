defmodule SchemaOrg.CheckoutPage do
  @moduledoc "Web page type: Checkout page."
  ...
  @doc false
  def __schema_org__, do: %{type: "CheckoutPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CheckoutPage` struct."
