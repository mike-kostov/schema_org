defmodule SchemaOrg.AboutPage do
  @moduledoc "Web page type: About page."
  ...
  @doc false
  def __schema_org__, do: %{type: "AboutPage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AboutPage` struct."
