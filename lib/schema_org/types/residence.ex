defmodule SchemaOrg.Residence do
  @moduledoc "The place where a person lives."
  ...
  @doc false
  def __schema_org__, do: %{type: "Residence", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Residence` struct."
