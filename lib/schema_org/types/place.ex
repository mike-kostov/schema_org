defmodule SchemaOrg.Place do
  @moduledoc "Entities that have a somewhat fixed, physical extension."
  ...
  @doc false
  def __schema_org__, do: %{type: "Place", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Place` struct."
