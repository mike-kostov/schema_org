defmodule SchemaOrg.ReviewAction do
  @moduledoc "The act of producing a balanced opinion about the object for an audience. An agent reviews an object with participants resulting in a review."
  ...
  @doc false
  def __schema_org__, do: %{type: "ReviewAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ReviewAction` struct."
  ...
  @doc "Sets the Schema.org `resultReview` property.\n\nA sub property of result. The review that resulted in the performing of the action."
  def result_review(%__MODULE__{} = thing, value) do
    %{thing | result_review: value}
  end
