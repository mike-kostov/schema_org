defmodule SchemaOrg.RentalCarReservation do
  ...
  @doc "Sets the Schema.org `dropoffLocation` property.\n\nWhere a rental car can be dropped off."
  def dropoff_location(%__MODULE__{} = thing, value) do
    %{thing | dropoff_location: value}
  end

  @doc "Sets the Schema.org `dropoffTime` property.\n\nWhen a rental car can be dropped off."
  def dropoff_time(%__MODULE__{} = thing, value) do
    %{thing | dropoff_time: value}
  end
