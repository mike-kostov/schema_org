defmodule SchemaOrg.SoftwareSourceCode do
  @moduledoc "Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates."
  ...
  @doc false
  def __schema_org__, do: %{type: "SoftwareSourceCode", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.SoftwareSourceCode` struct."
  ...
  @doc "Sets the Schema.org `codeRepository` property.\n\nLink to the repository where the un-compiled, human readable code and related code is located (SVN, GitHub, CodePlex)."
  def code_repository(%__MODULE__{} = thing, value) do
    %{thing | code_repository: value}
  end

  @doc "Sets the Schema.org `codeSampleType` property.\n\nWhat type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template."
  def code_sample_type(%__MODULE__{} = thing, value) do
    %{thing | code_sample_type: value}
  end
  ...
  @doc "Sets the Schema.org `programmingLanguage` property.\n\nThe computer programming language."
  def programming_language(%__MODULE__{} = thing, value) do
    %{thing | programming_language: value}
  end
  ...
  @doc "Sets the Schema.org `runtime` property.\n\nRuntime platform or script interpreter dependencies (example: Java v1, Python 2.3, .NET Framework 3.0)."
  def runtime(%__MODULE__{} = thing, value) do
    %{thing | runtime: value}
  end
  ...
  @doc "Sets the Schema.org `sampleType` property.\n\nWhat type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template."
  def sample_type(%__MODULE__{} = thing, value) do
    %{thing | sample_type: value}
  end
  ...
  @doc "Sets the Schema.org `targetProduct` property.\n\nTarget Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used."
  def target_product(%__MODULE__{} = thing, value) do
    %{thing | target_product: value}
  end
