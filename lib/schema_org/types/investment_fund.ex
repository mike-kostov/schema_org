defmodule SchemaOrg.InvestmentFund do
  @moduledoc "A company or fund that gathers capital from a number of investors to create a pool of money that is then re-invested into stocks, bonds and other assets."
  ...
  @doc false
  def __schema_org__, do: %{type: "InvestmentFund", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InvestmentFund` struct."
