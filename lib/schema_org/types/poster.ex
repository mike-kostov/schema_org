defmodule SchemaOrg.Poster do
  @moduledoc "A large, usually printed placard, bill, or announcement, often illustrated, that is posted to advertise or publicize something."
  ...
  @doc false
  def __schema_org__, do: %{type: "Poster", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Poster` struct."
