defmodule SchemaOrg.ElectronicsStore do
  @moduledoc "An electronics store."
  ...
  @doc false
  def __schema_org__, do: %{type: "ElectronicsStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ElectronicsStore` struct."
