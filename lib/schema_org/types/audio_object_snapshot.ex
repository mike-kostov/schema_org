defmodule SchemaOrg.AudioObjectSnapshot do
  ...
  @doc false
  def __schema_org__, do: %{type: "AudioObjectSnapshot", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AudioObjectSnapshot` struct."
