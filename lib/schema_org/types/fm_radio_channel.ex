defmodule SchemaOrg.FMRadioChannel do
  @moduledoc "A radio channel that uses FM."
  ...
  @doc false
  def __schema_org__, do: %{type: "FMRadioChannel", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FMRadioChannel` struct."
