defmodule SchemaOrg.Chapter do
  @moduledoc "One of the sections into which a book is divided. A chapter usually has a section number or a name."
  ...
  @doc false
  def __schema_org__, do: %{type: "Chapter", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Chapter` struct."
