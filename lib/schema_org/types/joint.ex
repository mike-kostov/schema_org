defmodule SchemaOrg.Joint do
  @moduledoc "The anatomical location at which two or more bones make contact."
  ...
  @json_keys %{
    ...
    biomechnical_class: "biomechnicalClass",
  ...
  @doc false
  def __schema_org__, do: %{type: "Joint", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Joint` struct."
  ...
  @doc "Sets the Schema.org `biomechnicalClass` property.\n\nThe biomechanical properties of the bone."
  def biomechnical_class(%__MODULE__{} = thing, value) do
    %{thing | biomechnical_class: value}
  end
  ...
  @doc "Sets the Schema.org `functionalClass` property.\n\nThe degree of mobility the joint allows."
  def functional_class(%__MODULE__{} = thing, value) do
    %{thing | functional_class: value}
  end
  ...
  @doc "Sets the Schema.org `structuralClass` property.\n\nThe name given to how bone physically connects to each other."
  def structural_class(%__MODULE__{} = thing, value) do
    %{thing | structural_class: value}
  end
