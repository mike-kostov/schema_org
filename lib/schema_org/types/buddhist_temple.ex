defmodule SchemaOrg.BuddhistTemple do
  @moduledoc "A Buddhist temple."
  ...
  @doc false
  def __schema_org__, do: %{type: "BuddhistTemple", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.BuddhistTemple` struct."
