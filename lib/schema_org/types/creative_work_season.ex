defmodule SchemaOrg.CreativeWorkSeason do
  @moduledoc "A media season, e.g. TV, radio, video game etc."
  ...
  @doc false
  def __schema_org__, do: %{type: "CreativeWorkSeason", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CreativeWorkSeason` struct."
