defmodule SchemaOrg.HighSchool do
  @moduledoc "A high school."
  ...
  @doc false
  def __schema_org__, do: %{type: "HighSchool", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.HighSchool` struct."
