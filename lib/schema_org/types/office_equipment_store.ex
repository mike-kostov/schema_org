defmodule SchemaOrg.OfficeEquipmentStore do
  @moduledoc "An office equipment store."
  ...
  @doc false
  def __schema_org__, do: %{type: "OfficeEquipmentStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OfficeEquipmentStore` struct."
