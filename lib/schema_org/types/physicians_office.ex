defmodule SchemaOrg.PhysiciansOffice do
  @moduledoc "A doctor's office or clinic."
  ...
  @doc false
  def __schema_org__, do: %{type: "PhysiciansOffice", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PhysiciansOffice` struct."
