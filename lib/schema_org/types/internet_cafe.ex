defmodule SchemaOrg.InternetCafe do
  @moduledoc "An internet cafe."
  ...
  @doc false
  def __schema_org__, do: %{type: "InternetCafe", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.InternetCafe` struct."
