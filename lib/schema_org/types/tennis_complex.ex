defmodule SchemaOrg.TennisComplex do
  @moduledoc "A tennis complex."
  ...
  @doc false
  def __schema_org__, do: %{type: "TennisComplex", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TennisComplex` struct."
