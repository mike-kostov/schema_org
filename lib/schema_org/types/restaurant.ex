defmodule SchemaOrg.Restaurant do
  @moduledoc "A restaurant."
  ...
  @doc false
  def __schema_org__, do: %{type: "Restaurant", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Restaurant` struct."
