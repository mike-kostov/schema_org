defmodule SchemaOrg.CommunicateAction do
  @moduledoc "The act of conveying information to another person via a communication medium (instrument) such as speech, email, or telephone conversation."
  ...
  @doc false
  def __schema_org__, do: %{type: "CommunicateAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CommunicateAction` struct."
