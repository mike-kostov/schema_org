defmodule SchemaOrg.Canal do
  @moduledoc "A canal, like the Panama Canal."
  ...
  @doc false
  def __schema_org__, do: %{type: "Canal", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Canal` struct."
