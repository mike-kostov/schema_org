defmodule SchemaOrg.CollegeOrUniversity do
  @moduledoc "A college, university, or other third-level educational institution."
  ...
  @doc false
  def __schema_org__, do: %{type: "CollegeOrUniversity", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CollegeOrUniversity` struct."
