defmodule SchemaOrg.NailSalon do
  @moduledoc "A nail salon."
  ...
  @doc false
  def __schema_org__, do: %{type: "NailSalon", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.NailSalon` struct."
