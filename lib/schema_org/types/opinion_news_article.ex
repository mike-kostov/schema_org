defmodule SchemaOrg.OpinionNewsArticle do
  @moduledoc "An [[OpinionNewsArticle]] is a [[NewsArticle]] that primarily expresses opinions rather than journalistic reporting of news and events. For example, a [[NewsArticle]] consisting of a column or [[Blog]]/[[BlogPosting]] entry in the Opinions section of a news publication. "
  ...
  @doc false
  def __schema_org__, do: %{type: "OpinionNewsArticle", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.OpinionNewsArticle` struct."
