defmodule SchemaOrg.DeliveryEvent do
  @moduledoc "An event involving the delivery of an item."
  ...
  @doc false
  def __schema_org__, do: %{type: "DeliveryEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.DeliveryEvent` struct."
  ...
  @doc "Sets the Schema.org `accessCode` property.\n\nPassword, PIN, or access code needed for delivery (e.g. from a locker)."
  def access_code(%__MODULE__{} = thing, value) do
    %{thing | access_code: value}
  end
  ...
  @doc "Sets the Schema.org `availableFrom` property.\n\nWhen the item is available for pickup from the store, locker, etc."
  def available_from(%__MODULE__{} = thing, value) do
    %{thing | available_from: value}
  end

  @doc "Sets the Schema.org `availableThrough` property.\n\nAfter this date, the item will no longer be available for pickup."
  def available_through(%__MODULE__{} = thing, value) do
    %{thing | available_through: value}
  end
