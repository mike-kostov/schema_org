defmodule SchemaOrg.AmpStory do
  @moduledoc "A creative work with a visual storytelling format intended to be viewed online, particularly on mobile devices."
  ...
  @doc false
  def __schema_org__, do: %{type: "AmpStory", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.AmpStory` struct."
