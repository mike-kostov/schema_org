defmodule SchemaOrg.Muscle do
  ...
  @doc "Sets the Schema.org `antagonist` property.\n\nThe muscle whose action counteracts the specified muscle."
  def antagonist(%__MODULE__{} = thing, value) do
    %{thing | antagonist: value}
  end
  ...
  @doc "Sets the Schema.org `bloodSupply` property.\n\nThe blood vessel that carries blood from the heart to the muscle."
  def blood_supply(%__MODULE__{} = thing, value) do
    %{thing | blood_supply: value}
  end
  ...
  @doc "Sets the Schema.org `insertion` property.\n\nThe place of attachment of a muscle, or what the muscle moves."
  def insertion(%__MODULE__{} = thing, value) do
    %{thing | insertion: value}
  end
  ...
  @doc "Sets the Schema.org `muscleAction` property.\n\nThe movement the muscle generates."
  def muscle_action(%__MODULE__{} = thing, value) do
    %{thing | muscle_action: value}
  end
  ...
  @doc "Sets the Schema.org `nerve` property.\n\nThe underlying innervation associated with the muscle."
  def nerve(%__MODULE__{} = thing, value) do
    %{thing | nerve: value}
  end
