defmodule SchemaOrg.TelevisionStation do
  @moduledoc "A television station."
  ...
  @doc false
  def __schema_org__, do: %{type: "TelevisionStation", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TelevisionStation` struct."
