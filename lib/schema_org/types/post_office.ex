defmodule SchemaOrg.PostOffice do
  @moduledoc "A post office."
  ...
  @doc false
  def __schema_org__, do: %{type: "PostOffice", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.PostOffice` struct."
