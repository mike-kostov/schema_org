defmodule SchemaOrg.TheaterEvent do
  @moduledoc "Event type: Theater performance."
  ...
  @doc false
  def __schema_org__, do: %{type: "TheaterEvent", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.TheaterEvent` struct."
