defmodule SchemaOrg.Menu do
  @moduledoc "A structured representation of food or drink items available from a FoodEstablishment."
  ...
  @doc false
  def __schema_org__, do: %{type: "Menu", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.Menu` struct."
