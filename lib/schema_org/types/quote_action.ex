defmodule SchemaOrg.QuoteAction do
  @moduledoc "An agent quotes/estimates/appraises an object/product/service with a price at a location/store."
  ...
  @doc false
  def __schema_org__, do: %{type: "QuoteAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.QuoteAction` struct."
