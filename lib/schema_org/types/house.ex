defmodule SchemaOrg.House do
  @moduledoc "A house is a building or structure that has the ability to be occupied for habitation by humans or other creatures (source: Wikipedia, the free encyclopedia, see <a href=\"http://en.wikipedia.org/wiki/House\">http://en.wikipedia.org/wiki/House</a>)."
  ...
  @doc false
  def __schema_org__, do: %{type: "House", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.House` struct."
