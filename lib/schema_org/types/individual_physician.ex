defmodule SchemaOrg.IndividualPhysician do
  ...
  @json_keys %{
    ...
    is_accepting_new_patients: "isAcceptingNewPatients",
  ...
  @doc false
  def __schema_org__, do: %{type: "IndividualPhysician", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.IndividualPhysician` struct."
  ...
  @doc "Sets the Schema.org `availableService` property.\n\nA medical service available from this provider."
  def available_service(%__MODULE__{} = thing, value) do
    %{thing | available_service: value}
  end
  ...
  @doc "Sets the Schema.org `healthPlanNetworkId` property.\n\nName or unique ID of network. (Networks are often reused across different insurance plans.)"
  def health_plan_network_id(%__MODULE__{} = thing, value) do
    %{thing | health_plan_network_id: value}
  end

  @doc "Sets the Schema.org `hospitalAffiliation` property.\n\nA hospital with which the physician or office is affiliated."
  def hospital_affiliation(%__MODULE__{} = thing, value) do
    %{thing | hospital_affiliation: value}
  end
  ...
  @doc "Sets the Schema.org `isAcceptingNewPatients` property.\n\nWhether the provider is accepting new patients."
  def is_accepting_new_patients(%__MODULE__{} = thing, value) do
    %{thing | is_accepting_new_patients: value}
  end
  ...
  @doc "Sets the Schema.org `medicalSpecialty` property.\n\nA medical specialty of the provider."
  def medical_specialty(%__MODULE__{} = thing, value) do
    %{thing | medical_specialty: value}
  end
  ...
  @doc "Sets the Schema.org `practicesAt` property.\n\nA [[MedicalOrganization]] where the [[IndividualPhysician]] practices."
  def practices_at(%__MODULE__{} = thing, value) do
    %{thing | practices_at: value}
  end
