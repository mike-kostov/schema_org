defmodule SchemaOrg.FastFoodRestaurant do
  @moduledoc "A fast-food restaurant."
  ...
  @doc false
  def __schema_org__, do: %{type: "FastFoodRestaurant", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.FastFoodRestaurant` struct."
  ...
  @doc "Sets the Schema.org `acceptsReservations` property.\n\nIndicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```."
  def accepts_reservations(%__MODULE__{} = thing, value) do
    %{thing | accepts_reservations: value}
  end
  ...
  @doc "Sets the Schema.org `hasMenu` property.\n\nEither the actual menu as a structured representation, as text, or a URL of the menu."
  def has_menu(%__MODULE__{} = thing, value) do
    %{thing | has_menu: value}
  end
  ...
  @doc "Sets the Schema.org `menu` property.\n\nEither the actual menu as a structured representation, as text, or a URL of the menu."
  def menu(%__MODULE__{} = thing, value) do
    %{thing | menu: value}
  end
  ...
  @doc "Sets the Schema.org `servesCuisine` property.\n\nThe cuisine of the restaurant."
  def serves_cuisine(%__MODULE__{} = thing, value) do
    %{thing | serves_cuisine: value}
  end
  ...
  @doc "Sets the Schema.org `starRating` property.\n\nAn official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars)."
  def star_rating(%__MODULE__{} = thing, value) do
    %{thing | star_rating: value}
  end
