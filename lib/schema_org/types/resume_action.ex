defmodule SchemaOrg.ResumeAction do
  @moduledoc "The act of resuming a device or application which was formerly paused (e.g. resume music playback or resume a timer)."
  ...
  @doc false
  def __schema_org__, do: %{type: "ResumeAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ResumeAction` struct."
