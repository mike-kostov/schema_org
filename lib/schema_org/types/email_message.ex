defmodule SchemaOrg.EmailMessage do
  @moduledoc "An email message."
  ...
  @doc false
  def __schema_org__, do: %{type: "EmailMessage", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.EmailMessage` struct."
