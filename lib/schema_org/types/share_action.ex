defmodule SchemaOrg.ShareAction do
  @moduledoc "The act of distributing content to people for their amusement or edification."
  ...
  @doc false
  def __schema_org__, do: %{type: "ShareAction", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.ShareAction` struct."
