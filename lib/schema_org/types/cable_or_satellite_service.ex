defmodule SchemaOrg.CableOrSatelliteService do
  @moduledoc "A service which provides access to media programming like TV or radio. Access may be via cable or satellite."
  ...
  @doc false
  def __schema_org__, do: %{type: "CableOrSatelliteService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CableOrSatelliteService` struct."
