defmodule SchemaOrg.CurrencyConversionService do
  @moduledoc "A service to convert funds from one currency to another currency."
  ...
  @doc false
  def __schema_org__, do: %{type: "CurrencyConversionService", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.CurrencyConversionService` struct."
