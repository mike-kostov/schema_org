defmodule SchemaOrg.MusicStore do
  @moduledoc "A music store."
  ...
  @doc false
  def __schema_org__, do: %{type: "MusicStore", json_keys: @json_keys}

  @doc "Builds an empty `SchemaOrg.MusicStore` struct."
